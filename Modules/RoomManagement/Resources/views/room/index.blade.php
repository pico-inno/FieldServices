...
<ul class="breadcrumb fw-semibold fs-base my-1">
    ...
    <li class="breadcrumb-item text-dark">Room</li>
</ul>
<!--end::Breadcrumb-->
@endsection
            ...
            <div class="card-header py-5 gap-2 gap-md-5 d-flex flex-column">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{route('room.create') }}" class="text-light btn btn-primary btn-sm">Add</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table align-middle rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                ...
                                <th class="min-w-150px">Floor</th>
                                <th class="min-w-150px">Room Type</th>
                                <th class="min-w-150px">Room Status</th>
                                <th class="min-w-150px">Active</th>
                                <th class="min-w-150px">Max Occupancy</th>
                                <th class="min-w-150px">Description</th>                            
                                <th class="min-w-150px">Custom Field 1</th>
                                <th class="min-w-150px">Custom Field 2</th>
                                <th class="min-w-150px">Custom Field 3</th>
                                <th class="min-w-150px">Custom Field 4</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
...
@push('scripts')
    <script>
        ...
        var KTDatatablesExample = function () {
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Rooms Report';
