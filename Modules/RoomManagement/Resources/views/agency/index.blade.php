...
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-2">Agency</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Room Management</li>
    <li class="breadcrumb-item text-dark">Agency</li>
</ul>
<!--end::Breadcrumb-->
@endsection
            ...
            <div class="card-header py-5 gap-2 gap-md-5 d-flex flex-column">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{ url('agency/create') }}" class="text-light btn btn-primary">Add</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <td>
                                    ...
                                    <div>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-150px p-2" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <div class="menu-item">
                                                <a class="menu-link" href="{{ url('agency/edit')}}">
