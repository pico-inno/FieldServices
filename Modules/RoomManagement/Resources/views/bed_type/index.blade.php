...
@section('bed_type_active_show','active')

@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Bed Type</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Room Management</li>
    <li class="breadcrumb-item text-dark">Bed Type</li>
</ul>
<!--end::Breadcrumb-->
@endsection
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" 
                                    data-bs-target="#add_bed_type_modal" data-href="{{ url('bed-type/create')}}"
                        >
                            Add
                        </button>
                    </div>
    ...
    <!--end::container-->
    <!--begin::Modal-->
   @include('roommanagement::bed_type.create')

   <div class="modal modal-lg fade" tabindex="-1" role="dialog" id="edit_bed_type_modal">
   </div>
    <!--end::Modal-->
</div>
<!--end::Content-->
    ...
    <script>
        ...
        var KTDatatablesExample = function () {
            ...
            $(document).on('click', 'button.edit-btn', function(){
                $('#edit_bed_type_modal').load($(this).data('href'), function() {
                    $(this).modal('show');

                    $('form#edit_bed_type_form').submit(function(e) {
                        e.preventDefault();
                        var form = $(this);
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if (result.success == true) {
                                    $('#edit_bed_type_modal').modal('hide');
            ...
            $(document).on('click', 'button.delete-btn', function(){
                ...
                Swal.fire({
                    title: "Are you sure",
                    text: "This bed type will be deleted",
                    icon: "warning",
                    ...
                    if (confirmed.value) {
                        $.ajax({
                            method: "DELETE",
                            url: '/room-management/bed-type/' + id,
                            dataType: "json",
                            data: data,
                            headers: {
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Bed Types Report';
        ...
        $(document).on('click', 'button.edit_bed_type_button', function(){
            $('#edit_bed_type_modal').load($(this).data('href'), function() {
                $(this).modal('show');
            });
        });
