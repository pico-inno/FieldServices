...
@section('room_type_active_show','active')

@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Room Type</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Room Management</li>
    <li class="breadcrumb-item text-dark">Room Type</li>
</ul>
<!--end::Breadcrumb-->
@endsection
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" 
                                    data-bs-target="#add_room_type_modal" data-href="{{route('room-type.create')}}"
                        >
                            Add
                        </button>
                    </div>
    ...
    <!--end::container-->
    <!--begin::Modal-->
   @include('roommanagement::room_type.create')
   
   <div class="modal modal-lg fade" tabindex="-1" role="dialog" id="edit_room_type_modal">
   </div>
    <!--end::Modal-->
</div>
<!--end::Content-->
    ...
    <script>
        ...
        var KTDatatablesExample = function () {
            ...
            $(document).on('click', 'button.edit-btn', function(){
                $('#edit_room_type_modal').load($(this).data('href'), function() {
                    $(this).modal('show');

                    $('form#edit_room_type_form').submit(function(e) {
                        e.preventDefault();
                        var form = $(this);
                        ...
                        $.ajax({
                            ...
                            success: function(result) {
                                if (result.success == true) {
                                    $('#edit_room_type_modal').modal('hide');
            ...
            $(document).on('click', 'button.delete-btn', function(){
                ...
                Swal.fire({
                    ...
                    if (confirmed.value) {
                        $.ajax({
                            method: "DELETE",
                            url: '/room-management/room-type/' + id,
                            dataType: "json",
                            data: data,
                            headers: {
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Room Types Report';
        ...
        $(document).on('click', 'button.edit_room_type_button', function(){
            $('#edit_room_type_modal').load($(this).data('href'), function() {
                $(this).modal('show');
            });
        });
