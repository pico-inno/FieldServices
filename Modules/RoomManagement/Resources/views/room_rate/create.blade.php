...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        @endif
        <form action="{{route('room-rate.store')}}" method="POST">
            @csrf
            <!--begin::Card-->
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-6">
                            ...
                            <input type="text" name="rate_name" id="rate_name" class="form-control form-control-sm fs-7" placeholder="Rate Name" required />
                        </div>
                        <div class="col-md-6 col-sm-12 mb-6">
                            <label for="rate_amount" class="form-label">Rate Amount</label>
                            <input type="number" name="rate_amount" id="rate_amount" class="form-control form-control-sm fs-7" placeholder="Rate Amount" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-6">
                            <label for="start_date" class="form-label">Start Date</label>
                            <input type="text" name="start_date" id="start_date" value="{{ $currentDate }}" class="form-control form-control-sm fs-7" autocomplete="off" />
                        </div>
                        <div class="col-md-6 col-sm-12 mb-6">
                            <label for="end_date" class="form-label">End Date</label>
                            <input type="text" name="end_date" id="end_date" value="{{ $currentDate }}" class="form-control form-control-sm fs-7" autocomplete="off" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-6">
                            <label for="booking_rule" class="form-label">Booking Rule</label>
                            <textarea name="booking_rule" id="booking_rule" class="form-control form-control-sm fs-7" placeholder="Booking Rule" style="resize: none;"></textarea>
                        </div>
                        <div class="col-md-6 col-sm-12 mb-6">
                            <label for="cancellation_rule" class="form-label">Cancellation Rule</label>
                            <textarea name="cancellation_rule" id="cancellation_rule" class="form-control form-control-sm fs-7" placeholder="Cancellation Rule" style="resize: none;"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-12 mb-6">
                            <label for="min_stay" class="form-label">Minimum Stay</label>
                            <input type="number" name="min_stay" id="min_stay" class="form-control form-control-sm fs-7" placeholder="Minimun Stay" />
                        </div>
                        <div class="col-md-6 col-sm-12 mb-6">
                            <label for="max_stay" class="form-label">Maximum Stay</label>
                            <input type="number" name="max_stay" id="max_stay" class="form-control form-control-sm fs-7" placeholder="Maximum Stay" />
                        </div>
                    </div>
                </div>
