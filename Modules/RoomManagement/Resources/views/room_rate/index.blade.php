...
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Room Rate</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Room Management</li>
    <li class="breadcrumb-item text-dark">Room Rate</li>
</ul>
<!--end::Breadcrumb-->
@endsection
            ...
            <div class="card-header py-5 gap-2 gap-md-5 d-flex flex-column">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{route('room-rate.create') }}" class="text-light btn btn-primary btn-sm">Add</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table class="table align-middle rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                ...
                                <th class="min-w-150px">Rate Name</th>
                                <th class="min-w-150px">Rate Amount</th>
                                <th class="min-w-150px">Room Type</th>
                                <th class="min-w-150px">Start Date</th>
                                <th class="min-w-150px">End Date</th>
                                <th class="min-w-150px">Booking Rule</th>
                                <th class="min-w-150px">Cancellation Rule</th>
                                <th class="min-w-150px">Minimum Stay</th>                            
                                <th class="min-w-150px">Maximum Stay</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
    ...
    <script>
        ...
        var KTDatatablesExample = function () {
            ...
            $(document).on('click', 'button.delete-btn', function(){
                ...
                Swal.fire({
                    title: "Are you sure",
                    text: "This room rate will be deleted",
                    icon: "warning",
                    ...
                    if (confirmed.value) {
                        $.ajax({
                            method: "DELETE",
                            url: '/room-management/room-rate/' + id,
                            dataType: "json",
                            data: data,
                            headers: {
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Room Rates Report';
