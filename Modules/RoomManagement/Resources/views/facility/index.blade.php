...
@section('facility_active_show','active')

@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Facility</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Room Management</li>
    <li class="breadcrumb-item text-dark">Facility</li>
</ul>
<!--end::Breadcrumb-->
@endsection
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" 
                                    data-bs-target="#add_facility_modal" data-href="{{route('facility.create')}}"
                        >
                            Add
                        </button>
                    </div>
    ...
    <!--end::container-->
    <!--begin::Modal-->
    @include('roommanagement::facility.create')

    <div class="modal modal-lg fade" tabindex="-1" role="dialog" id="edit_facility_modal">
    </div>
    <!--end::Modal-->
</div>
<!--begin::Content-->
    ...
    <script>
        ...
        var KTDatatablesExample = function () {
            ...
            $(document).on('click', 'button.edit-btn', function(){
                $('#edit_facility_modal').load($(this).data('href'), function() {
                    $(this).modal('show');

                    $('form#edit_facility_form').submit(function(e) {
                        e.preventDefault();
                        var form = $(this);
            ...
            $(document).on('click', 'button.delete-btn', function(){
                ...
                Swal.fire({
                    ...
                    if (confirmed.value) {
                        $.ajax({
                            method: "DELETE",
                            url: '/room-management/facility/' + id,
                            dataType: "json",
                            data: data,
                            headers: {
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Facilities Report';
        ...
        $(document).on('click', 'button.edit_facility_button', function(){
            $('#edit_facility_modal').load($(this).data('href'), function() {
                $(this).modal('show');
            });
        });
