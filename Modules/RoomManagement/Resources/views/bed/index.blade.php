...
@section('bed_active_show','active')

@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Bed</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Room Management</li>
    <li class="breadcrumb-item text-dark">Bed</li>
</ul>
<!--end::Breadcrumb-->
@endsection
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" 
                                    data-bs-target="#add_bed_modal" data-href="{{route('bed.create')}}"
                        >
                            Add
                        </button>
                    </div>
                ...
                <table class="table align-middle rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                            ...
                            <th class="min-w-150px">Bed Type</th>
    ...
    <!--end::container-->
    <!--begin::Modal-->
   @include('roommanagement::bed.create')
   
   <div class="modal modal-lg fade" tabindex="-1" role="dialog" id="edit_bed_modal">
   </div>
    <!--end::Modal-->
</div>
<!--end::Content-->
    ...
    <script>
        ...
        var KTDatatablesExample = function () {
            ...
            $(document).on('click', 'button.edit-btn', function(){
                $('#edit_bed_modal').load($(this).data('href'), function() {
                    $(this).modal('show');

                    $('form#edit_bed_form').submit(function(e) {
                        e.preventDefault();
                        var form = $(this);
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Beds Report';
        ...
        $(document).on('click', 'button.edit_bed_button', function(){
            $('#edit_bed_modal').load($(this).data('href'), function() {
                $(this).modal('show');
            });
        });
