...
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Room Sale</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Room Management</li>
    <li class="breadcrumb-item text-dark">Room Sale</li>
</ul>
<!--end::Breadcrumb-->
@endsection
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div class="card-header py-5 gap-2 gap-md-5 d-flex flex-column">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{route('room-sale.create') }}" class="text-light btn btn-primary btn-sm">Add</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table align-middle rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                            ...
                            <th class="min-w-125px">Room Rate</th>
                            <th class="min-w-125px">Sale Amount</th>
                            <th class="min-w-125px">Quantity</th>
                            <th class="min-w-125px">Total Item Discount</th>
                            <th class="min-w-125px">Total Sale Amount(Inc. dis and tax)</th>
                            <th class="min-w-125px">Paid Amount</th>
                            <th class="min-w-125px">Balance Amount</th>
                            <th class="min-w-125px">Confirm At</th>
    ...
    <!--end::container-->
    <div class="modal fade" tabindex="-1" role="dialog" id="view_room_sale">
    </div>
...
<script>
    ...
    var KTDatatablesExample = function() {
        ...
        $(document).on('click', 'button.view_room_sale', function(){
            $('#view_room_sale').load($(this).data('href'), function() {
                $(this).modal('show');
            });
        });
        ...
        $(document).on('click', 'button.delete-btn', function() {
            ...
            Swal.fire({
                title: "Are you sure",
                text: "This room sale will be deleted",
                icon: "warning",
                ...
                if (confirmed.value) {
                    $.ajax({
                        method: "DELETE",
                        url: '/room-management/room-sale/' + id,
                        dataType: "json",
                        data: data,
                        headers: {
        ...
        // Hook export buttons
        var exportButtons = () => {
            const documentTitle = 'Room Sales Report';
