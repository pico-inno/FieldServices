                            ...
                            <tbody class="fw-semibold text-gray-700">
                                ...
                                <tr class="room_sales">
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="total_line_discount_amount[]" class="form-control form-control-sm rounded-0 fs-7"value="{{ old('room_fees', $room_sale_detail->total_line_discount_amount)}} placeholder="0" />
                                    </td>
