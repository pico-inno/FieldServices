...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{__('combokit::combokit.create_combo_kit')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">{{__('combokit::combokit.create')}}</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="rom_container">
        <div class="container-xxl">
            <form action="{{route('combokit.store')}}" method="POST" id="rom_form">
                @csrf
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 mb-5 data-container">
                    <div class="card">
                        <div class="card-body">
                            @error('consume_details')
                            ...
                            <div class="row mb-3 flex-wrap">
                                <div class="mb-7 mt-3 col-12 col-md-3">
                                    ...
                                    <div class="fv-row">
                                        <input type="text" class="form-control form-select-sm" id="name" name="name"  value="" placeholder="Combo/Kit Name">
                                    </div>
                                </div>
                                ...
                                <div class="mb-7 mt-3 col-12 col-md-3 fv-row">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <div class="overflow-hidden flex-grow-1">
                                            <select name="product_id" class="form-select form-select-sm fw-bold rounded-0 product_name" data-kt-select2="true" data-hide-search="false" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true" id="productSelect">
                                                <option></option>
                                                @foreach($products as $product)
                                                    <option value="{{$product['id']}}" data-rom="{{json_encode($product['rom'])}}" data-template_uom_id="{{ $product['uom_id'] }}" @if(old('product_id') == $product['id']) selected @endif>{{$product['name']}}</option>
                                                @endforeach

                                            </select>
                                        </div>
                                        <button class="input-group-text productQuickAdd"  data-bs-toggle="modal" type="button"   data-href="{{route('product.quickAdd')}}" >
                                ...
                                <div class="mb-7 mt-3 col-12 col-md-3">
                                    ...
                                    <div class="fv-row">
                                        <select name="rom_type" class="form-select form-select-sm fw-bold " data-kt-select2="true" data-hide-search="false" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true" >
                                            <option></option>
                                            <option value="kit" @selected(old('rom_type') == 'kit') selected>Kit</option>
                                            <option value="manufacture" @selected(old('rom_type') == 'manufacture')>Manufacture this product</option>
                                        </select>
                                    </div>
                                </div>
                                    <input type="hidden" id="templateUom" name="uom_id" value="">
...
{{--                                    </label>--}}
{{--                                    <div class="fv-row">--}}
{{--                                        <input type="text" class="form-control form-select-sm" id="quantity" name="quantity"  value="{{old('quantity', '1.00')}}">--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                                <div class="mb-7 mt-3 col-12 col-md-3">--}}
...
{{--                                </div>--}}
                                ...
                                <div class="mb-7 mt-3 col-12 col-md-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid">
                                            <!--begin::Input-->
                                            <input type="checkbox" name="default_template" value="1"    class="form-check-input me-3" id="default_template">
                                            <!--end::Input-->
                                            <!--begin::Label-->
                                ...
                                <table class="table table-rounded table-striped border gy-4 gs-4" id="rom_consume_table">
                                    ...
                                    <tbody class="fw-semibold text-gray-600 data-table-body rom-table">
                                        <tr class="dataTables_empty text-center">
                                            <td colspan="5" >{{__('combokit::combokit.there_is_no_data_to_show')}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                ...
                <div class="col-12 text-center mt-5 mb-5">
                    <button type="submit" class="btn btn-primary btn" data-kt-purchase-action="submit" name="save" value='save'>{{__('combokit::combokit.create')}}</button>
                </div>
            </form>
        </div>
        <!--end::Container-->
