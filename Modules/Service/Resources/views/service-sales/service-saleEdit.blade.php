...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('service.edit_service_sale') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
...
@section('content')
	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="container-xxl" id="kt_content_container">
			<!--begin::Card-->
			<form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('service-sale.update', $serviceSale->id) }}" method="POST">
                @method('PUT')
				@csrf
                        ...
                        <div class="col-12 my-5 input-group flex-nowrap">
                            ...
                            <select name="business_location_id" id="business_location_id" class="form-select rounded-0" data-kt-select2="true" data-placeholder="Select locations">
                                ...
                                @foreach ($locations as $location)
                                    <option value="{{$location->id}}" @selected($location->id === $serviceSale->business_location_id)>
                                        {{$location->name}}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="card-body">
                            <div class="row mb-5 flex-wrap">
                                <div class="mb-10 col-12 mt-3 col-md-6">
                                    ...
                                    <input type="text" name="service_voucher_no" class="form-control mb-2" placeholder="Service voucher no" value="{{old('service_voucher_no',$serviceSale->service_voucher_no)}}" />
                                </div>
                                <div class="mb-10 mt-3 col-12 col-md-6">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        ...
                                        <select class="form-select  fw-bold rounded-0"  name="contact_id" data-kt-select2="true" data-hide-search="false" data-placeholder="Select customer name" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                            <option value=""></option>
                                            @foreach ($customers as $customer)
                                                <option value="{{$customer->id}}" @selected($customer->id === $serviceSale->contact_id)>
                                ...
                                <div class="mb-10 col-12 mt-3 col-md-6">
                                    ...
                                    <select name="status" id="" class="form-select" data-kt-select2="true" data-placeholder="Select status" data-hide-search="true">
                                        <option></option>
                                        <option value="request" @selected("request" === $serviceSale->service_status)>Request</option>
                                        {{-- <option value="order">Order</option> --}}
                                        {{-- <option value="quotation">Quotation</option> --}}
                                        <option value="draft" @selected("draft" === $serviceSale->service_status)>Draft</option>
                                        <option value="suspend" @selected("suspend" === $serviceSale->service_status)>Suspend</option>
                                        <option value="final" @selected("final" === $serviceSale->service_status)>Final</option>
                                        <option value="confirm" @selected("confirm" === $serviceSale->service_status)>Confirm</option>
                                    </select>
                                    @error('status')
                                        <div class="text-danger my-2">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row total-dis-row">
                                <div class="mb-7 mt-3 col-12 col-md-4">
                                    ...
                                    <select name="parent_discount_type" id="parent-discount-type" data-placeholder="Select status" data-hide-search="true" class="form-select total_discount_type" data-control="select2">
                                        {{-- <option></option> --}}
                                        <option value="fixed" @selected("fixed" === $serviceSale->service_discount_type)>Fixed</option>
                                        <option value="percentage" @selected("percentage" === $serviceSale->service_discount_type)>Percentage</option>
                                    </select>
                                </div>
                                <div class="mb-7 mt-3 col-12 col-md-4">
                                    <label class="form-label fs-6 fw-semibold " for="">
                                    ...
                                    <input type="text" name="total_discount_amount" class="form-control total_discount_amount_input" value="{{old('total_discount_amount',$serviceSale->discount_amount * 1)}}">
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-5">
                                <div class="col-md-6 col-md-offset-6">
                                    ...
                                    <textarea name="remark" id="" cols="30" rows="3" class="form-control">
                                        {{old('remark',$serviceSale->remark)}}
                                    </textarea>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                ...
                                <input type="text" class="form-control paid_amount_input"  name="paid_amount" value="{{old('paid_amount',$serviceSale->paid_amount * 1)}}">
                                </div>
