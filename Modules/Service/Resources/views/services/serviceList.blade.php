...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('service.service_list') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{ __('service.service') }}</li>
        <li class="breadcrumb-item text-dark">{{ __('service.service_list') }}</li>
    </ul>
<!--end::Breadcrumb-->
@endsection
@section('content')
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" id="search" data-kt-filter="search" class="form-control form-control-solid w-250px ps-14 form-control-sm" placeholder="Search Report" />
                        </div>
                        <!--end::Search-->
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <a href="{{ route('service.add') }}" class="text-light btn btn-primary btn-sm">{{ __('service.add_service') }}</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table align-middle Datatable-tb rounded table-row-dashed fs-6 g-5">
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                    ...
                                    <th class="min-w-100px">{{ __('service.service_code') }}</th>
                                    <th class="min-w-100px">{{ __('service.service_type') }}</th>
                                    <th class="min-w-100px">{{ __('product/product.uom') }}</th>
                                    <th class="min-w-100px">{{ __('service.price') }}</th>
                        ...
                        render: function(data){
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a href="/service/edit/${data}" class="dropdown-item p-2">
                                        <i class="fas fa-pen-to-square me-3"></i>{{ __('product/product.edit') }}</a></li>
                                    <li><div class="dropdown-item p-2 delete-confirm cursor-pointer"  data-id="${data}">
