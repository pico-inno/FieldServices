...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('service.edit_service') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
...
@section('content')
	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="container-xxl" id="kt_content_container">
			<!--begin::Card-->
			<form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('service.update', $service->id) }}" method="POST">
                @method('PUT')
				@csrf
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="kt_ecommerce_settings_general" role="tabpanel">
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="name" value="{{old('name',$service->name)}}" placeholder="Service name"/>
                                            <!--end::Input-->
                                            @error('name')
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="service_code" value="{{old('service_code',$service->service_code)}}" placeholder="Service code"/>
                                            <!--end::Input-->
                                            @error('service_code')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-select form-select-sm mb-2" name="service_type_id" data-control="select2" data-hide-search="true" data-placeholder="Select an option">
                                                ...
                                                @foreach ($service_types as $service_type)
                                                    <option  value="{{ $service_type->id }}" @selected($service_type->id === $service->service_type_id)>
                                                        {{ $service_type->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-select form-select-sm mb-2" name="uom_id" data-control="select2" data-hide-search="true" data-placeholder="Select an option">
                                                <option></option>
                                                @foreach ($uoms as $uom)
                                                    <option  value="{{ $uom->id }}" @selected($uom->id === $service->uom_id)>
                                                        {{ $uom->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="price" value="{{old('price',$service->price * 1)}}" placeholder="Price"/>
                                            @error('price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check mt-3">
                                                <input class="form-check-input form-check-sm" name="active" type="checkbox" value="1" id="flexCheckChecked" @checked($service->active) />
