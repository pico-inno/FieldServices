...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('service.service_type_list') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{ __('service.service') }}</li>
        <li class="breadcrumb-item text-dark">{{ __('service.service_type_list') }}</li>
    </ul>
<!--end::Breadcrumb-->
@endsection
@section('content')
            ...
            <div class="card  card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <a href="{{ route('service-type.add') }}" class="text-light btn btn-primary btn-sm">{{ __('service.add_service_type') }}</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        render: function(data){
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a href="/service-type/edit/${data}" class="dropdown-item p-2">
