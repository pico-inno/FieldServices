...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('service.add_service_type') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
...
@section('content')
	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="container-xxl" id="kt_content_container">
			<!--begin::Card-->
			<form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('service-type.create') }}" method="POST">
				@csrf
							...
							<div class="tab-pane fade show active" id="kt_ecommerce_settings_general" role="tabpanel">
                                ...
                                <div class="row mb-7">
                                    <div class="col-md-9 offset-md-3">
                                        <h2>{{ __('service.add_service_type') }}</h2>
                                    </div>
                                </div>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="name" value="" placeholder="Service type name"/>
                                        <!--end::Input-->
                                        @error('name')
                                ...
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check mt-3">
                                            <input class="form-check-input" name="is_active" type="checkbox" value="1" id="flexCheckChecked" checked />
