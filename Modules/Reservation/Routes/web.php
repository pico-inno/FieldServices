...
Route::get('/reservation/create/guest/{id}', [ReservationController::class, 'addNewGuest'])->name('addNewGuest');
...
// Print
Route::get('/reservations/folios/foralltabs/{id}', [ReservationController::class, 'getFolioInvoicesForAllTab'])->name('printInvoice');
