...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('stockinout::stockin.stockin')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{__('stockinout::stockin.stockin')}}</li>
        <li class="breadcrumb-item text-dark">{{__('stockinout::stockin.list')}}</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">
                                <h2>{{ucfirst(__('stockinout::stockin.filter'))}}</h2>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <!--end::Svg Icon-->{{ucfirst(__('stockinout::stockin.filter'))}}
                                </button>
                                <!--begin::Menu 1-->
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path opacity="0.3"
                                    ...
                                    <!--end::Svg Icon-->{{ucfirst(__('stockinout::stockin.export'))}}
                                </button>
                                <!--end::Export-->
                            @endif
                            @if(hasCreate('stockin'))
                                ...
                                <button onclick="window.location.href='{{route('stock-in.create')}}'" type="button"
                                        class="btn btn-primary">{{ucfirst(__('stockinout::stockin.create'))}}
                                </button>
                                <!--end::Add customer-->
                            @endif
                        </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="stockin_table">
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px text-center">{{__('stockinout::stockin.actions')}}</th>
                            <th class="min-w-125px">{{__('stockinout::stockin.date')}}</th>
                            <th class="min-w-125px">{{__('stockinout::stockin.voucher_no')}}</th>
                            <th class="min-w-125px">{{__('stockinout::stockin.location')}}</th>
                            <th class="min-w-125px">{{__('stockinout::stockin.stockin_person')}}</th>
                            <th class="min-w-125px">{{__('stockinout::stockin.add_by')}}</th>
                        </tr>
                        <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                    ...
                    $.ajax({
                        ...
                        // console.log(results);
                            if (results.length > 0) {
                                ...
                                stockinTableBody.append('<tr><td colspan="7" class="text-center">{{__('stockinout::stockin.no_data_table')}}</td></tr>');
                            }
                        },
                    });
                } catch (error) {
