...
@push('scripts')
    <script>
        ...
        function append_row(item,unique_name_id,selectedTag) {
            ...
            <td>
                <select name="stockin_details[${unique_name_id}][uom_id]" id="" class="form-select form-select-sm uom-select" data-kt-repeater="uom_select_${unique_name_id}"  data-hide-search="true"  data-placeholder="Select Unit" required>
