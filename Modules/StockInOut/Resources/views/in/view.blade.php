                                    ...
                                    <div class="table-responsive border-bottom mb-9">
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tr class="border-bottom fs-6 fw-bold text-muted">
                                                ...
                                                <th class="min-w-70px text-end pb-2">{{__('stockinout::stockin.received_qty')}}</th>
                                                <th class="min-w-80px text-end pb-2">{{__('stockinout::stockin.uom')}}</th>
                                                <th class="min-w-100px text-end pb-2">{{__('stockinout::stockin.remark')}}</th>
                                            </tr>
                                            </thead>
