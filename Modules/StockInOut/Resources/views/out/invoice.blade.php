...
<div id="print-invoice" class="m-10">
    <div class="-header">
        <h4 class="fw-bolder text-gray-800 fs-2qx pe-5 pb-7">Stockout Details (Voucher
            No: {{$stockout['stockout_voucher_no']}} )</h4>
    ...
    <div class="body">
            ...
            <div class="col-4">
                ...
                <div class="text-group">
                    <h3 class="fw-semibold fs-5">
                        Date : <span class="text-gray-600">{{$stockout['stockout_date']}}</span>
                    </h3>
                    <h3 class="fw-semibold fs-5">
                        Stockin Status : <span class="text-gray-600">{{$stockout['status']}}</span>
                    </h3>
                </div>
            </div>
        </div>
        <div class="">
            <table class="table align-middle table-row-dashed fs-6 p-10" id="kt_customers_table">
                ...
                @foreach ($stockout_details as $key=>$detail)
                    @php
            ...
            <div class="mt-5">
                <table class="table align-middle table-row-dashed fs-6 gy-2 p-5" id="kt_customers_table">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            @php
                                $totalPurchasePrice = $stockout_details->sum('purchase_price');
                            @endphp
