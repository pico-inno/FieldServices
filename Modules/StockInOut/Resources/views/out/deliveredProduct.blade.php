...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('stockinout::stockout.delivered_product')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{__('stockinout::stockout.stockout')}}</li>
        <li class="breadcrumb-item text-muted"><a href="{{route('stock-out.outgoing.index')}}">{{__('stockinout::stockout.outgoing_list')}}</a></li>
                        ...
                        <div class="card-body">
                            <div class="row mb-5 flex-wrap">
                                <div class="mb-7 mt-3 col-12 col-md-6">
                                    <div class="text-group">
                                        <h3 class="text-primary-emphasis fw-semibold fs-5 mb-5">
                                            ...
                                            {{__('stockinout::stockout.customer_name')}} : <span class="text-gray-600 fw-semibold">{{$dispensed_data->customer->first_name}}</span>
                                            <input type="text" class="d-none" name="customers" value="{{$dispensed_data->customer->id}}">
                                        </h3>
                                        <h3 class="text-primary-emphasis fw-semibold fs-5 mb-5">
                                            {{__('stockinout::stockout.sale_voucher_no')}} : <span class="text-gray-600 fw-semibold">{{$dispensed_data->sales_voucher_no}}</span>
                                ...
                                <div class="mb-7 mt-3 col-12 col-md-6">
                                    <div class="text-group">
                                        <h3 class="text-primary-emphasis fw-semibold fs-5 mb-5">
                                            {{__('stockinout::stockout.status')}} : <span class=" fw-semibold text-warning">{{$dispensed_data->status}}</span>
                                        </h3>
                                        <h3 class="text-primary-emphasis fw-semibold fs-5 mb-5">
                                            {{__('stockinout::stockout.business_location')}} : <span class="text-gray-600 fw-semibold">{{$dispensed_data->businessLocation->name}}</span>
