...
@section('table_here_show', 'here show')
@section('res_management_show', 'active show')
@section('table_list_active_show', 'active show')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">Table List</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">Restaurant</li>
        <li class="breadcrumb-item text-dark">Table </li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="card card-flush h-xl-100">
            <!--begin::Card header-->
            <div class="d-flex  justify-content-between py-7 px-10">
                <div class="d-flex">
                    <h4>Table List</h4>
                ...
                <div class="card-toolbar">
                    <div class="d-flex flex-stack flex-wrap gap-4" data-kt-table-toolbar="base">
                        <button type="button" class="btn btn-primary btn-sm openModal"  id="add" data-href="{{route('restaurant.tableCreate')}}">Add</button>
            ...
            <div class="card-body">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-3" id="tableDataTable">
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" data-checked="selectAll" id="selectAll" type="checkbox" data-kt-check="true"  data-kt-check-target="#tableDataTable .form-check-input" value="1" />
                                </div>
                            </th>
                            <th>Actions</th>
...
var tableData = function () {
    ...
    var tablelist = function () {
        datatable = $(table).DataTable({
            ...
            serverSide: true,
               ajax: {
                url: '/restaurant/table/list/data',
            },
            columns: [
                {
                    data: 'checkbox',
    ...
    return {
        init: function () {
            table = document.querySelector('#tableDataTable');
