        ...
        ->addColumn('action', function ($table) {
            $html = '
                <div class="dropdown ">
                    ...
                    $html.='<a class="dropdown-item cursor-pointer" id="delete" data-id="'.$table->id.'"  data-kt-exchangeRate-table="delete_row" data-href="'.route('exchangeRate.destory',$table->id).'">Delete</a>';
                    // $html .= $editBtn;
                $html .= '</ul></div></div>';
                return $html;
        })
