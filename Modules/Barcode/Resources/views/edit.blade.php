...
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-2">Edit Barcode Template</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
                ...
                <form class="form" action="{{route('barcode.update',$template->id)}}" method="POST" id="template_form">
                    ...
                    <div class="d-flex">
                                ...
                                <div class="mb-7">
                                        ...
                                        <div class="fv-row col-12 d-block  d-md-flex mb-5 mt-3  align-items-end">
                                            ...
                                            <div class=" ms-5 min-w-100px">
                                                <x-forms.nob-select placeholder="Select Location Type"
                                                    class="min-w-200px" attr="data-hide-search='true'"
                                                    name="paper_type" id="paper_type">
                                                    <option value="cf" @selected($templateData->paper_type=='cf')>Continous feed or rolls</option>
                                                    <option value="fixed" @selected($templateData->paper_type=='fixed')>fixed</option>
                                                </x-forms.nob-select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row ">
                                        ...
                                        <div class="col-md-6 col-12 ps-3  mt-10">
                                            ...
                                            <x-forms.input class="mt-2" placeholder="Eg : 2"  value="{{$templateData->barcodeInnerPadding}}"
                        ...
                        <div class="d-none d-md-block card col-6 shadow-none p-2 ps-5">
                            ...
                            <div
                                class="card-body border border-1 border-gray-300 rounded rounded-1 p-0 d-flex align-items-center justify-content-center">
