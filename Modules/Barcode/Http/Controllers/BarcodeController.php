...
class BarcodeController extends Controller
{
    ...
    public function prepare(){
        ...
        return view('barcode::layouts.prepare',compact('barcodeTemplates','business', 'priceLists', 'exchangeRates'));
    }
    ...
    public function print(Request $request){
        ...
        return view('barcode::layouts.print',compact('data', 'business', 'currencySymbol', 'template', 'templateData'));
    }
}
