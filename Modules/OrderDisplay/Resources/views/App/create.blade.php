    ...
    <div class="modal-dialog  w-sm-500px">
        <div class="modal-content">
            <form action="{{route('kdStore')}}" method="POST" id="add_exchange_rates">
                @csrf
                ...
                <div class="modal-body">
                    <div class="row mb-6">
                        ...
                        <div class="col-12 mb-5">
                            ...
                            <input class="form-control form-control-solid " id="pos_register_tagify" name="pos_register_id" />
                        </div>
                        <div class="col-12 mb-5">
                            <label for="category" class="required form-label">Product Category</label>
                            <input class="form-control form-control-solid " id="category_tagify"   name="category_id" />
