            ...
            <script>
                ...
                const detailOrderComponent=(data)=>{
                    ...
                    saleDetails.forEach(sd => {
                        items += productItem(sd.product,sd.quantity,sd.uom,sd.rest_order_status,sd.note);
                    });
                        return `
                            <div class="food">
                ...
                const productItem=(product,qty,uom,status,detailNote)=>{
                    let note='';
                    if(detailNote){
                        note+=`
                    ...
                    return `
                            <div class="d-flex justify-content-between px-5 py-3 detailItem" type='button'>
                                <div class="">
                                    <h2 class=" fs-6 fw-bold productName ${status == `ready` ? `text-decoration-line-through text-gray-500` : ``}">${product.name}</h2>
                                </div>
                                <div class="">
