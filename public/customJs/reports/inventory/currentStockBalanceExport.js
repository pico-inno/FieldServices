                ...
                validator.validate().then(function (status) {
                    ...
                    if (status === 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            var table = $('#current_stock_balance_reports_table').DataTable();
                            ...
                            var dataTableButtons = new $.fn.dataTable.Buttons(table, {
                                buttons: [
                                    {
                                        extend: 'excel',
                                        title: 'Current Stock Balance Report',
                                        text:'<i class="fa fa-table fainfo" aria-hidden="true" ></i>',
                                        titleAttr: 'Current Stock Balance Report',
                                    ...
                                    {
                                        extend: 'print',
                                        text: 'Current Stock Balance Report',
