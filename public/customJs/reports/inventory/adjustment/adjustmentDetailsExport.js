                ...
                validator.validate().then(function (status) {
                    ...
                    if (status === 'Valid') {
                        ...
                        setTimeout(function () {
                            ...
                            var table = $('#stock_adjustment_details_reports_table').DataTable();
                                ...
                                buttons: [
                                    {
                                        ...
                                        titleAttr: 'Adjustment Detail Report',
                            ...
                            Swal.fire({
                                text: "Adjustment details list has been successfully exported!",
                                icon: "success",
...
$(document).ready(function() {
    ...
    columnCheckboxes.on('change', function() {
        ...
        if (columnIndex === 0) {
            ...
            var column = table.column(columnIndex - 1);
