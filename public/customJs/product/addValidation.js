var productAdd = function () {
    ...
    const element = document.getElementById("product_content");
    const form = element.querySelector("#kt_ecommerce_add_product_form");
...
function validationField(form) {
    ...
    var validationFields = {
        ...
        uom_id:{
          validators: {
              notEmpty: { message: 'UOM field is required'}
          }
        },
        purchase_uom_id:{
            validators: {
                notEmpty: {message: 'Purchase UOM field is required'}
            }
