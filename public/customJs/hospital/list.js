...
var KTCustomersList = function () {
    ...
    var initCustomerList = function () {
        ...
        datatable = $(table).DataTable({
            ...
            serverSide: true,
               ajax: {
                url: '/hospital/registration/data',
            },
            order:['0','desc'],
            columns: [
                // {
                ...
                // },
                {
                    ...
                    data:'opd_check_in_date',
                    name:'opd_check_in_date'
                },{
                    data:'ipd_check_in_date',
                    name:'ipd_check_in_date'
                },{
                    data:'check_out_date',
                    name:'check_out_date'
                },
    ...
    var handleSearchDatatable = () => {
        const filterSearch = document.querySelector('[data-registration="search"]');
    ...
    var handleDeleteRows = () => {
        ...
        const deleteButtons = document.querySelectorAll('[data-kt-room-data="delete_row"]');
        deleteButtons.forEach(d => {
            ...
            d.addEventListener('click', function (e) {
                ...
                // Get purchase name
                const patientName = parent.querySelectorAll('td')[4].innerText;

                // SweetAlert2 pop up --- official docs reference: https://sweetalert2.github.io/
                Swal.fire({
                    text: "Are you sure you want to delete " + patientName + "'s registration data?",
                    icon: "warning",
                    ...
                    if (result.value) {
                        let id=d.getAttribute('data-id')
                            $.ajax({
                                url: `/hospital/registration/${id}/delete`,
                                type: 'DELETE',
                                headers: {
                                ...
                                success: function(s) {
                                    ...
                                    Swal.fire({
                                        text: "You have deleted " + patientName + "!.",
                                        icon: "success",
                                        buttonsStyling: false,
                        ...
                        Swal.fire({
                            text: patientName + " was not deleted.",
                            icon: "error",
                            buttonsStyling: false,
                            confirmButtonText: "Ok, got it!",
                            customClass: {
    ...
    return {
        init: function () {
            table = document.querySelector('#kt_registration_table');
