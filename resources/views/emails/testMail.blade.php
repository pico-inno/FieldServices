                                        ...
                                        <div style="text-align:center; margin:0 15px 34px 15px">
                                            ...
                                            <div style="margin-bottom: 10px">
                                                <a href="https://keenthemes.com" rel="noopener" target="_blank">
                                                    <img alt="Logo" src={{asset("assets/media/email/logo-1.svg")}}
                                                        style="height: 35px" />
                                                </a>
                                            </div>
                                            <!--end:Logo-->
                                            ...
                                            <!--end:Text-->
                                            <!--begin:Action-->
                                            <a href='../../demo55/dist/authentication/general/welcome.html'
                                                target="_blank"
                                        ...
                                        <div style="background: #F9F9F9; border-radius: 12px; padding:35px 30px">
                                            ...
                                            <div style="display:flex">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        style="position: absolute; color:#50CD89; font-size: 16px; font-weight: 600;">1</span>
                                                </div>
                                                <!--end::Media-->
                                                <!--begin::Block-->
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p
                                                            ...
                                                            writers just put whitespace in their text</p>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                    <!--begin::Separator-->
                                            ...
                                            <div style="display:flex">
                                                ...
                                                <div
                                                    ...
                                                    <img alt="Logo" src={{asset("assets/media/email/icon-polygon.svg")}} />
                                                    <span
                                                        style="position: absolute; color:#50CD89; font-size: 16px; font-weight: 600;">2</span>
                                                </div>
                                                <!--end::Media-->
                                                <!--begin::Block-->
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <p
                                                            ...
                                                            readers’ improtant attentions</p>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                    <!--begin::Separator-->
                                            ...
                                            <div style="display:flex">
                                                ...
                                                <div
                                                    ...
                                                    <img alt="Logo" src={{asset("assets/media/email/icon-polygon.svg")}} />
                                                    <span
                                                        style="position: absolute; color:#50CD89; font-size: 16px; font-weight: 600;">3</span>
                                                </div>
                                                <!--end::Media-->
                                                <!--begin::Block-->
                                                <div>
                                                    ...
                                                    <div>
                                                     ...
                                                     style="color:#181C32; font-size: 14px; font-weight: 600;font-family:Arial,Helvetica,sans-serif">Task
                                                        ...
                                                        <p
                                                            ...
                                                            humor, and explain complex topics</p>
                                                        <!--end::Desc-->
                                                    </div>
                                                    <!--end::Content-->
                                                </div>
