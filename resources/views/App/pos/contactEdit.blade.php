                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <select name="type" class="form-select" id="contact-type" data-control="select2" >
                                        ...
                                        <option value="Both" {{ $customer->type == "Both"  ? 'selected' : '' }}>Both (Suppliers and Customers)</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 mb-6">
                                    ...
                                    <input type="text" name="contact_id" id="contact_id" value="{{old('contact_id',$customer->contact_id)}}" class="form-control" placeholder="Contact ID" />
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <select name="customer_group_id" class="form-select" data-control="select2" data-placeholder="None" data-hide-search="true">
                                        ...
                                        @foreach($customer_groups as $customer_group)
                                            <option value="{{$customer_group->id}}" {{ old('customer_group_id', $customer->customer_group_id) == $customer_group->id ? 'selected' : ''}}>
                                                {{$customer_group->name}}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row business-div">
                                <div class="col-md-4 col-sm-12 mb-6">
                                    ...
                                    <input type="text" name="company_name" id="company_name" value="{{old('company_name',$customer->company_name)}}" class="form-control" placeholder="Business Name" />
                                </div>
                            </div>
                            <div class="row individual-div">
                                <div class="col-md-3 col-sm-12 mb-6 detail-toggle-class-edit d-none">
                                    <label for="prefix" class="form-label">Prefix</label>
                                    <input type="text" name="prefix" id="prefix" value="{{old('prefix',$customer->prefix)}}" class="form-control" placeholder="Mr / Mrs / Miss" />
                                </div>
                                <div class="col-md-3 col-sm-12 mb-6">
                                    <label for="first_name" class="form-label">First Name</label>
                                    <input type="text" name="first_name" id="first_name" value="{{old('first_name',$customer->first_name)}}" class="form-control" placeholder="First Name" />
                                </div>
                                <div class="col-md-3 col-sm-12 mb-6 detail-toggle-class-edit d-none">
                                    <label for="middle_name" class="form-label">Middle Name</label>
                                    <input type="text" name="middle_name" id="middle_name" value="{{old('middle_name',$customer->middle_name)}}" class="form-control" placeholder="Middle Name" />
                                </div>
                                <div class="col-md-3 col-sm-12 mb-6">
                                    <label for="last_name" class="form-label">Last Name</label>
                                    <input type="text" name="last_name" id="last_name" value="{{old('last_name',$customer->last_name)}}" class="form-control" placeholder="Last Name" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 col-sm-12 mb-6">
                                    <label for="mobile" class="required form-label">Mobile</label>
                                    <input type="text" name="mobile" id="mobile" value="{{old('mobile',$customer->mobile)}}" class="form-control" placeholder="Mobile" />
                                </div>
                                <div class="col-md-3 col-sm-12 mb-6 detail-toggle-class-edit d-none">
                                    <label for="alternate_number" class="form-label">Alternate Contact Number</label>
                                    <input type="text" name="alternate_number" id="alternate_number" value="{{old('alternate_number',$customer->alternate_number)}}" class="form-control" placeholder="Alternate Contact Numbe" />
                                </div>
                                <div class="col-md-3 col-sm-12 mb-6 detail-toggle-class-edit d-none">
                                    <label for="landline" class="form-label">Landline</label>
                                    <input type="text" name="landline" id="landline" value="{{old('landline',$customer->landline)}}" class="form-control" placeholder="Landline" />
                                </div>
                                <div class="col-md-3 col-sm-12 mb-6 detail-toggle-class-edit d-none">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="text" name="email" id="email" value="{{old('email',$customer->email)}}" class="form-control" placeholder="Email" />
                                </div>
                            </div>
                            <div class="row mb-6 detail-toggle-class-edit d-none">
                                <div class="col-md-4 col-sm-12 mb-6 individual-div">
                                    <label for="dob" class="form-label">Date of birth</label>
                                    <input type="text" name="dob" id="dob" value="{{ old('dob', !empty($customer->dob) ? date('d/m/Y', strtotime($customer->dob)) : null) }}" class="form-control" placeholder="Date of birth" autocomplete="off"  />
                                </div>
                                <div class="col-md-4 col-sm-12 mb-6">
                            ...
                            {{-- <div class="form-group text-center mt-5" id="show_more_info">
                                <button type="button" class="btn btn-primary btn-lg moreBtn rounded text-white" id="show_more_info_btn">More Informations <i class="fa-solid fa-chevron-down text-white ms-4"></i></button>
                            </div> --}}
                            <div class="form-group text-center mt-5 toggle-details-edit-btn" id="show_more_info">
                                <button type="button" class="btn btn-primary btn-lg moreBtn rounded text-white show_detail_edit" id="show_more_info_btn">
                                    <i class="fa-solid fa-eye-slash me-5"></i> Show Details
                                </button>
                                <button type="button" class="btn btn-primary btn-lg moreBtn rounded text-white hide_detail_edit d-none" id="show_more_info_btn">
                                    <i class="fa-solid fa-eye me-5"></i> Hide Details
                                </button>
                            </div>
                            <div id="more-info-fields" class="mt-8">
                                <div class="row detail-toggle-class-edit d-none">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="tax_number" class="form-label">Tax Number</label>
                                        <input type="text" name="tax_number" id="tax_number" value="{{old('tax_number',$customer->tax_number)}}" class="form-control" placeholder="Tax Number">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="balance" class="form-label">Opening Balance</label>
                                        <input type="number" name="balance" id="balance" value="{{old('balance',$customer->balance)}}" class="form-control" placeholder="Opening Balance">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="pay_term_number" class="form-label">Pay Term</label>
                                        <div class="input-group">
                                            <input type="number" name="pay_term_number" id="pay_term_number" value="{{old('pay_term_number',$customer->pay_term_number)}}" class="form-control"> 
                                            <select name="pay_term_type" class="form-select" aria-label="Select example">
                                                <option value="">Please select</option>
                                                <option value="Months" {{ $customer->pay_term_type == "Months"  ? 'selected' : '' }}>Months</option>
                                                <option value="Days" {{ $customer->pay_term_type == "Days"  ? 'selected' : '' }}>Days</option>
                                            </select>                                
                                        </div>
                                    </div>
                                </div>
                                <div class="row credit-limit detail-toggle-class-edit d-none">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="credit_limit" class="form-label">Credit Limit</label>
                                        <input type="number" name="credit_limit" id="credit_limit" value="{{old('credit_limit',$customer->credit_limit)}}" class="form-control" placeholder="Credit Limit">
                                    </div>
                                </div>
                                ...
                                <div class="row mt-6">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        ...
                                        <input type="text" name="address_line_1" id="address_line_1" value="{{old('address_line_1',$customer->address_line_1)}}" class="form-control" placeholder="Address Line 1">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="address_line_2" class="form-label">Address Line 2</label>
                                        <input type="text" name="address_line_2" id="address_line_2" value="{{old('address_line_2',$customer->address_line_2)}}" class="form-control" placeholder="Address Line 2">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="city" class="form-label">City</label>
                                        <input type="text" name="city" id="city" value="{{old('city',$customer->city)}}" class="form-control" placeholder="City">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="state" class="form-label">State</label>
                                        <input type="text" name="state" id="state" value="{{old('state',$customer->state)}}" class="form-control" placeholder="State">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6 detail-toggle-class-edit d-none">
                                        ...
                                        <select name="country" id="country" class="form-select" aria-label="Select example">
                                            ...
                                            <option value="Aland Islands" {{ $customer->country == "Aland Islands"  ? 'selected' : '' }}>Aland Islands</option>
                                            ...
                                            <option value="American Samoa" {{ $customer->country == "American Samoa"  ? 'selected' : '' }}>American Samoa</option>
                                            ...
                                            <option value="Antigua and Barbuda" {{ $customer->country == "Antigua and Barbuda"  ? 'selected' : '' }}>Antigua and Barbuda</option>
                                            ...
                                            <option value="Bolivia, Plurinational State of" {{ $customer->country == "Bolivia, Plurinational State of"  ? 'selected' : '' }}>Bolivia, Plurinational State of</option>
                                            <option value="Bonaire, Sint Eustatius and Saba" {{ $customer->country == "Bonaire, Sint Eustatius and Saba"  ? 'selected' : '' }}>Bonaire, Sint Eustatius and Saba</option>
                                            <option value="Bosnia and Herzegovina" {{ $customer->country == "Bosnia and Herzegovina"  ? 'selected' : '' }}>Bosnia and Herzegovina</option>
                                            ...
                                            <option value="British Indian Ocean Territory" {{ $customer->country == "British Indian Ocean Territory"  ? 'selected' : '' }}>British Indian Ocean Territory</option>
                                            <option value="Brunei Darussalam" {{ $customer->country == "Brunei Darussalam"  ? 'selected' : '' }}>Brunei Darussalam</option>
                                            <option value="Bulgaria" {{ $customer->country == "Bulgaria"  ? 'selected' : '' }}>Bulgaria</option>
                                            <option value="Burkina Faso" {{ $customer->country == "Burkina Faso"  ? 'selected' : '' }}>Burkina Faso</option>
                                            ...
                                            <option value="Cayman Islands" {{ $customer->country == "Cayman Islands"  ? 'selected' : '' }}>Cayman Islands</option>
                                            <option value="Central African Republic" {{ $customer->country == "Central African Republic"  ? 'selected' : '' }}>Central African Republic</option>
                                            ...
                                            <option value="Christmas Island" {{ $customer->country == "Christmas Island"  ? 'selected' : '' }}>Christmas Island</option>
                                            <option value="Cocos (Keeling) Islands" {{ $customer->country == "Cocos (Keeling) Islands"  ? 'selected' : '' }}>Cocos (Keeling) Islands</option>
                                            ...
                                            <option value="Cook Islands" {{ $customer->country == "Cook Islands"  ? 'selected' : '' }}>Cook Islands</option>
                                            <option value="Costa Rica" {{ $customer->country == "Costa Rica"  ? 'selected' : '' }}>Costa Rica</option>
                                            <option value="Côte d'Ivoire" {{ $customer->country == "Côte d'Ivoire"  ? 'selected' : '' }}>Côte d'Ivoire</option>
                                            ...
                                            <option value="Czech Republic" {{ $customer->country == "Czech Republic"  ? 'selected' : '' }}>Czech Republic</option>
                                            ...
                                            <option value="Dominican Republic" {{ $customer->country == "Dominican Republic"  ? 'selected' : '' }}>Dominican Republic</option>
                                            ...
                                            <option value="Equatorial Guinea" {{ $customer->country == "Equatorial Guinea"  ? 'selected' : '' }}>Equatorial Guinea</option>
                                            ...
                                            <option value="Falkland Islands (Malvinas)" {{ $customer->country == "Falkland Islands (Malvinas)"  ? 'selected' : '' }}>Falkland Islands (Malvinas)</option>
                                            ...
                                            <option value="French Polynesia" {{ $customer->country == "French Polynesia"  ? 'selected' : '' }}>French Polynesia</option>
                                            ...
                                            <option value="Guinea-Bissau" {{ $customer->country == "Guinea-Bissau"  ? 'selected' : '' }}>Guinea-Bissau</option>
                                            <option value="Haiti" {{ $customer->country == "Haiti"  ? 'selected' : '' }}>Haiti</option>
                                            <option value="Holy See (Vatican City State)" {{ $customer->country == "Holy See (Vatican City State)"  ? 'selected' : '' }}>Holy See (Vatican City State)</option>
                                            ...
                                            <option value="Iran, Islamic Republic of" {{ $customer->country == "Iran, Islamic Republic of"  ? 'selected' : '' }}>Iran, Islamic Republic of</option>
                                            ...
                                            <option value="Korea, Democratic People's Republic of" {{ $customer->country == "Korea, Democratic People's Republic of"  ? 'selected' : '' }}>Korea, Democratic People's Republic of</option>
                                            ...
                                            <option value="Lao People's Democratic Republic" {{ $customer->country == "Lao People's Democratic Republic"  ? 'selected' : '' }}>Lao People's Democratic Republic</option>
                                            ...
                                            <option value="Liechtenstein" {{ $customer->country == "Liechtenstein"  ? 'selected' : '' }}>Liechtenstein</option>
                                            ...
                                            <option value="Marshall Islands" {{ $customer->country == "Marshall Islands"  ? 'selected' : '' }}>Marshall Islands</option>
                                            ...
                                            <option value="Micronesia, Federated States of" {{ $customer->country == "Micronesia, Federated States of"  ? 'selected' : '' }}>Micronesia, Federated States of</option>
                                            <option value="Moldova, Republic of" {{ $customer->country == "Moldova, Republic of"  ? 'selected' : '' }}>Moldova, Republic of</option>
                                            ...
                                            <option value="Norfolk Island" {{ $customer->country == "Norfolk Island"  ? 'selected' : '' }}>Norfolk Island</option>
                                            <option value="Northern Mariana Islands" {{ $customer->country == "Northern Mariana Islands"  ? 'selected' : '' }}>Northern Mariana Islands</option>
                                            ...
                                            <option value="Palestinian Territory, Occupied" {{ $customer->country == "Palestinian Territory, Occupied"  ? 'selected' : '' }}>Palestinian Territory, Occupied</option>
                                            <option value="Panama" {{ $customer->country == "Panama"  ? 'selected' : '' }}>Panama</option>
                                            <option value="Papua New Guinea" {{ $customer->country == "Papua New Guinea"  ? 'selected' : '' }}>Papua New Guinea</option>
                                            ...
                                            <option value="Russian Federation" {{ $customer->country == "Russian Federation"  ? 'selected' : '' }}>Russian Federation</option>
                                            <option value="Rwanda" {{ $customer->country == "Rwanda"  ? 'selected' : '' }}>Rwanda</option>
                                            <option value="Saint Barthélemy" {{ $customer->country == "Saint Barthélemy"  ? 'selected' : '' }}>Saint Barthélemy</option>
                                            <option value="Saint Kitts and Nevis" {{ $customer->country == "Saint Kitts and Nevis"  ? 'selected' : '' }}>Saint Kitts and Nevis</option>
                                            <option value="Saint Lucia" {{ $customer->country == "Saint Lucia"  ? 'selected' : '' }}>Saint Lucia</option>
                                            <option value="Saint Martin (French part)" {{ $customer->country == "Saint Martin (French part)"  ? 'selected' : '' }}>Saint Martin (French part)</option>
                                            <option value="Saint Vincent and the Grenadines" {{ $customer->country == "Saint Vincent and the Grenadines"  ? 'selected' : '' }}>Saint Vincent and the Grenadines</option>
                                            ...
                                            <option value="Sao Tome and Principe" {{ $customer->country == "Sao Tome and Principe"  ? 'selected' : '' }}>Sao Tome and Principe</option>
                                            <option value="Saudi Arabia" {{ $customer->country == "Saudi Arabia"  ? 'selected' : '' }}>Saudi Arabia</option>
                                            ...
                                            <option value="Sierra Leone" {{ $customer->country == "Sierra Leone"  ? 'selected' : '' }}>Sierra Leone</option>
                                            <option value="Singapore" {{ $customer->country == "Singapore"  ? 'selected' : '' }}>Singapore</option>
                                            <option value="Sint Maarten (Dutch part)" {{ $customer->country == "Sint Maarten (Dutch part)"  ? 'selected' : '' }}>Sint Maarten (Dutch part)</option>
                                            ...
                                            <option value="Solomon Islands" {{ $customer->country == "Solomon Islands"  ? 'selected' : '' }}>Solomon Islands</option>
                                            <option value="Somalia" {{ $customer->country == "Somalia"  ? 'selected' : '' }}>Somalia</option>
                                            <option value="South Africa" {{ $customer->country == "South Africa"  ? 'selected' : '' }}>South Africa</option>
                                            ...
                                            <option value="Syrian Arab Republic" {{ $customer->country == "Syrian Arab Republic"  ? 'selected' : '' }}>Syrian Arab Republic</option>
                                            <option value="Taiwan, Province of China" {{ $customer->country == "Taiwan, Province of China"  ? 'selected' : '' }}>Taiwan, Province of China</option>
                                            <option value="Tajikistan" {{ $customer->country == "Tajikistan"  ? 'selected' : '' }}>Tajikistan</option>
                                            <option value="Tanzania, United Republic of" {{ $customer->country == "Tanzania, United Republic of"  ? 'selected' : '' }}>Tanzania, United Republic of</option>
                                            ...
                                            <option value="Trinidad and Tobago" {{ $customer->country == "Trinidad and Tobago"  ? 'selected' : '' }}>Trinidad and Tobago</option>
                                            ...
                                            <option value="Turkmenistan" {{ $customer->country == "Turkmenistan"  ? 'selected' : '' }}>Turkmenistan</option>
                                            <option value="Turks and Caicos Islands" {{ $customer->country == "Turks and Caicos Islands"  ? 'selected' : '' }}>Turks and Caicos Islands</option>
                                            ...
                                            <option value="United Arab Emirates" {{ $customer->country == "United Arab Emirates"  ? 'selected' : '' }}>United Arab Emirates</option>
                                            <option value="United Kingdom" {{ $customer->country == "United Kingdom"  ? 'selected' : '' }}>United Kingdom</option>
                                            <option value="United States" {{ $customer->country == "United States"  ? 'selected' : '' }}>United States</option>
                                            ...
                                            <option value="Venezuela, Bolivarian Republic of" {{ $customer->country == "Venezuela, Bolivarian Republic of"  ? 'selected' : '' }}>Venezuela, Bolivarian Republic of</option>
                                            <option value="Vietnam" {{ $customer->country == "Vietnam"  ? 'selected' : '' }}>Vietnam</option>
                                            <option value="Virgin Islands" {{ $customer->country == "Virgin Islands"  ? 'selected' : '' }}>Virgin Islands</option>
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-6 detail-toggle-class-edit d-none">
                                        ...
                                        <input type="text" name="zip_code" id="zip_code" value="{{old('zip_code',$customer->zip_code)}}" class="form-control" placeholder="Zip Code">
                                    </div>
                                </div>
                                <hr style="opacity: 0.3;" class="detail-toggle-class-edit d-none">
                                <div class="row mt-6 detail-toggle-class-edit d-none">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_1" class="form-label">Custom Field 1</label>
                                        <input type="text" name="custom_field_1" id="custom_field_1" value="{{old('custom_field_1',$customer->custom_field_1)}}" class="form-control" placeholder="Custom Field 1">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_2" class="form-label">Custom Field 2</label>
                                        <input type="text" name="custom_field_2" id="custom_field_2" value="{{old('custom_field_2',$customer->custom_field_2)}}" class="form-control" placeholder="Custom Field 2">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_3" class="form-label">Custom Field 3</label>
                                        <input type="text" name="custom_field_3" id="custom_field_3" value="{{old('custom_field_3',$customer->custom_field_3)}}" class="form-control" placeholder="Custom Field 3">
                                    </div>
                                </div>
                                <div class="row detail-toggle-class-edit d-none">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_4" class="form-label">Custom Field 4</label>
                                        <input type="text" name="custom_field_4" id="custom_field_4" value="{{old('custom_field_4',$customer->custom_field_4)}}" class="form-control" placeholder="Custom Field 4">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_5" class="form-label">Custom Field 5</label>
                                        <input type="text" name="custom_field_5" id="custom_field_5" value="{{old('custom_field_5',$customer->custom_field_5)}}" class="form-control" placeholder="Custom Field 5">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_6" class="form-label">Custom Field 6</label>
                                        <input type="text" name="custom_field_6" id="custom_field_6" value="{{old('custom_field_6',$customer->custom_field_6)}}" class="form-control" placeholder="Custom Field 6">
                                    </div>
                                </div>
                                <div class="row detail-toggle-class-edit d-none">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_7" class="form-label">Custom Field 7</label>
                                        <input type="text" name="custom_field_7" id="custom_field_7" value="{{old('custom_field_7',$customer->custom_field_7)}}" class="form-control" placeholder="Custom Field 7">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_8" class="form-label">Custom Field 8</label>
                                        <input type="text" name="custom_field_8" id="custom_field_8" value="{{old('custom_field_8',$customer->custom_field_8)}}" class="form-control" placeholder="Custom Field 8">
                                    </div>
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_9" class="form-label">Custom Field 9</label>
                                        <input type="text" name="custom_field_9" id="custom_field_9" value="{{old('custom_field_9',$customer->custom_field_9)}}" class="form-control" placeholder="Custom Field 9">
                                    </div>
                                </div>
                                <div class="row detail-toggle-class-edit d-none">
                                    <div class="col-md-4 col-sm-12 mb-6">
                                        <label for="custom_field_10" class="form-label">Custom Field 10</label>
                                        <input type="text" name="custom_field_10" id="custom_field_10" value="{{old('custom_field_10',$customer->custom_field_10)}}" class="form-control" placeholder="Custom Field 10">
                                    </div>
                                </div>
                                <hr style="opacity: 0.3;" class="detail-toggle-class-edit d-none">
                                <div class="row mt-6 detail-toggle-class-edit d-none">
                                    <div class="col-md-5 col-sm-12">
                                        ...
                                        <textarea name="shipping_address" id="shipping_address" class="form-control" style="resize: none;">{{ old('shipping_address',!empty($customer->shipping_address) ? $customer->shipping_address : null) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
