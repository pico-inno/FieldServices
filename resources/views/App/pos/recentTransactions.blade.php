                                        ...
                                        @foreach ($saleDelivered as $sd)
                                            <tr>
                                                ...
                                                <td class="d-flex flex-row">
                                                    ...
                                                    <span class="me-5 print-invoice" data-href="{{route('pos.pryment-print-layout', [
                                                        'id'=>$sd->id,
                                                        'layout_id'=>$posRegister->invoice_layout_id
                                                    ])}}"><i class="fas fa-print fs-5 text-primary cursor-pointer"></i></span>
