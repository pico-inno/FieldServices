                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            ...
                            <select name="type" class="form-select" id="contact-type" data-control="select2" required aria-label="Select example">
                    ...
                    <div class="form-group text-center mt-5 toggle-details-btn" id="show_more_info">
                        <button type="button" class="btn btn-primary btn-lg moreBtn rounded text-white show_detail" id="show_more_info_btn">
                            <i class="fa-solid fa-eye-slash me-5"></i> Show Details
                        </button>
                        <button type="button" class="btn btn-primary btn-lg moreBtn rounded text-white hide_detail d-none" id="show_more_info_btn">
