                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-12 mb-6">
                            ...
                            <input type="text" name="contact_id" id="contact_id" class="form-control form-control-sm fs-7"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 mb-8 business-div hide">
                            ...
                            <input type="text" name="company_name" id="company_name" class="form-control form-control-sm fs-7"
                    ...
                    <div class="row individual-div">
                        <div class="col-md-3 col-sm-12 mb-8">
                            ...
                            <input type="text" name="prefix" id="prefix" class="form-control form-control-sm fs-7"
                                placeholder="Mr / Mrs / Miss" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="first_name" class="form-label">First Name</label>
                            <input type="text" name="first_name" id="first_name" class="form-control form-control-sm fs-7"
                                placeholder="First Name" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="middle_name" class="form-label">Middle Name</label>
                            <input type="text" name="middle_name" id="middle_name" class="form-control form-control-sm fs-7"
                                placeholder="Middle Name" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="last_name" class="form-label">Last Name</label>
                            <input type="text" name="last_name" id="last_name" class="form-control form-control-sm fs-7"
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12 mb-8">
                            ...
                            <input type="text" name="mobile" id="mobile" class="form-control form-control-sm fs-7" placeholder="Mobile"
                                required />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                        ...
                        <div class="col-md-3 col-sm-12 mb-8 individual-div">
                            ...
                            <input type="text" name="dob" id="dob_create" class="form-control form-control-sm fs-7" placeholder="Date of birth"
                                autocomplete="off" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="age" class="form-label">Age</label>
                            <input type="text" name="age" id="age" class="form-control form-control-sm fs-7 age" placeholder="Age" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="alternate_number" class="form-label">Alternate Contact Number</label>
                            <input type="text" name="alternate_number" id="alternate_number" class="form-control form-control-sm fs-7"
                                placeholder="Alternate Contact Numbe" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="landline" class="form-label">Landline</label>
                            <input type="text" name="landline" id="landline" class="form-control form-control-sm fs-7"
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12 mb-8">
                            ...
                            <input type="text" name="address_line_1" id="address_line_1" class="form-control form-control-sm fs-7"
                                placeholder="Address Line 1">
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="address_line_2" class="form-label">Address Line 2</label>
                            <input type="text" name="address_line_2" id="address_line_2" class="form-control form-control-sm fs-7"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 mb-8">
                            ...
                            <input type="text" name="zip_code" id="zip_code" class="form-control form-control-sm fs-7"
                    ...
                    <div id="more-info-fields" class="mt-8" style="display: none;">
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="text" name="tax_number" id="tax_number" class="form-control form-control-sm fs-7"
                            ...
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="number" name="payable_amount" id="payable_amount" class="form-control form-control-sm fs-7"
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8 credit-limit">
                                ...
                                <input type="number" name="credit_limit" id="credit_limit" class="form-control form-control-sm fs-7"
                        ...
                        <div class="row mt-6">
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="text" name="custom_field_1" id="custom_field_1" class="form-control form-control-sm fs-7"
                                    placeholder="Custom Field 1">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_2" class="form-label">Custom Field 2</label>
                                <input type="text" name="custom_field_2" id="custom_field_2" class="form-control form-control-sm fs-7"
                                    placeholder="Custom Field 2">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_3" class="form-label">Custom Field 3</label>
                                <input type="text" name="custom_field_3" id="custom_field_3" class="form-control form-control-sm fs-7"
                                    placeholder="Custom Field 3">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_4" class="form-label">Custom Field 4</label>
                                <input type="text" name="custom_field_4" id="custom_field_4" class="form-control form-control-sm fs-7"
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="text" name="custom_field_5" id="custom_field_5" class="form-control form-control-sm fs-7"
                                    placeholder="Custom Field 5">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_6" class="form-label">Custom Field 6</label>
                                <input type="text" name="custom_field_6" id="custom_field_6" class="form-control form-control-sm fs-7"
                                    placeholder="Custom Field 6">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_7" class="form-label">Custom Field 7</label>
                                <input type="text" name="custom_field_7" id="custom_field_7" class="form-control form-control-sm fs-7"
                                    placeholder="Custom Field 7">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_8" class="form-label">Custom Field 8</label>
                                <input type="text" name="custom_field_8" id="custom_field_8" class="form-control form-control-sm fs-7"
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="text" name="custom_field_9" id="custom_field_9" class="form-control form-control-sm fs-7"
                                    placeholder="Custom Field 9">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_10" class="form-label">Custom Field 10</label>
                                <input type="text" name="custom_field_10" id="custom_field_10" class="form-control form-control-sm fs-7"
...
<script>
    $(document).ready(function() {
        ...
        new tempusDominus.TempusDominus(document.getElementById('dob_create'), {
                localization: {
                locale: "en",
                format: "dd/MM/yyyy",
            }
        });
        $(document).on('change', '#dob_create', function () {
            let dobString = $('#dob_create').val();
            ...
            if (dob) {
                ...
                $(this).closest('#add_contact_form').find('.age').val(age);
            }
        })
        ...
        $(business).off('change').on('change', function() {
            for(let i = 0; i < individualdivs.length; i++){
        ...
        $(contact_type).off('click').on('click', function(){
