    ...
    <div style="height: 100vh; overflow: hidden; ">
        ...
        <div class="row bg-primary px-2 mh-80px ">
            <div class=" d-flex  justify-content-between align-items-center ">
                ...
                <div class="d-flex">
                    <a href="{{ route('home') }}" class="btn btn-sm  rounded-0"> <i
                            class="fa-solid fa-house text-light fs-3"></i></a>
                    @if ($posRegister->use_for_res == '1')
                        <select name="table_id" id="table_nav_id" autofocus="false" data-placeholder="Select Table"
                            placeholder="Select Table"
                            class="w-150px form-select form-select-sm form-select w-auto m-0 border border-1 border-top-0 border-right-0 border-left-0 rounded-0 border-gray-300 text-light table_id tableSelect"
                ...
                <div class="">
                    <button class="btn btn-sm  text-dark fw-bold  rounded-0"
                        data-href="{{ route('pos.recentSale', $posRegister->id) }}" id="pos_sale_recent_btn"><i
                            class="fa-solid fa-clock-rotate-left fs-3 text-white"></i></button>
                    <button class="btn btn-sm  btn-danger fw-bold  rounded-0"
                        data-href="{{ route('pos.closeSession', [
        ...
        <div class="content d-flex flex-column flex-column-fluid ms-8 " id="pos_kt_content" style="height:100%;">
            ...
            <div class="container-fluid  pe-1 h-100" id="kt_content_container">
                ...
                <div class="d-flex flex-column flex-lg-row p-2">
                    <!--begin::Content-->
                    <div class="d-flex flex-column flex-row-fluid me-lg-9 mb-lg-0 me-xl-9 mb-10 mb-xl-0"
                        style="height: 100vh;">
                        <div class="row mt-3" style="max-height: 5%">
                            <div class="col-6">
                                <select name="business_location_id" id="business_location_id"
                                    class="form-select form-select-sm me-2" data-kt-select2="true"
                                    data-placeholder="Select locations">
                                    <option></option>
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->id }}" @selected(Auth::user()->default_location_id == $location->id)>
                                            {{ $location->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-6">
                                <select name="selling_price_group" id="selling_price_group"
                                    class="form-select form-select-sm " data-kt-select2="true"
                                    data-placeholder="Select selling price group">
                        ...
                        <div class="row mt-3" style="max-height: 5%">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" name="pos_product_search"
                                    autocomplete="false" placeholder="Search products...">
                                <span class="input-group-text custom-tooltip productQuickAdd"
                                    data-href="{{ route('product.quickAdd') }}" type="button">
                    ...
                    <!--end::Content-->
                    <!--begin::Sidebar-->
                    <div class="flex-row-auto w-lg-550px w-xl-650px mt-3 d-none d-md-none d-sm-none d-lg-block d-xl-block mb-5 pe-3"
                        id="invoice_side_bar" style="height: 100vh;">

                        <div class="row mb-1" style="max-height: 5%;z-index: 200;">
                            <div class="input-group input-group-solid flex-nowrap">
                                <x-customersearch placeholder='Select customer name' id="sb_pos_customer"
                                    name="pos_customer"
                                    className="form-select rounded-end-0 border-start border-end" />
                                <span class="input-group-text border-gray-300 cursor-pointer" data-bs-toggle="modal"
                                    data-bs-target="#contact_add_modal" data-href="{{ route('pos.contact.add') }}">
                                    <i class="fa-solid fa-circle-plus text-primary fs-3"></i>
                                </span>

                                <span class="input-group-text border-gray-300 cursor-pointer contact_edit_btn "
                                    id="contact_edit_btn">
                                    <i class="fas fa-edit text-success-emphasis"></i>
                                </span>

                                <span class="input-group-text border-gray-300 cursor-pointer"
                                    id="contact_edit_phone_btn">
                        ...
                        <div class="row position-relative " style="height: 95%">
                            <div class="table-responsive position-absolute top-0"
                                style="max-height: 60%; overflow: scroll;padding-bottom: 300px">
                                <table id="kt_datatable_zero_configuration invoice_with_sidebar_table"
                                    class="table table-row-bordered w-100">
                                    <thead class="table-layout-fixed bg-light"
                            ...
                            <div class="position-absolute " style="z-index: 600;bottom:30px"
                                id="info_price_with_sidebar">
                                <div
                                    class="row bg-primary rounded-3 px-3 py-5 mb-3 justify-content-between align-items-center">
                                    <div class="col-6 d-flex justify-content-between   text-white">
                                        ...
                                        <div class="fs-7 fw-bold  text-end">
                                            <span class="d-block lh-1  mb-6 sb-item-quantity"
                                    ...
                                    <div class="col-12 d-flex flex-stack text-white my-2 mt-3">
                                        ...
                                        <div class="fs-6 fw-bold  text-end">
                                            <span class="d-inline-block fs-md-2 lh-1 sb-total-amount"
                                ...
                                <div class="row  px-3 py-2 ">
                                    <div class="col-7">
                                        <div class="d-flex  flex-equal gap-5  justify-content-around px-0 mb-5"
                                            data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                            <div class="row mb-3 g-1">
                                                <label
                                                    class="for_disable_btn mb-3 btn btn-light  btn-sm  border border-1 border-gray-600 hover-elevate-up w-100 px-4"
                                                    data-kt-button="true">
                                                    <!--begin::Input-->
                                                    ...
                                                    <!--begin::Title-->
                                                    <span
                                                        class="fs-7 text-dark fw-bold d-block sale_credit">Credit</span>
                                                    <!--end::Title-->
                                                </label>
                                                <!--end::Radio-->
                                                <!--begin::Radio-->
                                                @if ($posRegister->use_for_res == '1')
                                                    <label data-bs-toggle="modal" id="order_confirm_modal_btn"
                                                        data-bs-target="#order_confirm_modal"
                                                        class="for_disable_btn mb-3 btn btn-light  btn-sm  border border-1 border-gray-600 border-gray-100 hover-elevate-up w-100 px-4 order_confirm_modal_btn"
                                                        data-kt-button="true">
                                                        <input class="btn-check" type="radio" name="method"
                                                            value="1" />
                                                ...
                                                @else
                                                    <label
                                                        class="for_disable_btn mb-3 btn btn-light  btn-sm  border border-1 border-gray-600 hover-elevate-up w-100 px-4 finalizeOrder"
                                                        data-kt-button="true">
                                            ...
                                            <div class="row mb-3 g-1">
                                                ...
                                                <label
                                                    ...
                                                    <!--begin::Title-->
                                                    <span
                                                        class="fs-7 text-dark fw-bold d-block sale_draft">Draft</span>
                                                    <!--end::Title-->
                                                </label>
                                                <!--end::Radio-->
                                                <label
                                                    class="for_disable_btn mb-3 btn btn-light  btn-sm  border border-1 border-gray-600  rounded rounded-1 hover-elevate-up w-100 px-4 split_order_modal_btn_from_create"
                                                    data-kt-button="true">
                                                    <input class="btn-check" type="radio" name="method"
                                                        value="1" />
                                    ...
                                    <div class="col-5 btn-primary text-center " data-bs-toggle="modal"
                                        data-bs-target="#payment_info">
                                        <input type="submit" class="btn btn-lg btn-success d-block for_disable_btn "
                                            value="Payment" style="width: 100%; height: 70%;">
                                    </div>
        ...
        <!--begin::Content-->
        <div class="content pb-15 d-flex flex-column flex-column-fluid ms-8 d-none d-lg-none d-xl-none d-xxl-none "
            id="pos_second_content" style="height: 100vh">
            <!--begin::container-->
                ...
                <div class="card  card-flush" style="height: 100%; overflow: hidden">
                    <div class="card-body p-5">
                        <div class="row mb-1">
                            <div class="col-12">
                                <div class="input-group input-group-solid input-group-sm mb-2 flex-nowrap">
                                    ...
                                    <x-customersearch placeholder='Select customer name' id="pos_customer"
                                        name="pos_customer"
                                        className="form-select rounded-end-0 border-start border-end" />
                                    <span class="input-group-text border-gray-300 cursor-pointer "
                                        data-bs-toggle="modal" data-bs-target="#contact_add_modal"
                                        data-href="{{ route('pos.contact.add') }}">
                                        <i class="fa-solid fa-circle-plus text-primary fs-3"></i>
                                    </span>

                                    <span class="input-group-text border-gray-300 cursor-pointer contact_edit_btn "
                                        id="contact_edit_btn_modal">
                                        <i class="fas fa-edit text-success-emphasis"></i>
                                    </span>

                                    <span class="input-group-text border-gray-300 cursor-pointer "
                                        id="contact_edit_phone_btn_modal"><i
                                            class="fa-sharp fa-solid fa-phone text-info"></i>
                                    </span>
                        ...
                        <div class="row  " style="height: 95%">
                            <div class="table-responsive position-absolute top-30"
                                style="max-height: 60%; overflow: scroll;padding-bottom: 300px">
                            ...
                            <div id="info_price_with_modal" class="position-absolute  bg-light px-5"
                                style="z-index: 600;bottom:0px;left: 0;">
                                <div class="row bg-primary rounded-3 px-3 py-5 mb-3 ">
                                    <div class="col-12 d-flex flex-stack text-white ">
                                        ...
                                        <div class="fs-7 fs-md-6 fw-bold text-end">
                                            <span class="d-block lh-1  mb-4 sb-item-quantity"
                                                data-kt-pos-element="total"></span>
                                            <span class="d-block lh-1  mb-4 sb-total"
                                                data-kt-pos-element="total"></span>
                                            <span class="d-block mb-5 mb-4 sb-discount"
                                    ...
                                    <div class="col-12 d-flex flex-stack text-white my-2 mt-3">
                                        ...
                                        <div class="fs-9 fw-bold  text-end">
                                            <span class="d-block fs-md-1 fs-2 fs-md-2x lh-1 sb-total-amount"
                                ...
                                <div class="row  px-3 py-2">
                                    <div class="col-md-7 col-sm-8 col-12">
                                        <div class="col-12 d-flex  flex-equal gap-5  justify-content-around px-0 mb-sm-5 align-items-center"
                                            data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">
                                            <div class="row mb-sm-3 col-6">
                                                <label
                                                    class=" mb-3 btn  btn-sm bg-light btn-color-gray-900  border border-3 border-gray-100 hover-elevate-up w-100 px-4"
                                                    data-kt-button="true">
                                                    <!--begin::Input-->
                                                    <input class="btn-check" type="radio" name="method"
                                                        value="0" />
                                                ...
                                                @if ($posRegister->use_for_res == '1')
                                                    <label data-bs-toggle="modal"
                                                        data-bs-target="#order_confirm_modal"
                                                        class="for_disable_btn mb-3 btn  btn-sm  bg-light btn-color-gray-900  border border-3 border-gray-100 hover-elevate-up w-100 px-4 order_confirm_modal_btn"
                                                        data-kt-button="true">
                                                        <input class="btn-check" type="radio" name="method"
                                                            value="1" />
                                                        <button
                                                            class="btn btn-sm  text-dark fw-bold  rounded-0">Order</button>
                                                    </label>
                                                @else
                                                    <label
                                                        class="for_disable_btn mb-3 btn  btn-sm  bg-light btn-color-gray-900  border border-3 border-gray-100 hover-elevate-up w-100 px-4 finalizeOrder"
                                                        data-kt-button="true">
                                                        <input class="btn-check" type="radio" name="method"
                                                            value="1" />
                                                        <button
                                            ...
                                            <div class="row mb-sm-3 col-6">
                                                ...
                                                <!--end::Radio-->
                                                <label
                                                    class="for_disable_btn mb-3 btn  btn-sm   rounded rounded-1 btn-color-gray-900  border border-3 border-gray-100 hover-elevate-up w-100 px-4 split_order_modal_btn_from_create"
                                                    data-kt-button="true">
                                                    <input class="btn-check" type="radio" name="method"
                                                        value="1" />
                                    ...
                                    <div class="col-md-5 col-sm-4 col-12  btn-primary text-center"
                                        data-bs-toggle="modal" data-bs-target="#payment_info">
                                        <input type="submit"
                                            class="btn btn-lg btn-success d-block text-center h-sm-100px"
                                            value="Payment" style="width: 100%; ">
                                    </div>
        ...
        <div class="app-engage" id="kt_app_engage">
            <button class="app-engage-btn hover-gray bg-success text-white" data-bs-toggle="modal"
                data-bs-target="#filter_category">
                <span class="landscape-text">Category</span>
            </button>
            <button class="app-engage-btn hover-gray bg-primary text-white" data-bs-toggle="modal"
                data-bs-target="#filter_sub_category">
                <span class="landscape-text">Sub Category</span>
            </button>
            <button class="app-engage-btn hover-gray bg-warning text-white" data-bs-toggle="modal"
                data-bs-target="#filter_brand">
                <span class="landscape-text">Brand</span>
            </button>
            <button class="app-engage-btn hover-gray  bg-info text-white" data-bs-toggle="modal"
                data-bs-target="#filter_manufacturer">
                <span class="landscape-text">Manufacturer</span>
            </button>
            <button class="app-engage-btn hover-gray generic bg-success text-white" data-bs-toggle="modal"
                data-bs-target="#filter_generic">
        ...
        <div class="app-engage-secondary" style="z-index: 700;">
            <button
                ...
                <span
                    class="position-absolute top-0 start-0 translate-middle badge rounded-pill bg-danger badgeQtyCount">
                    0
                </span>
        ...
        <div class="modal-dialog modal-dialog-scrollable w-lg-600px">
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    ...
                    <div
                        class="card  border border-left-0 border-right-0 border-bottom-0 border-top-1 border-primary  ">
                        <div class="card-body">
                            <!--begin::Repeater-->
                                    ...
                                    <form action="" id="paymentForm">
                                        @if (count($reservations) > 0)
                                            <div class="folio-Form mb-5">
                                                <div class="form-group">
                                                    <label for="" class="form-label fw-bold">Post to
                                                        Folio</label>
                                                    <select name="reservation_id_from_delivered"
                                                        class="form-select form-select-sm reservation_id"
                                                        data-placeholder="Select Reservation"
                                                        placeholder='Select Reservation' data-kt-select2="true"
                                                        data-allow-clear="true" data-dropdown-parent="#payment_info"
                                                        autofocus="false">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info btn-sm payment_save_btn"
                        data-bs-dismiss="modal">Save</button>
                    <button type="button" class="btn btn-primary btn-sm" id="payment_print"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body sec-custom-modal-body">
                    @foreach ($categories as $category)
                        <div class="mb-5">
                            <input class="form-check-input me-3 cursor-pointer" name="filter_parent_category_id"
                                type="radio" value="{{ $category->id }}"
                                id="filter_parent_category_{{ $category->id }}" />
                ...
                <div class="modal-body sec-custom-modal-body">
                    @foreach ($categories as $category)
                        @if ($category->parent_id !== null)
                            <div class="mb-5">
                                <input class="form-check-input me-3 cursor-pointer" name="filter_child_category_id"
                                    type="radio" value="{{ $category->id }}"
                                    id="filter_child_category_id_{{ $category->id }}" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body sec-custom-modal-body">
                    ...
                    @foreach ($brands as $brand)
                        <div class="mb-5">
                            <input class="form-check-input me-3 cursor-pointer" name="filter_brand_id" type="radio"
                                value="{{ $brand->id }}" id="filter_brand_id_{{ $brand->id }}" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body sec-custom-modal-body">
                    @foreach ($manufacturers as $manu)
                        <div class="mb-5">
                            <input class="form-check-input me-3 cursor-pointer" name="filter_manufacturer_id"
                                type="radio" value="{{ $manu->id }}"
                                id="filter_manufacturer_id_{{ $manu->id }}" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body sec-custom-modal-body">
                    @foreach ($generics as $generic)
                        <div class="mb-5">
                            <input class="form-check-input me-3 cursor-pointer" name="filter_generic_id"
                                type="radio" value="{{ $generic->id }}"
                                id="filter_generic_id_{{ $generic->id }}" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row mb-5">
                        <div class="col-12">
                            ...
                            <select class="form-select mb-2 form-select-sm rounded-0" id="packaging_modal"
                                name="packaging_id" data-control="select2" data-placeholder="Select Packaging"
                                placeholder="Select Packaging" data-hide-search="true" data-allow-clear="true">
                    ...
                    <div class="row mb-5">
                        <div class="col-12">
                            ...
                            <select class="form-select mb-2 form-select-sm rounded-0" disabled
                                name="each_selling_price" data-control="select2" data-placeholder="-"
                                placeholder="-" data-hide-search="true">
                    ...
                    <div class="row mb-5">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-sm rounded-0"
                                name="modal_price_without_dis" value="" readonly>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-6">
                            <label for="" class="fs-5">Discount Type</label>
                            <select class="form-select mb-2 form-select-sm rounded-0" name="invoice_row_discount_type"
                    ...
                    <div class="row mb-5">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control form-control-sm rounded-0"
                                name="subtotal_with_discount" value="">
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-12">
                            <label for="" class="fs-5">Note</label>
                            <textarea name="item_detail_note_input" id="item_detail_note_input" cols="30" rows="4"
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-bs-dismiss="modal"
                        id="saveExtraSetting">Save</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable  w-md-500px">
            <div class="modal-content">
                    ...
                    <div class="folio-Form p-5">
                        <div class="form-group">
                            ...
                            <select name="reservation_id_from_order" class="form-select form-select-sm reservation_id"
                                data-placeholder="Select Reservation" placeholder='Select Reservation'
                                data-kt-select2="true" data-allow-clear="true"
                                data-dropdown-parent="#order_confirm_modal" autofocus="false">
                ...
                <div class="p-5 pt-0">
                    ...
                    <select name="services" class="form-select form-select-sm" id="services" placeholder="Services"
                        data-placeholder="Services" data-kt-select2="true" data-hide-search="true">
                ...
                <div class="px-5 mt-3 mb-5">
                    <select id="tableForFinalize" autofocus="false" data-placeholder="Select Table"
                        placeholder="Select Table" class="form-select form-select-sm tableSelect"
                        data-kt-select2="true" data-allow-clear="true">
                        <option disabled selected>Select Table</option>
                        @if ($tables)
                            @foreach ($tables as $table)
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm finalizeOrder" id=""
                        data-bs-dismiss="modal">Finalize Order</button>
                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                </div>
            </div>
        </div>
                    ...
                    <div class="modal-body ">
                        <div class="row mb-5">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control form-control-sm rounded-0"
                                    name="customer_name" readonly value="">
                            </div>
                        </div>
                        <div class="row mb-5">
                            <div class="col-12">
