                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                        ...
                        <div class="me-7 mb-4">
                            <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                <img src="{{$current_user->personal_info->profile_photo === null ? asset('assets/media/svg/avatars/blank.svg') : asset($current_user->personal_info->profile_photo) }}" alt="image" />
                            ...
                            <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$current_user->personal_info->initname.' '.$current_user->personal_info->first_name.' '.$current_user->personal_info->last_name}}</a>
                                        <a href="#">
                                    ...
                                    <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                            ...
                                            <!--end::Svg Icon-->{{$current_user->role->name}}</a>
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                        ...
                                        <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
                                            ...
                                            <!--end::Svg Icon-->{{$current_user->email}}</a>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::User-->
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 @yield('profile_active_show')" href="{{route('profile.index')}}">Overview</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
