                                            ...
                                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                                <div class="card-title">
                                                    ...
                                                    <div class="d-flex align-items-center position-relative my-1">
                                                        ...
                                                        <input type="text" id="unit-category-search" data-kt-filter="search" class="form-control form-control-sm form-control-solid w-250px ps-14" placeholder="Search Unit Category" />
                                                    </div>
                                                    <!--end::Search-->
                                                    ...
                                                    <table class="table align-middle  rounded table-row-dashed fs-6 g-5 unit-category-table" id="kt_datatable_example">
                                                        <thead>
                                                            ...
                                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                                                ...
                                                                <th class="min-w-100px text-center">{{ __('product/product.action') }}</th>
                                                            </tr>
                                                            <!--end::Table row-->
                                                        </thead>
                                        ...
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            <div class="card-title">
                                                ...
                                                <div class="d-flex align-items-center position-relative my-1">
                                                    ...
                                                    <input type="text" id="uom-search" data-kt-filter="search-stock" class="form-control form-control-sm form-control-solid w-250px ps-14" placeholder="Search Unit" />
                                                </div>
                                                <!--end::Search-->
                                                <!--begin::Export buttons-->
                                                <div id="kt_datatable_example_1_export" class="d-none"></div>
