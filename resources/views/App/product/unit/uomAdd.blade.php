						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade show active" id="kt_ecommerce_settings_general" role="tabpanel">
                                ...
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="name" value="" placeholder="UoM name"/>
                                        @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="short_name" value="" placeholder="UoM short name">
                                    </div>
                                    <div class="col-md-3"></div>
                                </div>
                                ...
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-select mb-2 form-select-sm unit_type" name="unit_type" data-control="select2" data-hide-search="true" data-placeholder="Select unit type">
                                            <option></option>
                                            <option value="reference">{{ __('product/unit-and-uom.reference') }}</option>
                                ...
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="value" value="" placeholder="Value">
                                        @error('value')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row fv-row mb-7">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control form-control-sm form-control-solid mb-2" name="rounded_amount" value="" placeholder="Rounded Amount">
                                    </div>
                                    <div class="col-md-3"></div>
                                </div>
							</div>
