            ...
            <form action="{{ route('import-product.create') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="">
                            <button type="submit" class="btn btn-success btn-sm">{{ __('product/import-product.submit')
                                }}</button>
                        </div>
                        <div class="mt-5">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped g-3">
                            ...
                            // 'name' => 'Applicable Tax',
                            // 'is_req' => false,
                            // 'instruction' => 'Name of the Tax Rate. If purchase Price (Excluding Tax) is not the same
                            as Purchase Price (Including Tax), then you must supply the tax rate name.',
                            // ],
                            // [
                            ...
                            'is_req' => false,
                            'instruction' => 'Packaging of product',
                            'note'=>"You can easily use the package to purchase or sell the product.",
                            ],
                            // [
                            // 'name' => 'Opening Stock',
                            // 'is_req' => false,
                            // 'instruction' => 'Opening Stock (Only in numbers). For variable products, separate stock
                            quantities with \'|\'. (Ex: 100|150|200)',
                            // ],
                            // [
                            // 'name' => 'Opening stock location',
                            // 'is_req' => false,
                            // 'instruction' => 'Name of the business location. If blank, the first business location
                            will be used',
                            // ],
                            // [
                            // 'name' => 'Expiry Date',
                            ...
                            // 'name' => 'Rack',
                            // 'is_req' => false,
                            // 'instruction' => 'Rack details separated by \'|\' for different business locations
                            serially. (Ex: R1|R5|R12)',
                            // ],
                            // [
                            // 'name' => 'Row',
                            // 'is_req' => false,
                            // 'instruction' => 'Row details separated by \'|\' for different business locations
                            serially. (Ex: ROW1|ROW2|ROW3)',
                            // ],
                            // [
                            // 'name' => 'Position',
                            // 'is_req' => false,
                            // 'instruction' => 'Position details separated by \'|\' for different business locations
                            serially. (Ex: POS1|POS2|POS3)',
                            // ],
                            ];
                            @endphp
                            <tbody>
