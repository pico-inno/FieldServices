...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('product/manufacturer.manufacturer_list') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{ __('product/product.product') }}</li>
        <li class="breadcrumb-item text-dark">{{ __('product/manufacturer.manufacturer_list') }}</li>
    </ul>
<!--end::Breadcrumb-->
@endsection
@section('content')
            ...
            <div class="card  card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        @endif
                        @if(hasCreate('manufacture'))
                        <a href="{{ url('manufacturer/add') }}" class="text-light btn btn-primary btn-sm">{{ __('product/manufacturer.add_manufacturer') }}</a>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle  rounded table-row-dashed fs-6 g-5 Datatable-tb" >
                            <thead>
                                <!--begin::Table row-->
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data){
                            let updatePermission = <?php echo hasUpdate('manufacture') ? 'true' : 'false'; ?>;
                            let deletePermission = <?php echo hasDelete('manufacture') ? 'true' : 'false'; ?>;
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ${updatePermission ? `<li><a href="/manufacturer/edit/${data}" class="dropdown-item p-2"  >
