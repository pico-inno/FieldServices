                                        ...
                                        <div class="col-md-4 mb-3 col-md-offset-4">
                                            ...
                                            <div class="mb-3">
                                                <select class="form-select form-select-sm" name="product_type"
                                                    id="product_type" data-hide-search="true">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <label for="" class="required form-label">Exc.
                                                                        tax</label>
                                                                    <input type="text" name="single_exc"
                                                                        class="form-control form-control-sm"
                                                                        placeholder="Exc. tax">
                                                    ...
                                                    <tr>
                                                        <td class="min-w-200px">
                                                            <select name="variation_name" id="variationSelect"
                                                                ...
                                                                @php
                                                                $variations =
                                                                \App\Models\Product\VariationTemplates::all();
                                                                @endphp
                                                                @foreach ($variations as $variation)
            ...
            let calculateVariation = () => {
                ...
                profit.on('keyup', (e) => {
                    ...
                    if (currentExc.val() || currentInc.val()) {
                        let resultSelling = sellingPrice(currentProfitValue, currentExc
                            .val());
                ...
                selling.on('keyup', (e) => {
                    ...
                    let currentProfit = $(e.currentTarget).closest('tr').find(profit);
                    if (currentExc.val() || currentInc.val()) {
                        let resultProfit = profitPercentage(currentSellingValue, currentExc
                            .val());
            ...
            function fetchAndCloneRows(id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach(item => {
                            let cloneRow = $(newVariation).clone();
                            cloneRow.find('input[name="variation_value[]"]').val(
                                item.name);
                            cloneRow.find('input[name="variation_id[]"]').val(item
                                .id);
                            cloneRow.find('input[name="variation_value[]"]').attr(
                                'readonly',
                                true);
