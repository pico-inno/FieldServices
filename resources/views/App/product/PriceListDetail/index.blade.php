...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('product/pricelist.pricelist') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{ __('product/product.product') }}</li>
        <li class="breadcrumb-item text-dark">{{ __('product/pricelist.pricelist') }}</li>
    </ul>
<!--end::Breadcrumb-->
@endsection
@section('content')
            ...
            <div class="card  card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <a href="{{ route('price-list-detail.add') }}" class="text-light btn btn-primary btn-sm">{{ __('product/pricelist.add_pricelist') }}</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table class="table align-middle Datatable-tb rounded table-row-dashed fs-6 g-5">
                            <thead>
                                ...
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase">
                                    ...
                                    <th class="min-w-100px">{{ __('product/pricelist.business') }}</th>
                                    <th class="min-w-100px">{{ __('product/pricelist.currency') }}</th>
                                    <th class="min-w-100px">{{ __('product/category.description') }}</th>
        ...
        $(document).ready(function () {
                        ...
                        render: function(data){
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a href="/price-list-detail/edit/${data}" class="dropdown-item p-2"  >
            ...
            $(document).on('click', '.delete-confirm', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: '/price-list-detail/delete/'+id,
                            type: 'POST',
                            headers: {
