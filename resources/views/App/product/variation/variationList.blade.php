                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        @if(hasCreate('variation'))
                            <a href="{{ url('variation/add') }}" class="btn btn-light-primary btn-sm">{{ __('product/variation.add_variation') }}</a>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-resoponsive">
                        <table class="table align-middle Datatable-tb rounded table-row-dashed fs-6 g-5" id="kt_datatable_example">
                            <thead>
                                <!--begin::Table row-->
