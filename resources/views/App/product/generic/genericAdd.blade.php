...
@section('title')
    ...
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('product/generic.add_generic') }}</h1>
...
@section('content')
	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="container-xxl" id="kt_content_container">
			...
			<form id="kt_ecommerce_settings_general_form" class="form" action="{{ route('generic.create') }}" method="POST">
				@csrf
							...
							<div class="tab-pane fade show active" id="kt_ecommerce_settings_general" role="tabpanel">
								...
								<div class="row mb-7">
									<div class="col-md-9 offset-md-3">
										<h2>{{ __('product/generic.add_generic') }}</h2>
									</div>
								</div>
								...
								<div class="row fv-row mb-7">
									...
									<div class="col-md-6">
										...
										<input type="text" class="form-control form-control-sm form-control-solid mb-2" name="generic_name" value="" placeholder="Generic name"/>
