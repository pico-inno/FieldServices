...
@section('title')
<!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">{{ __('product/generic.generic_list') }}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{ __('product/product.product') }}</li>
        <li class="breadcrumb-item text-dark">{{ __('product/generic.generic_list') }}</li>
    </ul>
<!--end::Breadcrumb-->
@endsection
@section('content')
            ...
            <div class="card  card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        @endif
                        @if(hasCreate('generic'))
                            <a href="{{ url('generic/add') }}" class="text-light btn btn-primary btn-sm">{{ __('product/generic.add_generic') }}</a>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data){
                            let updatePermission = <?php echo hasUpdate('generic') ? 'true' : 'false'; ?>;
                            let deletePermission = <?php echo hasDelete('generic') ? 'true' : 'false'; ?>;
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    ${updatePermission ? `<li><a href="/generic/edit/${data}" class="dropdown-item p-2"  >
