            ...
            <div class="d-flex flex-column flex-xl-row">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                ...
                                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit customer details">
                                    <a href="{{ route('contacts#editSupplierPage') }}" class="btn btn-sm btn-light-primary">Edit</a>
                                </span>
                            </div>
                            <!--end::Details toggle-->
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                                href="#kt_customer_view_purchase">Purchases</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                                href="#kt_customer_view_stockAndReport">Stock and report</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <!--begin:::Purchase-->
                        <div class="tab-pane fade" id="kt_customer_view_purchase" role="tabpanel">
                            <!--begin::first card-->
                            <div class="card mb-6 mb-xl-9">
                                <!--begin::Card body-->
                                <div class="card-body pt-0">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-50px">Purchase Status</th>
                                                <th class="min-w-50px">Payment Status</th>
                                                <th class="min-w-50px">Grand Total</th>
                                                <th class="min-w-50px">Payment Due</th>
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-175px py-4"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('contacts#purchaseLabelPage') }}" class="menu-link px-3">Labels</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('contacts#addPaymentPage') }}" class="menu-link px-3">Add Payment</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('contacts#purchaseViewPaymentPage') }}" class="menu-link px-3">View Payment</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('contacts#purchaseReturnPage') }}" class="menu-link px-3">Purchase Return</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3">Update Status </a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="#" class="menu-link px-3">Items Recieved
                                                                Notification </a>
                                                        </div>
                                                        <!--end::Menu item-->
                        ...
                        <!--begin:::stock and report-->
                        <div class="tab-pane fade" id="kt_customer_view_stockAndReport" role="tabpanel">
                            <!--begin::first card-->
                            <div class="card mb-6 mb-xl-9">
                                <!--begin::Card body-->
                                <div class="card-body pt-0">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 gy-5"
                                        ...
                                        <thead>
                                            ...
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                ...
                                                <th class="min-w-50px">Purchase Quantity</th>
                                                <th class="min-w-50px">Total Sold</th>
                                                <th class="min-w-50px">Total Unit Transfered</th>
                                                <th class="min-w-50px">Total Returned</th>
                                                <th class="min-w-50px">Current Stock</th>
                                                <th class="min-w-50px">Current Stock Value</th>
                                            </tr>
                                            <!--end::Table row-->
                                        </thead>
                                        <!--end::Table head-->
