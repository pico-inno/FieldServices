...
@section('supplier_list_active_show','active show')

@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Supplier</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Contact</li>
    <li class="breadcrumb-item text-dark">Supplier</li>
</ul>
<!--end::Breadcrumb-->
@endsection
            ...
            <div class="card-header py-5 gap-2 gap-md-5 d-flex flex-column">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <a href="{{route('suppliers.create')}}" class="text-light btn btn-primary btn-sm">Add</a>
                            @endif
                    </div>
                </div>
            </div>
