                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            ...
                            <select name="type" class="form-select form-select-sm fs-7" id="contact-type" required aria-label="Select example" onchange="showCG()">
                    ...
                    <div class="row customer-group hide" @if($supplier->type == 'Both') style="display: flex;" @endif>
                    ...
                    <div id="more-info-fields" class="mt-8" style="display: none;">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 mb-8">
                                ...
                                <div class="input-group">
                                    <input type="number" name="pay_term_number" id="pay_term_number" value="{{old('pay_term_number',$supplier->pay_term_number)}}" class="form-control form-control-sm fs-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 mb-8 credit-limit hide" @if($supplier->type == 'Both') style="display: block;" @endif>
