                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 mb-8 customer-group hide" @if($supplier->type == 'Both') style="display: block;" @endif>
                            ...
                            <select name="price_list_id" class="form-select form-select-sm fs-7" data-control="select2" data-placeholder="None" data-allow-clear="true">
                                ...
                                <option value="{{$price_list->id}}" {{ old('price_list_id', $supplier->price_list_id) == $price_list->id ? 'selected' : ''}}>
                                    {{$price_list->name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <div class="input-group flex-nowrap">
                                    <input type="number" name="pay_term_value" id="pay_term_value" value="{{old('pay_term_value',$supplier->pay_term_value)}}" class="form-control form-control-sm rounded-end-0 fs-7">
