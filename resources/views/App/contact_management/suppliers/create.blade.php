...
@section('supplier_add_active_show','active show')
@section('styles')
<style>
    .individual-div.hide,
    .business-div.hide,
...
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-4">Add Supplier</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
        ...
        <form action="{{route('suppliers.store')}}" method="POST" id="add_supplier_form">
            ...
            <div class="card card-p-4 card-flush">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            ...
                            <select name="type" class="form-select form-select-sm fs-7" id="contact-type" required aria-label="Select example" onclick="showCG()">
                                ...
                                <option @disabled(!hasCreate('customer')) value="Customer">Customers</option>
                                <option @disabled(!hasCreate('customer')) value="Both">Both (Suppliers and Customers)</option>
                            </select>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label class="form-check form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" id="business" value="" checked />
                                        <span class="form-check-label">
                                            Business
                                        </span>
                                    </label>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12 mb-8 customer-group hide">
                    ...
                    <div class="row individual-div hide">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 mb-8 individual-div hide">
                    ...
                    <div id="more-info-fields" class="mt-8" style="display: none;">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8 credit-limit hide">
