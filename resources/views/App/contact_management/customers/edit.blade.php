                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4 col-sm-12 mb-8">
                            ...
                            <select name="pricelist_id" class="form-select form-select-sm fs-7" data-control="select2" data-placeholder="None" data-hide-search="true">
                                ...
                                @foreach($price_lists as $price_list)
                                    <option value="{{$price_list->id}}" {{ old('pricelist_id', $customer->pricelist_id) == $price_list->id ? 'selected' : ''}}>
                                        {{$price_list->name}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div id="more-info-fields" class="mt-8" style="display: none;">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 mb-8">
                                ...
                                <div class="input-group">
                                    <input type="number" name="pay_term_number" id="pay_term_number" value="{{old('pay_term_number',$customer->pay_term_number)}}" class="form-control form-control-sm fs-7"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 mb-8 credit-limit">
