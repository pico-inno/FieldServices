...
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-4">Edit Customer</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 col-sm-12">
                            ...
                            <select name="type" class="form-select form-select-sm fs-7" id="contact-type" aria-label="Select example" onclick="showCG()" required>
                        ...
                        <div class="col-md-4 col-sm-12 mb-6">
                            ...
                            <input type="text" name="contact_id" id="contact_id" value="{{old('contact_id',$customer->contact_id)}}" class="form-control form-control-sm fs-7" placeholder="Contact ID" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 mb-8 customer-group">
                            ...
                            <select name="price_list_id" class="form-select form-select-sm fs-7" data-control="select2" data-placeholder="None" data-allow-clear="true">
                                ...
                                <option value="{{$price_list->id}}" {{ old('price_list_id', $customer->price_list_id) == $price_list->id ? 'selected' : ''}}>
                                    {{$price_list->name}}
                                </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row individual-div">
                        <div class="col-md-3 col-sm-12 mb-8">
                            ...
                            <input type="text" name="prefix" id="prefix" value="{{old('prefix',$customer->prefix)}}" class="form-control form-control-sm fs-7" placeholder="Mr / Mrs / Miss" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="first_name" class="form-label">First Name</label>
                            <input type="text" name="first_name" id="first_name" value="{{old('first_name',$customer->first_name)}}" class="form-control form-control-sm fs-7" placeholder="First Name" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="middle_name" class="form-label">Middle Name</label>
                            <input type="text" name="middle_name" id="middle_name" value="{{old('middle_name',$customer->middle_name)}}" class="form-control form-control-sm fs-7" placeholder="Middle Name" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="last_name" class="form-label">Last Name</label>
                            <input type="text" name="last_name" id="last_name" value="{{old('last_name',$customer->last_name)}}" class="form-control form-control-sm fs-7" placeholder="Last Name" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-sm-12 mb-8">
                        ...
                        <div class="col-md-3 col-sm-12 mb-8">
                            ...
                            <input type="text" name="landline" id="landline" value="{{old('landline',$customer->landline)}}" class="form-control form-control-sm fs-7" placeholder="Landline" />
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-12 mb-8">
                            ...
                            <input type="text" name="address_line_1" id="address_line_1" value="{{old('address_line_1',$customer->address_line_1)}}" class="form-control form-control-sm fs-7" placeholder="Address Line 1">
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="address_line_2" class="form-label">Address Line 2</label>
                            <input type="text" name="address_line_2" id="address_line_2" value="{{old('address_line_2',$customer->address_line_2)}}" class="form-control form-control-sm fs-7" placeholder="Address Line 2">
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="city" class="form-label">City</label>
                            <input type="text" name="city" id="city" value="{{old('city',$customer->city)}}" class="form-control form-control-sm fs-7" placeholder="City">
                        </div>
                        <div class="col-md-3 col-sm-12 mb-8">
                            <label for="state" class="form-label">State</label>
                            <input type="text" name="state" id="state" value="{{old('state',$customer->state)}}" class="form-control form-control-sm fs-7" placeholder="State">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-sm-12 mb-8">
                    ...
                    <div id="more-info-fields" class="mt-8" style="display: none;">
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="text" name="tax_number" id="tax_number" value="{{old('tax_number',$customer->tax_number)}}" class="form-control form-control-sm fs-7" placeholder="Tax Number">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="pay_term_value" class="form-label">Pay Term</label>
                                <div class="input-group">
                                    <input type="number" name="pay_term_value" id="pay_term_value" value="{{old('pay_term_value',$customer->pay_term_value)}}" class="form-control form-control-sm rounded-end-0 fs-7">
                            ...
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="number" name="opening_receivable_amount" id="opening_receivable_amount"  value="{{old('opening_receivable_amount',$customer->opening_receivable_amount)}}" class="form-control form-control-sm fs-7" placeholder="Opening Receivable Amount">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="opening_payable_amount" class="form-label">Opening Payable Amount</label>
                                <input type="number" name="opening_payable_amount" id="opening_payable_amount"  value="{{old('opening_payable_amount',$customer->opening_payable_amount)}}" class="form-control form-control-sm fs-7" placeholder="Opening Payable Amount">
                            </div>

                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="receivable_amount" class="form-label">Receivable Amount</label>
                                <input type="number" name="receivable_amount" id="receivable_amount" value="{{old('receivable_amount',$customer->receivable_amount)}}" class="form-control form-control-sm fs-7" placeholder="Receivable Amount">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="payable_amount" class="form-label">Payable Amount</label>
                                <input type="number" name="payable_amount" id="payable_amount" value="{{old('payable_amount',$customer->payable_amount)}}" class="form-control form-control-sm fs-7" placeholder="Payable Amount">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row mt-6">
                            <div class="col-md-3 col-sm-12 mb-8">
                                ...
                                <input type="text" name="custom_field_1" id="custom_field_1" value="{{old('custom_field_1',$customer->custom_field_1)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 1">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_2" class="form-label">Custom Field 2</label>
                                <input type="text" name="custom_field_2" id="custom_field_2" value="{{old('custom_field_2',$customer->custom_field_2)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 2">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_3" class="form-label">Custom Field 3</label>
                                <input type="text" name="custom_field_3" id="custom_field_3" value="{{old('custom_field_3',$customer->custom_field_3)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 3">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_4" class="form-label">Custom Field 4</label>
                                <input type="text" name="custom_field_4" id="custom_field_4" value="{{old('custom_field_4',$customer->custom_field_4)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 4">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_5" class="form-label">Custom Field 5</label>
                                <input type="text" name="custom_field_5" id="custom_field_5" value="{{old('custom_field_5',$customer->custom_field_5)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 5">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_6" class="form-label">Custom Field 6</label>
                                <input type="text" name="custom_field_6" id="custom_field_6" value="{{old('custom_field_6',$customer->custom_field_6)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 6">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_7" class="form-label">Custom Field 7</label>
                                <input type="text" name="custom_field_7" id="custom_field_7" value="{{old('custom_field_7',$customer->custom_field_7)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 7">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_8" class="form-label">Custom Field 8</label>
                                <input type="text" name="custom_field_8" id="custom_field_8" value="{{old('custom_field_8',$customer->custom_field_8)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 8">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_9" class="form-label">Custom Field 9</label>
                                <input type="text" name="custom_field_9" id="custom_field_9" value="{{old('custom_field_9',$customer->custom_field_9)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 9">
                            </div>
                            <div class="col-md-3 col-sm-12 mb-8">
                                <label for="custom_field_10" class="form-label">Custom Field 10</label>
                                <input type="text" name="custom_field_10" id="custom_field_10" value="{{old('custom_field_10',$customer->custom_field_10)}}" class="form-control form-control-sm fs-7" placeholder="Custom Field 10">
                            </div>
                        </div>
                        <hr style="opacity: 0.3;">
                        <div class="row mt-6">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <textarea name="shipping_address" id="shipping_address" class="form-control form-control-sm" style="resize: none;">{{ old('shipping_address',!empty($customer->shipping_address) ? $customer->shipping_address : null) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
