        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card p-6 shadow-lg">
                    <h1 class="text-center mt-0 mb-5">Edit Payment</h1>
                    <div class="row fs-3">
                        {{-- first card in card --}}
                        <div class="card p-5 col bg-secondary ">
                            <div><b>Customer :</b>Hein Htike</div>
                            <div><b>Business :</b>APK</div>
                        </div>
                        {{-- second card in card --}}
                        <div class="card p-5 col  offset-1 bg-secondary">
                            <div> <b>Reference No: </b>PO2023/0012</div>
                            <div><b>Location: </b>Demo Business</div>
                        </div>
                        {{-- third card in card --}}
                        <div class="card p-5 col offset-1 bg-secondary">
                            <div><b>Total amount: </b>Ks 80,000</div>
                            <div><b>Payment Note:</b>--</div>
                        </div>
                    </div>
                    <form class="mt-5">
                        <div class="mt-5 mb-sm-3 fs-3"><b>Advance Balance:</b> Ks 0</div>
                        ...
                        <div class="form-group mb-5">
                         ...
                         <div class="form-group text-center mt-5 justify-content-end d-flex">
                            <button type="submit" class=" btn-primary btn-lg btn-block rounded text-white">Update</button>
                        </div>
                    </form>
                </div>
            </div>
