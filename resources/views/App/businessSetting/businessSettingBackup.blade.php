    ...
    <div class="col-md-10 offset-md-2 my-5 col-12">
        <div class="input-group flex-nowrap">
            ...
            <div class="overflow-hidden flex-grow-1">
                <select class="form-select rounded-start-0" name="search-bar" id="search-bar" data-control="select2"
                    data-allow-clear="true" data-placeholder='Serach'>
                    <option></option>
                    {{-- business --}}
                    ...
                    <option value="currency_symbol_placement">{{__('business_settings.currency_symbol_placement')}}
                    </option>
                    ...
                    <option value=""></option>
                    <option value="enable_product_expiry_check">{{__('business_settings.enable_product_expiry')}}
                    </option>
                    ...
                    {{-- sale --}}
                    <option value="enable_line_discount_for_sale">
                        {{__('business_settings.enable_line_discount_for_sale')}}</option>
                    ...
                    <option value="minimun_selling_price">
                        {{__('business_settings.sales_price_is_minimum_selling_price')}}</option>
                    ...
                    <option value="commission_calc_type">{{__('business_settings.commission_calculation_type')}}
                    </option>
                    ...
                    <option value="disable_express_checkout">{{__('business_settings.display_express_checkout')}}
                    </option>
                    <option value="show_product_suggestion">{{__('business_settings.dont_show_product_suggestion')}}
                    </option>
                    <option value="recent_transactions">{{__('business_settings.dont_show_recent_transactions')}}
                    </option>
                    ...
                    <option value="service_staff_required">{{__('business_settings.is_service_staff_required')}}
                    </option>
                    <option value="disable_credit_sale_btn">{{__('business_settings.disable_credit_sale_button')}}
                    </option>
                    ...
                    <option value="show_invoice_layout_dropdown">
                        {{__('business_settings.show_invoice_layout_dropdown')}}</option>
                    <option value="print_invoice_on_suspend">{{__('business_settings.print_invoice_on_suspend')}}
                    </option>
                    ...
                    <option value="quantity_interger_part_length">
                        {{__('business_settings.quantity_integer_part_length')}}</option>
                    ...
                    <option value="default_page_entries">{{__('business_settings.default_datatable_page_entries')}}
                    </option>
                    ...
                    <option value="reward_point_display_name">{{__('business_settings.reward_point_display_name')}}
                    </option>
                    ...
                    <option value="maximum_points_per_order">{{__('business_settings.maximum_points_per_order')}}
                    </option>

                    <option value="redeem_amount_per_unit_point">
                        {{__('business_settings.redeem_amount_per_unit_point')}}</option>
                    ...
                    <option value="sale_shipping_custom_field_1">
                        {{__('business_settings.sale_shipping_custom_field_1')}}</option>
                    <option value="sale_shipping_custom_field_2">
                        {{__('business_settings.sale_shipping_custom_field_2')}}</option>
                    <option value="sale_shipping_custom_field_3">
                        {{__('business_settings.sale_shipping_custom_field_3')}}</option>
                    <option value="sale_shipping_custom_field_4">
                        {{__('business_settings.sale_shipping_custom_field_4')}}</option>
                    <option value="sale_shipping_custom_field_5">
                        {{__('business_settings.sale_shipping_custom_field_5')}}</option>

                    <option value="types_of_service_custom_1">{{__('business_settings.service_custom_payment_1')}}
                    </option>
                    <option value="types_of_service_custom_2">{{__('business_settings.service_custom_payment_2')}}
                    </option>
                    <option value="types_of_service_custom_3">{{__('business_settings.service_custom_payment_3')}}
                    </option>
                    <option value="types_of_service_custom_4">{{__('business_settings.service_custom_payment_4')}}
                    </option>
                    <option value="types_of_service_custom_5">{{__('business_settings.service_custom_payment_5')}}
                    </option>
                    <option value="types_of_service_custom_6">{{__('business_settings.service_custom_payment_6')}}
                    </option>
                </select>
            </div>
        </div>
        ...
        <div class="d-flex " style="height: 100%">
            ...
            <div class="card card-flush mb-0">
                ...
                <div class="card-body px-3">
                    <div
                        class="menu menu-column menu-rounded menu-state-bg menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary mb-5">
                        <div class="nav w-125 flex-column">
                            <div class="menu-item  mb-3 d-block ">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link active " data-bs-toggle="tab"
                                    href="#business_setting_business" data-bs-target="#business_setting_business">
                            ...
                            {{-- <div class="menu-item mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab" href="#business_setting_tax"
                                    data-bs-target="#business_setting_tax">
                                    <span class="menu-title fw-bold">{{__('business_settings.tax')}}</span>
                                    <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                        title="Registered Tax Number For Your Business."></i>
                                </span>
                                <!--end::Marked-->
                            </div> --}}
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_product" data-bs-target="#business_setting_product">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_contact" data-bs-target="#business_setting_contact">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab" href="#business_setting_sale"
                                    data-bs-target="#business_setting_sale">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab" href="#business_setting_pos"
                                    data-bs-target="#business_setting_pos">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_purchases" data-bs-target="#business_setting_purchases">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_payment" data-bs-target="#business_setting_payment">
                            ...
                            {{-- <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_dashboard" data-bs-target="#business_setting_dashboard">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_system" data-bs-target="#business_setting_system">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_prefix" data-bs-target="#business_setting_prefix">
                            ...
                            {{-- <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_emailSetting"
                                    data-bs-target="#business_setting_emailSetting">
                            ...
                            {{-- <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab" href="#business_setting_sms"
                                    data-bs-target="#business_setting_sms">
                            ...
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_reward_point_setting"
                                    data-bs-target="#business_setting_reward_point_setting">
                                    <span
                                        class="menu-title fw-bold">{{__('business_settings.reward_point_setting')}}</span>
                                </span>
                                <!--end::Marked-->
                            </div>
                            <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_reward_point_modules"
                                    data-bs-target="#business_setting_reward_point_modules">
                            ...
                            {{-- <div class="menu-item  mb-3 d-block">
                                <!--begin::Marked-->
                                <span class="menu-link setting-link " data-bs-toggle="tab"
                                    href="#business_setting_custom_labels"
                                    data-bs-target="#business_setting_custom_labels">
                    ...
                    <div class="card " style="min-height: 100vh;">
                        ...
                        <div class="card-body py-8 px-4 px-sm-7 px-md-10">
                            ...
                            <div class="tab-content " id="myTabContent">
                                {{-- business-tab --}}
                                <div class="tab-pane setting-tab fade active show" id="business_setting_business"
                                    role="tabpanel">
                                    <!--begin::Form-->
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                    ...
                                    <div class="row fv-row row-cols ">
                                        ...
                                        {{-- <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text" data-td-target="#kt_datepicker_1"
                                                    data-td-toggle="datetimepicker">
                                                    <i class="fas fa-calendar"></i>
                                                </span>
                                                <input class="form-control form-control form-control form-control-sm"
                                                    name="start_date" placeholder="Pick a date" id="kt_datepicker_1"
                                                    value="{{date('d-m-Y')}}" />
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="default_profit_percent">
                                                <span
                                                    class="required">{{__('business_settings.default_profit_percent')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                    title="Default profit margin of a product."></i>
                                            </label>
                                            <!--end::Label-->
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                ...
                                                <input type="number" id="default_profit_percent"
                                                    class="form-control form-control form-control form-control-sm"
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3" for="default_currency">
                                                <span
                                                    class="required">{{__('business_settings.default_currency')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <div class="input-group flex-nowrap">
                                                <span class="input-group-text">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="currency_id"
                                                        class="form-select rounded-start-0 form-select-sm" id="currency"
                                                        data-control="select2" data-placeholder="Select Currency">
                                                        <option></option>
                                                        @foreach ($currencies as $c)
                                                        <option value="{{$c->id}}"
                                                            @selected($settingData['currency_id']==$c->id)>{{$c->name}}
                                                            ({{$c->symbol}})
                                                        </option>
                                                        @endforeach
                                    ...
                                    <div class="row fv-row row-cols ">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                ...
                                                <span
                                                    class="required">{{__('business_settings.currency_symbol_placement')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <select class="form-select  form-select-sm" name="currency_symbol_placement"
                                                id="currency_symbol_placement" data-control="select2"
                                                data-placeholder="Select Currency">
                                                <option value="before"
                                                    @selected($settingData['currency_symbol_placement']='before' )>
                                                    Before Amount</option>
                                                <option value="after"
                                                    @selected($settingData['currency_symbol_placement']='after' )>After
                                                    Amount</option>
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select class="form-select rounded-start-0 form-select-sm"
                                                        id="timezone" name="timezone" data-control="select2"
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3 required"
                                                for="finanical_year_start_month">
                                                <span
                                                    class="required">{{__('business_settings.financial_year_start_month')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                    title="Starting month of the finanical year for your business."></i>
                                            </label>
                                            <!--end::Label-->
                                            <div class="input-group input-group-sm flex-nowrap">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="finanical_year_start_month"
                                                        class="form-select rounded-start-0 form-select-sm"
                                                        id="finanical_year_start_month" data-control="select2"
                                                        data-placeholder="Select month">
                                                        <option></option>
                                                        <option value="january"
                                                            @selected($settingData['finanical_year_start_month']==='january'
                                                            )>January</option>
                                                        <option value="february"
                                                            @selected($settingData['finanical_year_start_month']==='february'
                                                            )>February</option>
                                                        <option value="march"
                                                            @selected($settingData['finanical_year_start_month']==='march'
                                                            )>March</option>
                                                        <option value="april"
                                                            @selected($settingData['finanical_year_start_month']==='april'
                                                            )>April</option>
                                                        <option value="may"
                                                            @selected($settingData['finanical_year_start_month']==='may'
                                                            )>May</option>
                                                        <option value="june"
                                                            @selected($settingData['finanical_year_start_month']==='june'
                                                            )>June</option>
                                                        <option value="july"
                                                            @selected($settingData['finanical_year_start_month']==='july'
                                                            )>July</option>
                                                        <option value="august"
                                                            @selected($settingData['finanical_year_start_month']==='august'
                                                            )>August</option>
                                                        <option value="september"
                                                            @selected($settingData['finanical_year_start_month']==='september'
                                                            )>September</option>
                                                        <option value="october"
                                                            @selected($settingData['finanical_year_start_month']==='october'
                                                            )>October</option>
                                                        <option value="november"
                                                            @selected($settingData['finanical_year_start_month']==='november'
                                                            )>November</option>
                                                        <option value="december"
                                                            @selected($settingData['finanical_year_start_month']==='december'
                                                            )>December</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            ...
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="stock_accounting_method">
                                                <span
                                                    class="required">{{__('business_settings.stock_accounting_method')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            ...
                                            <div class="input-group flex-nowrap input-group-sm">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="accounting_method" data-hide-search="true"
                                                        id="stock_accounting_method"
                                                        class="form-select rounded-start-0 form-select-sm"
                                                        data-control="select2" data-placeholder="">
                                                        <option value="fifo" @selected($settingData->
                                                            accounting_method=='fifo')>FIFO (First In First Out)
                                                        </option>
                                                        <option value="lifo" @selected($settingData->
                                                            accounting_method=='lifo')>LIFO (Last In First Out)</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <!--end::Input-->
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3" for="transaction_edit_days">
                                                <span
                                                    class="required">{{__('business_settings.transaction_edit_days')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                    title="Number of days from Transaction Date till which a transaction can be edited."></i>
                                            </label>
                                            <!--end::Label-->
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                ...
                                                <input type="number" id="transaction_edit_days"
                                                    class="form-control form-control form-control form-control-sm"
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="date_format" id="date_format" data-hide-search="true"
                                                        class="form-select rounded-start-0 form-select-sm"
                                                        data-control="select2" data-placeholder="">
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            ...
                                            <div class="input-group flex-nowrap">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="time_format" id="time_format" data-hide-search="true"
                                                        class="form-select rounded-start-0 form-select-sm"
                                                        data-control="select2" data-placeholder="">
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3" for="currency_position">
                                                <span
                                                    class="required">{{__('business_settings.currency_decimal_places')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                    title="Number of digits after decimal point for currency value.Example:0.00 for value 2, 0.000 for value 3, 0.0000 for value 4"></i>
                                            </label>
                                            <!--end::Label-->
                                            <select name="currency_decimal_places" id="currency_position"
                                                class="form-select form-select-sm" data-control="select2"
                                                data-placeholder="Select month">
                                                <option value="0" @selected($settingData['currency_decimal_places']==0)>
                                                    0</option>
                                                <option value="1" @selected($settingData['currency_decimal_places']==1)>
                                                    1</option>
                                                <option value="2" @selected($settingData['currency_decimal_places']==2)>
                                                    2</option>
                                                <option value="3" @selected($settingData['currency_decimal_places']==3)>
                                                    3</option>
                                                <option value="4" @selected($settingData['currency_decimal_places']==4)>
                                                    4</option>
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3" for="quantity_precision">
                                                <span
                                                    class="required">{{__('business_settings.quantity_decimal_places')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            ...
                                            <!--end::Label-->
                                            <select name="quantity_decimal_places" id="quantity_precision"
                                                class="form-select form-select-sm" data-control="select2"
                                                data-placeholder="Select month">
                                                <option value="0" @selected($settingData['quantity_decimal_places']==0)>
                                                    0</option>
                                                <option value="1" @selected($settingData['quantity_decimal_places']==1)>
                                                    1</option>
                                                <option value="2" @selected($settingData['quantity_decimal_places']==2)>
                                                    2</option>
                                                <option value="3" @selected($settingData['quantity_decimal_places']==3)>
                                                    3</option>
                                                <option value="4" @selected($settingData['quantity_decimal_places']==4)>
                                                    4</option>
                                            </select>
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="currency_rounded_method">
                                                <span
                                                    class="required">{{__('business_settings.currency_rounded_method')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                    title="Number of digits after decimal point for quantity value.Example:0.00 for value 2, 0.000 for value 3, 0.0000 for value 4"></i>
                                            </label>
                                            <!--end::Label-->
                                            <select name="quantity_decimal_places" id="currency_rounded_method"
                                                class="form-select form-select-sm" data-control="select2"
                                                data-placeholder="Select month">
                                                <option value="0" @selected($settingData['quantity_decimal_places']==0)>
                                                    RoundUp</option>
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="quantity_rounded_method">
                                                <span
                                                    class="required">{{__('business_settings.quantity_rounded_method')}}</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                    title="Number of digits after decimal point for quantity value.Example:0.00 for value 2, 0.000 for value 3, 0.0000 for value 4"></i>
                                            </label>
                                            <!--end::Label-->
                                            <select name="quantity_decimal_places" id="quantity_rounded_method"
                                                class="form-select form-select-sm" data-control="select2"
                                                data-placeholder="Select month">
                                                <option value="0" @selected($settingData['quantity_decimal_places']==0)>
                                                    RoundUp</option>
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_tax" role="tabpanel">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <input type="text"
                                                class="form-control form-control form-control form-control-sm"
                                                name="tax_1_name" id="tax_1_name" value=""
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <input type="number"
                                                class="form-control form-control form-control form-control-sm"
                                                id="tax_1_no" name="tax_1_no" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <input type="text"
                                                class="form-control form-control form-control form-control-sm"
                                                id="tax_2_name" name="tax_2_name" value=""
                                                placeholder="GST/VAT/OTHER" />
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols ">
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <input type="number"
                                                class="form-control form-control form-control form-control-sm"
                                                id="tax_2_no" name="tax_2_no" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 col-lg-4 d-flex align-items-center">
                                            <div class="form-check form-check-custom">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="" id="enable_inline_tax_in_purchase_and_sell">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_inline_tax_in_purchase_and_sell">
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_product" role="tabpanel">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        {{-- <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <input type="text"
                                                class="form-control form-control form-control form-control-sm"
                                                id="sku_prefix" name="sku" value="" placeholder="GST/VAT/OTHER" />
                                        </div> --}}
                                        {{-- <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="enable_product_expiry_check">
                                                <span
                                                    class="required">{{__('business_settings.enable_product_expiry')}}</span>
                                            </label>
                                            <div class="input-group flex-nowrap">
                                                <span class="input-group-text">
                                                    <div class="form-check form-check-custom">
                                                        <input type="checkbox" name="enable_product_expiry_check"
                                                            class="form-check-input border-gray-400 w-20px h-20px border-gray-500"
                                                            id="enable_product_expiry_check">
                                                    </div>
                                                </span>
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="enable_product_expiry" data-hide-search="true"
                                                        id="enable_product_expiry" class="form-select rounded-start-0"
                                                        data-control="select2" data-placeholder="">
                                                        <option value="fifo">{{__('business_settings.add_item_expiry')}}
                                                        </option>
                                                        <option value="lifo">
                                                            {{__('business_settings.add_manufacturing_date_and_expiry_period')}}
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4 mt-5" id="sell_expiry">
                                            ...
                                            {{-- <label class="fs-6 fw-semibold form-label mt-3">
                                                <span
                                                    class="required">{{__('business_settings.on_product_expiry')}}</span>
                                            </label> --}}
                                            {{--
                                            <!--end::Label-->data-control="select2" --}}
                                            {{-- <div class="input-group flex-nowrap">
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="stop_selling_before" disabled data-hide-search="true"
                                                        data-control="select2" id="add_sell_expriy"
                                                        class="form-select rounded-end-0 min-w-125px "
                                                        data-placeholder="">
                                                        <option value="keep_sell">
                                                            {{__('business_settings.keep_selling')}}</option>
                                                        <option value="stop_sell">
                                                            {{__('business_settings.stop_selling_n_day_before')}}
                                                        </option>
                                                    </select>
                                                </div>
                                                <input type="text" disabled value="0" id="n_day"
                                                    name="form-control form-control"
                                                    class="form-control form-control min-w-125px" id="check_product_ex">
                                            </div> --}}
                                            <div class="form-check form-switch ">
                                                <input class="form-check-input cursor-pointer" type="checkbox"
                                                    role="switch" id="flexSwitchCheckDefault">
                                                <label class="form-check-label"
                                                    for="flexSwitchCheckDefault">{{__('business_settings.keep_selling_on_expired')}}</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <label class="fs-6 fw-semibold form-label">
                                                <span
                                                    class="required">{{__('business_settings.stop_selling_n_day_before')}}</span>
                                            </label>
                                            <div class="input-group input-group-sm flex-nowrap">
                                    ...
                                    <div class="row row-cols">
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="default_purchase_units">
                                                <span
                                                    class="required">{{__('business_settings.default_purchase_uom')}}</span>
                                            </label>
                                            <div class="input-group input-group-sm flex-nowrap">
                                                <span class="input-group-text">
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="default_purchase_units" id="default_purchase_units"
                                                        data-hide-search="true"
                                                        class="form-select form-select-sm rounded-start-0"
                                                        data-control="select2" data-kt-select2="true"
                                                        data-placeholder="">
                                                        <option value=" ">{{__('business_settings.please_select')}}
                                                        </option>
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            <label class="fs-6 fw-semibold form-label mt-3" for="default_sale_uom">
                                                <span
                                                    class="required">{{__('business_settings.default_sale_uom')}}</span>
                                            </label>
                                            <div class="input-group input-group-sm flex-nowrap">
                                                <span class="input-group-text">
                                                    <i class="fa-solid fa-scale-balanced"></i>
                                                ...
                                                <div class="overflow-hidden flex-grow-1">
                                                    <select name="default_sale_uom" id="default_sale_uom"
                                                        data-hide-search="true"
                                                        class="form-select form-select-sm rounded-start-0"
                                    ...
                                    {{-- <div class="row row-cols">
                                        <div class="col-md-12 mb-7 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_racks" id="enable_racks">
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_position" id="enable_position">
                                    ...
                                    <div class="row row-cols">
                                        <div class="col-md-12 mb-7 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom">
                                                <input type="checkbox"
                                                    class="form-check-input border-gray-400 border-gray-400 me-3"
                                                    name="enable_warranty" id="enable_warranty">
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_secondary_unit" id="enable_secondary_unit">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_secondary_unit">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3" for="default_credit_limit">
                                                <span
                                                    class="required">{{__('business_settings.default_credit_limit')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control-sm"
                                                id="default_credit_limit" placeholder="Default credit limit">
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3" for="default_credit_limit">
                                                <span
                                                    class="required">{{__('business_settings.default_pay_term')}}</span>
                                            </label>
                                            <!--end::Label-->
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_sale" role="tabpanel">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            <div class="form-check form-switch ">
                                                <input class="form-check-input cursor-pointer" type="checkbox"
                                                    name="enable_row" value="1" role="switch" id="enable_row"
                                                    @checked($settingData['enable_row'])>
                                                <label class="form-check-label text-gray-800"
                                                    for="enable_row">{{__('business_settings.enable_sale_item_in_new_row')}}</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            <div class="form-check form-switch ">
                                                <input class="form-check-input cursor-pointer" type="checkbox"
                                                    role="switch" id="flexSwitchCheckDefault">
                                                <label class="form-check-label text-gray-800"
                                                    for="flexSwitchCheckDefault">{{__('business_settings.allow_overselling')}}</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row row-cols">
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input @checked($settingData['enable_line_discount_for_sale']=='1' )
                                                    type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_line_discount_for_sale"
                                                    id="enable_line_discount_for_sale" value="1">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_line_discount_for_sale">
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="pay_required" id="pay_required">
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_pos" role="tabpanel">
                                    ...
                                    <div class="row row-cols">
                                        <div class="col-12">
                                            ...
                                            <p class="text-gray-600 py-2 fs-6 d-none">
                                                {{__('business_settings.shortcut_should_be_the_names_of_the_keys_separated_by')}}
                                                <b>'+'</b>; {{__('business_settings.example')}}: <b>ctrl+shift+b,
                                                    ctrl+h</b>
                                            </p>
                                            <div class="help-class d-none">
                                                <h4 class=" text-gray-600 d-block fs-3">
                                                    {{__('business_settings.available_key_names_are')}}:</h4>
                                        ...
                                        <div class="col-12 col-lg-6 px-5">
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3">
                                                        <span
                                                            class="fw-bold text-primary">{{__('business_settings.operations')}}</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3">
                                                        <span
                                                            class="fw-blod text-primary">{{__('business_settings.keyboard_shortcut')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="express_checkout">
                                                        <span
                                                            class="">{{__('business_settings.express_checkout')}}:</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="express_checkout" value="shift+e"
                                                        id="express_checkout" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3" for="pay_checkout">
                                                        <span
                                                            class="">{{__('business_settings.pay_and_checkout')}}</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="pay_checkout" value="shift+p"
                                                        id="pay_checkout" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="draft" value="shift+d" id="draft"
                                            ...
                                            <div class="row mb-7 row-cols flex-wrap">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="cancle" value="shift+c" id="cancle"
                                                        class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3" for="go_product_qt">
                                                        <span
                                                            class="">{{__('business_settings.go_to_product_quantity')}}:
                                                        </span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="go_product_qt" value="f2"
                                                        id="go_product_qt" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="weighing_scale">
                                                        <span
                                                            class="">{{__('business_settings.weighing_scale')}}:</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="weighing_scale_setting" value=""
                                                        id="weighing_scale" class="form-control form-control">
                                                </div>
                                            </div>
                                        </div>
                                        {{-- right setting --}}
                                        <div class="col-12 col-lg-6 px-5">
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3">
                                                        <span
                                                            class="fw-bold text-primary">{{__('business_settings.operations')}}Operations</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3">
                                            ...
                                            <div class="row mb-7 row-cols flex-wrap">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" name="edit_discount" value="shift+i"
                                                        id="edit_discount" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="edit_order_tax">
                                                        <span
                                                            class="">{{__('business_settings.edit_order_tax')}}:</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="edit_order_tax" value="shift+t"
                                                        id="edit_order_tax" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="add_payment_row">
                                                        <span
                                                            class="">{{__('business_settings.add_payment_row')}}:</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="add_payment_row" value="shift+r"
                                                        id="add_payment_row" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="finalize_payment">
                                                        <span
                                                            class="">{{__('business_settings.finalize_payment')}}:</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="finalize_payment" value="shift+f"
                                                        id="finalize_payment" class="form-control form-control">
                                                </div>
                                            </div>
                                            <div class="row mb-7 row-cols flex-wrap">
                                                <div class="col-sm-6">
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="add_new_product">
                                                        <span
                                                            class="">{{__('business_settings.add_new_product')}}:</span>
                                                    </label>
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" name="add_new_product" value="f4"
                                                        id="add_new_product" class="form-control form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap d-none">
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="disable_mulitple_pay" id="disable_mulitple_pay">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="disable_mulitple_pay">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="disable_draft" id="disable_draft">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="disable_express_checkout" id="disable_express_checkout">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="disable_express_checkout">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap d-none">
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="show_product_suggestion" id="show_product_suggestion">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="show_product_suggestion">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="recent_transactions" id="recent_transactions">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="disable_discount" id="disable_discount">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap  d-none">
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="disable_order_tax" id="disable_order_tax">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="subtotal_editable" id="subtotal_editable">
                                                <label class="fs-6 fw-semibold form-label mt-3" for="subtotal_editable">
                                                    <span>{{__('business_settings.subtotal_editable')}}<i
                                                            class="fas fa-exclamation-circle ms-1 fs-7"
                                                            data-bs-toggle="tooltip"
                                                            title="Check this to make Subtotal field editable for each product in POS screen"></i></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="disable_suspend_sale" id="disable_suspend_sale">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="disable_suspend_sale">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap  d-none">
                                        <div class="col-md-12 mb-13 col-lg-6  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_transaction_date_on_pos_screen"
                                                    id="enable_transaction_date_on_pos_screen">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_transaction_date_on_pos_screen">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-6  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_serviece_staff_in_product_line"
                                                    id="enable_serviece_staff_in_product_line">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_serviece_staff_in_product_line">
                                                    <span>{{__('business_settings.enable_service_staff_in_product_line')}}<i
                                                            class="fas fa-exclamation-circle ms-1 fs-7"
                                                            data-bs-toggle="tooltip"
                                                            title="If enabled different service staffs can be assigned for different products for an order/sale"></i></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap  d-none">
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="service_staff_required" id="service_staff_required">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="service_staff_required">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="disable_credit_sale_btn" id="disable_credit_sale_btn">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="disable_credit_sale_btn">
                                                    <span>{{__('business_settings.disable_credit_sale_button')}}<i
                                                            class="fas fa-exclamation-circle ms-1 fs-7"
                                                            data-bs-toggle="tooltip"
                                                            title="If enabled credit sale button will be shown in place of Card button on pos screen"></i></span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_weighting_scale" id="enable_weighting_scale">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_weighting_scale">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap  d-none">
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="show_invoice_scheme" id="show_invoice_scheme">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="show_invoice_scheme">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="show_invoice_layout_dropdown"
                                                    id="show_invoice_layout_dropdown">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="show_invoice_layout_dropdown">
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="print_invoice_on_suspend" id="print_invoice_on_suspend">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="print_invoice_on_suspend">
                                    ...
                                    <div class="row mb-7 row-cols flex-wrap  d-none">
                                        <div class="col-12 d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="procing_on_product_suggestion_tooltip"
                                                    id="procing_on_product_suggestion_tooltip">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="procing_on_product_suggestion_tooltip">
                                    ...
                                    <div class="row row-cols d-none">
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            ...
                                            <select name="product_sku_length" id="product_sku_length"
                                                class="form-select" data-control="select2" data-placeholder="">
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="quantity_interger_part_length">
                                                <span
                                                    class="">{{__('business_settings.quantity_integer_part_length')}}:</span>
                                            </label>
                                            <select name="quantity_interger_part_length" class="form-select"
                                                data-control="select2" id="quantity_interger_part_length"
                                                data-placeholder="">
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                    ...
                                    <div class="row row-cols d-none">
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="quantity_fractional_part_length">
                                                <span
                                                    class="">{{__('business_settings.quantity_fractional_part_length')}}:</span>
                                            </label>
                                            <select name="quantity_fractional_part_length"
                                                id="quantity_fractional_part_length" class="form-select"
                                                data-control="select2" data-placeholder="">
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                                <option value="3">3</option>
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_purchases" role="tabpanel">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <div class="form-check form-check-custom">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="lot_control" id="lot_control"
                                        ...
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input @checked($settingData['enable_line_discount_for_purchase']=='1' )
                                                    type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    name="enable_line_discount_for_purchase"
                                                    id="enable_line_discount_for_purchase" value="1">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_line_discount_for_purchase">
                                                    <span>{{__('business_settings.enable_line_discount')}}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-13 col-lg-6  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="enable_pruchase_status" id="enable_pruchase_status">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_pruchase_status">
                                                    <span>{{__('business_settings.enable_purchase_status')}} <i
                                                            class="fas fa-exclamation-circle ms-1 fs-7"
                                                            data-bs-toggle="tooltip"
                                                            title="On disable all purchases will be marked as item received"></i></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-13 col-lg-6  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="enable_lot_number" id="enable_lot_number">
                                                <label class="fs-6 fw-semibold form-label mt-3" for="enable_lot_number">
                                                    <span> {{__('business_settings.enable_lot_number')}}
                                                        <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                            data-bs-toggle="tooltip"
                                                            title="This will enable you to enter Lot number for each purcahse line in purchase screen"></i>
                                                    </span>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-13 col-lg-6  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="enable_purchase_order" id="enable_purchase_order">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_purchase_order">
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_payment" role="tabpanel">
                                    ...
                                    <div class="col-md-12 mb-7 col-lg-4">
                                        <div class="form-check form-check-custom">
                                            <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                name="use_paymentAccount" id="use_payment_account"
                                                @checked($settingData['use_paymentAccount']==1)>
                                    ...
                                    {{-- <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12">
                                            ...
                                            <span
                                                class="text-gray-700 py-2 d-block">{{__('business_settings.comma_separated_values_example')}}:
                                                100,200,500,2000</span>
                                        </div>
                                    </div>
                                    <div class="row row-cols">
                                        <div class="col-md-12  mb-7  col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="enable_cash_denomination">
                                                <span
                                                    class="">{{__('business_settings.enable_cash_denomination_on')}}</span>
                                            </label>
                                            <select name="enable_cash_denomination" id="enable_cash_denomination"
                                                data-hide-search="true" class="form-select" data-control="select2"
                                                data-placeholder="">
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="enable_cash_denomination_for_payment_methods">
                                                <span
                                                    class="">{{__('business_settings.enable_cash_denomination_for_payment_methods')}}:</span>
                                            </label>
                                            <select name="enable_cash_denomination_for_payment_methods[]"
                                                class="form-select form-select "
                                                id="enable_cash_denomination_for_payment_methods" data-control="select2"
                                                data-close-on-select="false" data-placeholder="" data-allow-clear="true"
                                                multiple="multiple">
                                                <option></option>
                                                ...
                                                <option value="bank_transfer">{{__('business_settings.bank_transfer')}}
                                                </option>
                                    ...
                                    <div class="row row-cols">
                                        <div class="col-md-12 mb-13 col-lg-6  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    id="strict_check" name="strict_check">
                                ...
                                {{-- dashobard-tab --}}
                                <div class="tab-pane setting-tab fade d-none" id="business_setting_dashboard"
                                    role="tabpanel">
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                        <div class="col-12 p-3">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="view_storck_expiry_alert_for">
                                                <span
                                                    class="required">{{__('business_settings.view_stock_expiry_alert_for')}}:</span>
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-text">
                                                    <i class="fas fa-calendar"></i>
                                                ...
                                                <input class="form-control form-control"
                                                    name="view_storck_expiry_alert_for" placeholder=""
                                                    id="view_storck_expiry_alert_for" value="" />
                                                <span class="input-group-text">
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_system" role="tabpanel">
                                    ...
                                    <div class="row row-cols">
                                        {{-- <div class="col-md-12  mb-7  col-lg-6">
                                            ...
                                            <select name="theme_color" id="theme_color" class="form-select"
                                                data-control="select2" data-placeholder="">
                                        ...
                                        <div class="col-md-12  mb-7  col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3" for="default_page_entries">
                                                <span
                                                    class="">{{__('business_settings.default_datatable_page_entries')}}</span>
                                            </label>
                                            <select name="default_page_entries" id="default_page_entries"
                                                class="form-select" data-control="select2" data-placeholder="">
                                    ...
                                    {{-- <div class="row row-cols">
                                        <div class="col-md-12 mb-13 col-lg-6  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    id="show_help_text" name="show_help_text">
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_prefix" role="tabpanel">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="purchase"
                                                name="purchase" value="PO" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="purchase_return"
                                                id="purchase_return" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="purchase_order"
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="stock_transfer"
                                                name="stock_transfer" value="ST" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="stock_adjustment"
                                                id="stock_adjustment" value="SA" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="sell_return"
                                                id="sell_return" value="SN" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="expenses"
                                                name="expenses" value="EP" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="contacts"
                                                id="contacts" value="CO" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="purchase_payment"
                                                id="purchase_payment" value="PP" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="sell_payment"
                                                name="sell_payment" value="SP" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="expense_payment"
                                                id="expense_payment" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="business_location" id="business_location" value="BL" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="perfixes_username"
                                                name="perfixes_username" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="subscription_no"
                                                id="subscription_no" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="perfixes_draft"
                                                id="perfixes_draft" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="sales_order"
                                                name="sales_order" value="" />
                                        </div>
                                    </div>
                                </div>

                                {{-- emailSetting-tab --}}
                                <div class="tab-pane setting-tab fade" id="business_setting_emailSetting"
                                    role="tabpanel">
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                        <div class="col-12 p-3">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            ...
                                            <select name="mail_driver" data-hide-search="true" id="mail_driver"
                                                class="form-select" data-control="select2" data-placeholder="">
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="mail_host"
                                                id="mail_host" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="mail_port"
                                                id="mail_port" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <input type="password" class="form-control form-control"
                                                name="mail_password" id="mail_password" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="mail_encryption"
                                                id="mail_encryption" value="" placeholder="tls/ ssl" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="password" class="form-control form-control"
                                                name="mail_from_name" id="mail_from_name" value="" placeholder="" />
                                        </div>
                                    </div>
                                    <button
                                        class="btn btn-success btn-sm float-end">{{__('business_settings.send_test_mail')}}</button>
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_sms" role="tabpanel">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7  col-lg-4">
                                            ...
                                            <select name="sms_service" data-hide-search="true" id="sms_service"
                                                class="form-select" data-control="select2" data-placeholder="">
                                        ...
                                        <div id="other-tab" class=" d-none">
                                            <div class="row fv-row row-cols flex-wrap">
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control" id="sms_url"
                                                        name="sms_url" value="" placeholder="url" />
                                                </div>
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_name">
                                                        <span
                                                            class="">{{__('business_settings.send_to_parameter_name')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_name" id="parameter_name" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="message_para_name">
                                                        <span
                                                            class="">{{__('business_settings.message_parameter_name')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="message_para_name" id="message_para_name" value=""
                                            ...
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7  col-lg-4">
                                                    ...
                                                    <select name="request_method" data-hide-search="true"
                                                        id="request_method" class="form-select" data-control="select2"
                                                        data-placeholder="">
                                            ...
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="header_1_key" id="header_1_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="header_1_value">
                                                        <span
                                                            class="">{{__('business_settings.header_1_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="header_1_value" id="header_1_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="header_2_key" id="header_2_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="header_2_value">
                                                        <span
                                                            class="">{{__('business_settings.header_2_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="header_2_value" id="header_2_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="header_3_key" id="header_3_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="header_3_value">
                                                        <span
                                                            class="">{{__('business_settings.header_3_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="header_3_value" id="header_3_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            <div class="separator border-gray-600 my-4"></div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_1_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_1_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_1_key" id="parameter_1_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_1_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_1_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_1_value" id="parameter_1_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_2_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_2_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_2_key" id="parameter_2_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_2_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_2_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_2_value" id="parameter_2_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_3_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_3_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_3_key" id="parameter_3_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_3_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_3_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_3_value" id="parameter_3_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_4_key" id="parameter_4_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_4_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_4_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_4_value" id="parameter_4_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_5_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_5_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_5_key" id="parameter_5_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_5_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_5_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_5_value" id="parameter_5_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_6_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_6_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_6_key" id="parameter_6_key" value=""
                                                        placeholder="Send to parameter name" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_6_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_6_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_6_value" id="parameter_6_value" value=""
                                                        placeholder="Message parameter name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_7_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_7_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_7_key" id="parameter_7_key" value=""
                                                        placeholder="Parameter 7 key" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_7_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_7_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_7_value" id="parameter_7_value" value=""
                                            ...
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_8_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_8_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_8_key" id="parameter_8_key" value=""
                                                        placeholder="Parameter 8 key" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_8_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_8_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_8_value" id="parameter_8_value" value=""
                                            ...
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    ...
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_9_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_9_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_9_key" id="parameter_9_key" value=""
                                                        placeholder="Parameter 9 key" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_9_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_9_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_9_value" id="parameter_9_value" value=""
                                                        placeholder="Parameter9 value" />
                                                </div>
                                            </div>
                                            <div class="row row-cols flex-wrap">
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_10_key">
                                                        <span
                                                            class="">{{__('business_settings.parameter_10_key')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_10_key" id="parameter_10_key" value=""
                                                        placeholder="Parameter 10 key" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mt-3"
                                                        for="parameter_10_value">
                                                        <span
                                                            class="">{{__('business_settings.parameter_10_value')}}:</span>
                                                    </label>
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="parameter_10_value" id="parameter_10_value" value=""
                                                    ...
                                                    {{-- <form action="/ldf" method="POST">
                                                        ...
                                                        <div class="input-group">
                                                            <input class="form-control form-control" name=""
                                                                placeholder="Test Number" id="" value="" />
                                        ...
                                        <div id="smsPOH-tab">
                                            ...
                                            <div class="row fv-row row-cols flex-wrap">
                                                <div class="col-md-12 mb-7 col-lg-12">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        id="sms_poh_auth_key" name="SMSPOH_AUTH_TOKEN" value=""
                                                ...
                                                <div class="col-md-12  mb-7 col-lg-12">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="SMSPOH_SENDER" id="smsPohSender" value=""
                                                ...
                                                {{-- <div class="col-md-12 mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="nexmo_from" id="nexmo_from" value="" placeholder="from" />
                                                </div> --}}
                                            </div>
                                        </div>
                                        <div id="nexmo-tab" class=" d-none">
                                            <div class="row fv-row row-cols flex-wrap">
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control" id="nexmo_key"
                                                        name="nexmo_key" value="" placeholder="Nexmo key" />
                                                </div>
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="nexmo_secret" id="nexmo_secret" value=""
                                                        placeholder="Nexmo Secret:" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                        ...
                                        <div id="twilio-tab" class=" d-none">
                                            <div class="row fv-row row-cols flex-wrap">
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control" id="twilio_key"
                                                        name="twilio_key" value="" placeholder="Nexmo key" />
                                                </div>
                                                <div class="col-md-12  mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="twilio_secret" id="twilio_secret" value=""
                                                        placeholder="Nexmo Secret:" />
                                                </div>
                                                <div class="col-md-12 mb-7 col-lg-4">
                                                    <!--begin::Label-->
                                                    ...
                                                    <!--end::Label-->
                                                    <input type="text" class="form-control form-control"
                                                        name="twilio_from" id="twilio_from" value=""
                                                        placeholder="from" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                {{-- reward-point-tab --}}
                                <div class="tab-pane setting-tab fade" id="business_setting_reward_point_setting"
                                    role="tabpanel">
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                        <div class="col-md-9 p-3">
                                    ...
                                    <div class="row row-cols">
                                        <div class="col-md-12 mb-13 col-lg-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input type="checkbox" class="form-check-input border-gray-400 me-3"
                                                    id="enable_reward_point" name="enable_reward_point">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="enable_reward_point">
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="reward_point_display_name">
                                                <span
                                                    class="">{{__('business_settings.reward_point_display_name')}}:</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="reward_point_display_name" name="reward_point_display_name" value=""
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h2 class="d-inline text-primary">
                                                {{__('business_settings.earning_points_settings')}}:</h2>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="amount_spend_for_unit_point">
                                                <span class="">{{__('business_settings.amount_spend_for_unit_point')}};
                                                    <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                        data-bs-toggle="tooltip"
                                                        title="By enabling users can pay invoice using payment link."></i>
                                                </span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="amount_spend_for_unit_point" name="amount_spend_for_unit_point"
                                                value="" placeholder="Amount spend for unit point" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="minimun_order_total_to_earn_reward">
                                                <span
                                                    class="">{{__('business_settings.minimum_order_total_to_earn_reward')}}:
                                                    <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                        data-bs-toggle="tooltip"
                                                        title="By enabling users can pay invoice using payment link."></i>
                                                </span>
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="minimun_order_total_to_earn_reward"
                                                name="minimun_order_total_to_earn_reward" value=""
                                                placeholder="Minimum order total to earn reward:" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="maximum_points_per_order">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="maximum_points_per_order" name="maximum_points_per_order" value=""
                                                placeholder="maximum_points_per_order" />
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h2 class="d-inline text-primary">
                                                {{__('business_settings.redeem_points_settings')}}:</h2>
                                        </div>
                                    </div>
                                    <div class="separator border-gray-600 my-4"></div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        ...
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="redeem_amount_per_unit_point">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="redeem_amount_per_unit_point" name="redeem_amount_per_unit_point"
                                                value="" placeholder="Redeem amount per unit point" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-5">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="minimun_order_total_to_redeem_reward">
                                                <span
                                                    class="">{{__('business_settings.minimum_order_total_to_redeem_points')}}:
                                                    <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                        data-bs-toggle="tooltip"
                                                        title="By enabling users can pay invoice using payment link."></i>
                                                </span>
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="minimun_order_total_to_redeem_reward"
                                                name="minimun_order_total_to_redeem_reward" value=""
                                                placeholder="Minimum order total to earn reward:" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-3">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="minium_redeem_point" name="minium_redeem_point" value=""
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="maximum_redeem_point_per_order">
                                                <span
                                                    class="">{{__('business_settings.maximum_redeem_point_per_order')}}:
                                                    <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                        data-bs-toggle="tooltip" title="."></i>
                                                </span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="maximum_redeem_point_per_order"
                                                name="maximum_redeem_point_per_order" value=""
                                                placeholder="Maximum redeem point per order" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-7">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="reward_point_expiry_period">
                                                <span
                                                    class="required">{{__('business_settings.reward_point_expiry_period')}}:
                                                </span>
                                            </label>
                                            <div class="input-group flex-nowrap">
                                                <input class="form-control form-control"
                                                    name="reward_point_expiry_period"
                                                    placeholder="Reward Point expiry period"
                                                    id="reward_point_expiry_period" value="" />
                                                <span class="input-group-text">
                                                    -
                                                </span>
                                                <div class="overflow-hidden flex-grow-2">
                                                    <select name="reward_point_expiry_period_time_format"
                                                        data-hide-search="true" class="form-select rounded-start-0"
                                                        data-control="select2" data-placeholder="">
                                ...
                                {{-- modules-tab --}}
                                <div class="tab-pane setting-tab fade" id="business_setting_reward_point_modules"
                                    role="tabpanel">
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                        <div class="col-12 p-3">
                                    ...
                                    <div class="row mb-7">
                                        <div class="col-md-9 p-3">
                                            <h2 class="text-primary">{{__('business_settings.enable_disable_modules')}}
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="module_purchases" id="module_purchases">
                                        ...
                                        <div class="col-sm-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3" name="module_add_sale"
                                                    id="module_add_sale">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3" name="module_pos"
                                                    id="module_pos">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="module_stock_transfers" id="module_stock_transfers">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="module_stock_transfers">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="modulse_stock_adjustment" id="modulse_stock_adjustment">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="modulse_stock_adjustment">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3" name="module_expenses"
                                                    id="module_expenses">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3" name="module_account"
                                                    id="module_account">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3" name="module_table"
                                                    id="module_table">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="module_modifiers" id="module_modifiers">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="module_service_staff" id="module_service_staff">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="module_service_staff">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="modulse_enable_bookings" id="modulse_enable_bookings">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="modulse_enable_bookings">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="module_order_display_restaurants"
                                                    id="module_order_display_restaurants">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="module_order_display_restaurants">
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="module_enable_subscription" id="module_enable_subscription">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="module_enable_subscription">
                                        ...
                                        <div class="col-12 mb-13 col-md-4  d-flex align-items-center">
                                            <div class="form-check form-check-custom ">
                                                <input checked type="checkbox"
                                                    class="form-check-input border-gray-400 me-3"
                                                    name="module_type_of_service" id="module_type_of_service">
                                                <label class="fs-6 fw-semibold form-label mt-3"
                                                    for="module_type_of_service">
                                ...
                                <div class="tab-pane setting-tab fade" id="business_setting_custom_labels"
                                    role="tabpanel">
                                    <!--begin::Heading-->
                                    <div class="row mb-7">
                                        <div class="col-12 p-3">
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_custom_payments')}}</h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="custom_payment_1"
                                                name="custom_payment_1" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="custom_payment_2"
                                                id="custom_payment_2" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="custom_payment_3"
                                                id="custom_payment_3" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="custom_payment_4"
                                                name="custom_payment_4" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="custom_payment_5"
                                                id="custom_payment_5" value="" placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" name="custom_payment_6"
                                                id="custom_payment_6" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control" id="custom_payment_7"
                                                name="custom_payment_7" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_contact_custom_fields')}}</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_1">
                                                <span class="">{{__('business_settings.custom_field_1')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="contact_custom_field_1" name="contact_custom_field_1" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_2">
                                                <span class="">{{__('business_settings.custom_field_2')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="contact_custom_field_2" id="contact_custom_field_2" value=""
                                                placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_3">
                                                <span class="">{{__('business_settings.custom_field_3')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="contact_custom_field_3" id="contact_custom_field_3" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_4">
                                                <span class="">{{__('business_settings.custom_field_4')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="contact_custom_field_4" name="contact_custom_field_4" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_5">
                                                <span class="">{{__('business_settings.custom_field_5')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="contact_custom_field_5" id="contact_custom_field_5" value=""
                                                placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_6">
                                                <span class="">{{__('business_settings.custom_field_6')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="contact_custom_field_6" id="contact_custom_field_6" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_7">
                                                <span class="">{{__('business_settings.custom_field_7')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="contact_custom_field_7" name="contact_custom_field_7" value="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_8">
                                                <span class="">{{__('business_settings.custom_field_8')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="contact_custom_field_8" name="contact_custom_field_8" value="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_9">
                                                <span class="">{{__('business_settings.custom_field_9')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="contact_custom_field_9" name="contact_custom_field_9" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="contact_custom_field_10">
                                                <span class="">{{__('business_settings.custom_field_10')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="contact_custom_field_10" name="contact_custom_field_10" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_product_custom_fields')}}:</h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="product_custom_field_1">
                                                <span class="">{{__('business_settings.custom_field_1')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="product_custom_field_1" name="product_custom_field_1" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="product_custom_field_2">
                                                <span class="">{{__('business_settings.custom_field_2')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="product_custom_field_2" id="product_custom_field_2" value=""
                                                placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="product_custom_field_3">
                                                <span class="">{{__('business_settings.custom_field_3')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="product_custom_field_3" id="product_custom_field_3" value="" />
                                        </div>
                                    </div>
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="product_custom_field_4">
                                                <span class="">{{__('business_settings.custom_field_4')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="product_custom_field_4" id="product_custom_field_4" value="" />
                                        </div>
                                    </div>
                                    {{-- location custom --}}
                                    <div class="separator border-gray-600 my-4"></div>
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_location_custom_fields')}}:</h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="location_custom_field_1">
                                                <span class="">{{__('business_settings.custom_field_1')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="location_custom_field_1" name="location_custom_field_1" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="location_custom_field_2">
                                                <span class="">{{__('business_settings.custom_field_2')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="location_custom_field_2" id="location_custom_field_2" value=""
                                                placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="location_custom_field_3">
                                                <span class="">{{__('business_settings.custom_field_3')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="location_custom_field_3" id="location_custom_field_3" value="" />
                                        </div>
                                    </div>
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="location_custom_field_4">
                                                <span class="">{{__('business_settings.custom_field_4')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="location_custom_field_4" id="location_custom_field_4" value="" />
                                        </div>
                                    </div>
                                    {{-- user custom --}}
                                    <div class="separator border-gray-600 my-4"></div>
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_user_custom_fields')}}:</h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="user_custom_field_1" name="user_custom_field_1" value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="user_custom_field_2" id="user_custom_field_2" value=""
                                                placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="user_custom_field_3" id="user_custom_field_3" value="" />
                                        </div>
                                    </div>
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            ...
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="user_custom_field_4" id="user_custom_field_4" value="" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_purchase_shipping_custom_fields')}}
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="purchase_shipping_customer_field_1">
                                                <span>{{__('business_settings.custom_field_1')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control"
                                                    name="purchase_shipping_customer_field_1" placeholder=""
                                                    id="purchase_shipping_customer_field_1" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="purchase_shipping_customer_field_1_required"
                                                        id="purchase_shipping_customer_field_1_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="purchase_shipping_customer_field_1_required">
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="purchase_shipping_customer_field_2">
                                                <span>{{__('business_settings.custom_field_2')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control"
                                                    name="purchase_shipping_customer_field_2" placeholder=""
                                                    id="purchase_shipping_customer_field_2" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="purchase_shipping_customer_field_2_required"
                                                        id="purchase_shipping_customer_field_2_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="purchase_shipping_customer_field_2_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="purchase_shipping_customer_field_3">
                                                <span>{{__('business_settings.custom_field_3')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control"
                                                    name="purchase_shipping_customer_field_3" placeholder=""
                                                    id="purchase_shipping_customer_field_3" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="purchase_shipping_customer_field_3_required"
                                                        id="purchase_shipping_customer_field_3_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="purchase_shipping_customer_field_3_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="purchase_shipping_customer_field_4">
                                                <span>{{__('business_settings.custom_field_4')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control"
                                                    name="purchase_shipping_customer_field_4" placeholder=""
                                                    id="purchase_shipping_customer_field_4" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="purchase_shipping_customer_field_4_required"
                                                        id="purchase_shipping_customer_field_4_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="purchase_shipping_customer_field_4_required">
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="purchase_shipping_customer_field_5">
                                                <span>{{__('business_settings.custom_field_5')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control"
                                                    name="purchase_shipping_customer_field_5" placeholder=""
                                                    id="purchase_shipping_customer_field_5" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="purchase_shipping_customer_field_5_required"
                                                        id="purchase_shipping_customer_field_5_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="purchase_shipping_customer_field_5_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_sell_custom_fields')}}:</h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control form-control" name="sell_custom_field_1"
                                                    placeholder="" id="sell_custom_field_1"
                                                    value="sell_custom_field_1" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sell_custom_field_1_required"
                                                        id="sell_custom_field_1_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sell_custom_field_1_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control form-control" name="sell_custom_field_2"
                                                    placeholder="" id="sell_custom_field_2" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sell_custom_field_2_required"
                                                        id="sell_custom_field_2_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sell_custom_field_2_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control form-control" name="sell_custom_field_3"
                                                    placeholder="" id="sell_custom_field_3" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sell_custom_field_3_required"
                                                        id="sell_custom_field_3_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sell_custom_field_3_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12  mb-7 col-lg-6">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control form-control" name="sell_custom_field_4"
                                                    placeholder="" id="sell_custom_field_4" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sell_custom_field_4_required"
                                                        id="sell_custom_field_4_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sell_custom_field_4_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_sale_shipping_custom_fields')}}:</h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12  mb-7 ">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="sale_shipping_custom_field_1">
                                                <span>{{__('business_settings.custom_field_1')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control flex-grow-1"
                                                    name="sale_shipping_custom_field_1" placeholder=""
                                                    id="sale_shipping_custom_field_1" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_1_required"
                                                        id="sale_shipping_custom_field_1_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_1_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_1_default_contact"
                                                        id="sale_shipping_custom_field_1_default_contact">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_1_default_contact">
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-12  mb-7 ">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="sale_shipping_custom_field_2">
                                                <span>{{__('business_settings.custom_field_2')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control flex-grow-1"
                                                    name="sale_shipping_custom_field_2" placeholder=""
                                                    id="sale_shipping_custom_field_2" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_2_required"
                                                        id="sale_shipping_custom_field_2_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_2_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_2_default_contact"
                                                        id="sale_shipping_custom_field_2_default_contact">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_2_default_contact">
                                                        <span>{{__('business_settings.is_default_for_contact')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-12  mb-7 ">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="sale_shipping_custom_field_3">
                                                <span>{{__('business_settings.custom_field_3')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control flex-grow-1"
                                                    name="sale_shipping_custom_field_3" placeholder=""
                                                    id="sale_shipping_custom_field_3" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_3_required"
                                                        id="sale_shipping_custom_field_3_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_3_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_3_default_contact"
                                                        id="sale_shipping_custom_field_3_default_contact">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_3_default_contact">
                                                        <span>{{__('business_settings.is_default_for_contact')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row row-cols flex-wrap">
                                        <div class="col-12  mb-7 ">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="sale_shipping_custom_field_4">
                                                <span>{{__('business_settings.custom_field_4')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control flex-grow-1"
                                                    name="sale_shipping_custom_field_4" placeholder=""
                                                    id="sale_shipping_custom_field_4" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_4_required"
                                                        id="sale_shipping_custom_field_4_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_4_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_4_default_contact"
                                                        id="sale_shipping_custom_field_4_default_contact">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_4_default_contact">
                                                        <span>{{__('business_settings.is_default_for_contact')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-12  mb-7 ">
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="sale_shipping_custom_field_5">
                                                <span>{{__('business_settings.custom_field_5')}}</span>
                                            </label>
                                            <div class="input-group">
                                                <input class="form-control form-control flex-grow-1"
                                                    name="sale_shipping_custom_field_5" placeholder=""
                                                    id="sale_shipping_custom_field_5" value="" />
                                                <div
                                                    class="form-check form-check-custom input-group-text input-group-sm p-3 justify-content-center">
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_5_required"
                                                        id="sale_shipping_custom_field_5_required">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_5_required">
                                                        <span>{{__('business_settings.is_required')}}</span>
                                                    </label>
                                                    <input type="checkbox" class="form-check-input border-gray-400 "
                                                        name="sale_shipping_custom_field_5_default_contact"
                                                        id="sale_shipping_custom_field_5_default_contact">
                                                    <label class="fs-6 fw-semibold form-label mb-0 px-3"
                                                        for="sale_shipping_custom_field_5_default_contact">
                                                        <span>{{__('business_settings.is_default_for_contact')}}</span>
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-md-9 p-3">
                                            <h3 class="text-primary">
                                                {{__('business_settings.labels_for_types_of_service_custom_fields')}}:
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="types_of_service_custom_1">
                                                <span class="">{{__('business_settings.custom_payment_1')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="types_of_service_custom_1" name="types_of_service_custom_1"
                                                value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="types_of_service_custom_2">
                                                <span class="">{{__('business_settings.custom_payment_2')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="types_of_service_custom_2" id="types_of_service_custom_2" value=""
                                                placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="types_of_service_custom_3">
                                                <span class="">{{__('business_settings.custom_payment_3')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="types_of_service_custom_3" id="types_of_service_custom_3"
                                                value="" />
                                        </div>
                                    </div>
                                    <div class="row fv-row row-cols flex-wrap">
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="types_of_service_custom_4">
                                                <span class="">{{__('business_settings.custom_payment_4')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                id="types_of_service_custom_4" name="types_of_service_custom_4"
                                                value="" />
                                        </div>
                                        <div class="col-md-12  mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="types_of_service_custom_5">
                                                <span class="">{{__('business_settings.custom_payment_5')}}</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="types_of_service_custom_5" id="types_of_service_custom_5" value=""
                                                placeholder="" />
                                        </div>
                                        <div class="col-md-12 mb-7 col-lg-4">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3"
                                                for="types_of_service_custom_6">
                                                <span class="">{{__('business_settings.custom_payment_6')}}Custom
                                                    Payment 6</span>
                                            </label>
                                            <!--end::Label-->
                                            <input type="text" class="form-control form-control"
                                                name="types_of_service_custom_6" id="types_of_service_custom_6"
                                                value="" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class=" ">
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <button type="reset" data-kt-ecommerce-settings-type="cancel"
                                    class="btn btn-light me-3">{{__('business_settings.cancel')}}</button>
