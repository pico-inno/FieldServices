...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('stockout.edit_stockout')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
            ...
            <form action="{{route('stock-out.update', $stockout->id)}}" method="post">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 mb-5">
                    <div class="col-12 my-5 mb-2 input-group flex-nowrap">
                        ...
                        <select disabled name="business_location_id" id="business_location_id" class="form-select rounded-0" data-kt-select2="true"  data-placeholder="{{__('stockout.placeholder_location')}}">
...
{{--                                </div>--}}
                                ...
                                <div class="mb-7 mt-3 col-12 col-md-6">
                                    ...
                                    <input class="form-control form-control-sm d-flex align-items-center" placeholder="{{__('stockout.placeholder_sale_order')}}" value="" id="tagify_purchase_ordder" />
                                </div>
                    ...
                    <div class="col-12 text-center mt-2 mb-5">
                        <button type="submit" class="btn btn-primary btn-lg update_btn">{{__('stockout.update')}}</button>
                    </div>
                </div>
            </form>
        </div>
