...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">Stockout Details</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">Stockout</li>
        <li class="breadcrumb-item text-muted"><a href="{{route('stock-out.index')}}">List</a></li>
                ...
                <div class="card-body py-20">
                    ...
                    <div class="mw-lg-950px mx-auto w-100">
                        ...
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            <h4 class="fw-bolder text-gray-800 fs-2qx pe-5 pb-7">Stockout Details</h4>
                            <!--end::Logo-->
                                    ...
                                    <div class="table-responsive border-bottom mb-9">
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tr class="border-bottom fs-6 fw-bold text-muted">
                                                ...
                                                <th class="min-w-70px text-end pb-2">Delivered Quantity</th>
