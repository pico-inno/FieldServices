...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('stockin.edit_stockin')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{__('stockin.stockin')}}</li>
        <li class="breadcrumb-item text-muted"><a href="{{route('stock-in.index')}}">{{__('stokcin.list')}}</a></li>
        <li class="breadcrumb-item text-dark">{{$stockout->stockin_voucher_no}}</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
            ...
            <form action="{{route('stock-in.update', $stockin->id)}}" method="post">
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10 mb-5">
                    <div class="col-12 my-5 mb-2 input-group flex-nowrap">
                        ...
                        <select disabled name="business_location_id" id="business_location_id" class="form-select rounded-0" data-kt-select2="true"  data-placeholder="{{__('stockin.placeholder_location')}}">
                        ...
                        <div class="card-body">
                            <div class="row mb-5 flex-wrap">
                                ...
                                <div class="col-12 mb-7">
                                    ...
                                    <textarea class="form-control form-control-sm" name="note" id="" cols="30" rows="5">
                                        {{$stockin->note}}
                                    </textarea>
                                </div>
                            </div>
                    ...
                    <div class="col-12 text-center mt-2 mb-5">
                        <button type="submit" class="btn btn-primary btn-lg save-btn">{{__('stockin.update')}}</button>
                    </div>
                </div>
            </form>
        </div>
