...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('stockin.upcoming_list')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{__('stockin.stockin')}}</li>
        <li class="breadcrumb-item text-dark">{{__('stockin.upcoming_list')}}</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-customer-table-filter="search"
                                   ...
                                   placeholder="{{__('stockin.search_purchase_order')}}"/>
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="stockin_table">
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            <th class="min-w-100px">{{__('stockin.actions')}}</th>
                            <th class="min-w-125px">{{__('stockin.order_date')}}</th>
                            <th class="min-w-125px">{{__('stockin.voucher_no')}}</th>
                            <th class="min-w-125px">{{__('stockin.location')}}</th>
                            <th class="min-w-125px">{{__('stockin.order_person')}}</th>
                            <th class="min-w-125px">{{__('stockin.status')}}</th>
                            <th class="min-w-125px">{{__('stockin.received_qty')}}</th>
                        </tr>
                        <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                        ...
                        @if (count($upcomingLists) === 0)
                            <tr class="text-gray-400">
                                <td colspan="7" class="text-center">{{__('stockin.no_data_table')}}</td>
                            </tr>
                        @else
