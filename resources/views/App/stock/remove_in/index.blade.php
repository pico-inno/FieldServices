...
@section('stockin_active_show', 'active ')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('stockin.stockin')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">{{__('stockin.stockin')}}</li>
        <li class="breadcrumb-item text-dark">{{__('stockin.list')}}</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body filter-card">
                            <div class="row mb-5 flex-wrap">
                                ...
                                <!--begin::Input group-->
                                <div class="mb-5 col-6 col-md-4">
                                    <label class="form-label fs-6 fw-semibold">Stockin Person</label>
                                    <select class="form-select  fw-bold filter_stockinsperosn" data-kt-select2="true"
                                            data-placeholder="Select option" data-allow-clear="true"
                                            data-kt-user-table-filter="two-step" data-hide-search="true">
                                        <option selected value="0">All</option>
                                        @foreach($stockinsperson as $person)
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <!--end::Svg Icon-->{{ucfirst(__('stockin.filter'))}}
                                </button>
                                <!--begin::Menu 1-->
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path opacity="0.3"
                                    ...
                                    <!--end::Svg Icon-->{{ucfirst(__('stockin.export'))}}
                                </button>
                                <!--end::Export-->
                            @endif
                            @if(hasCreate('stockin'))
                                ...
                                <button onclick="window.location.href='{{route('stock-in.create')}}'" type="button"
                                        class="btn btn-primary">{{ucfirst(__('stockin.create'))}}
                                </button>
                                <!--end::Add customer-->
                            @endif
                        </div>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="stockin_table">
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px text-center">{{__('stockin.actions')}}</th>
                            <th class="min-w-125px">{{__('stockin.date')}}</th>
                            <th class="min-w-125px">{{__('stockin.voucher_no')}}</th>
                            <th class="min-w-125px">{{__('stockin.location')}}</th>
                            <th class="min-w-125px">{{__('stockin.stockin_person')}}</th>
                            <th class="min-w-125px">{{__('stockin.add_by')}}</th>
                        </tr>
                        <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                        ...
                        {{--                                            <a href="{{route('stock-in.show', $stockin->id)}}" class="menu-link px-3">View</a>--}}
                        {{--                                        </div>--}}
                        {{--                                        <!--end::Menu item-->--}}
                        {{--                                        @if(hasPrint('stockin'))--}}
                        {{--                                        <div class="menu-item px-3">--}}
                        ...
                        {{--                                        </div>--}}
                        {{--                                        @endif--}}
                        {{--                                        @if(hasUpdate('stockin'))--}}
                        {{--                                        @if($stockin->status != "confirmed")--}}
                        {{--                                            <div class="menu-item px-3">--}}
                        {{--                                                <a href="{{route('stock-in.edit', $stockin->id)}}" class="menu-link px-3 ">Edit</a>--}}
                        {{--                                            </div>--}}
                        {{--                                        @endif--}}
                        {{--                                        @endif--}}
                        {{--                                        @if(hasDelete('stockin'))--}}
                        {{--                                        <div class="menu-item px-3">--}}
                        {{--                                            <a class="menu-link px-3" href="#" onclick="event.preventDefault();--}}
                        {{--                                           document.getElementById('delete-form-{{$stockin->id}}').submit();">Delete</a>--}}
                        {{--                                            <form id="delete-form-{{$stockin->id}}"--}}
                        {{--                                                  action="{{route('stock-in.destroy',$stockin->id)}}" method="POST"--}}
                        {{--                                                  class="d-none">--}}
                        {{--                                                @csrf--}}
                        {{--                                                @method('delete')--}}
                        {{--                                            </form>--}}
                        ...
                        {{--                                       class="text-gray-800 text-hover-primary mb-1">{{$stockin->stockin_date}}</a>--}}
                        {{--                                </td>--}}
                        {{--                                <!--end::Name=-->--}}
                        {{--                                <!--begin::Email=-->--}}
                        {{--                                <td>--}}
                        {{--                                    <a href="#"--}}
                        {{--                                       class="text-gray-600 text-hover-primary mb-1">{{$stockin->stockin_voucher_no}}</a>--}}
                        {{--                                </td>--}}
                        {{--                                <td>--}}
                        {{--                                    <a href="#"--}}
                        {{--                                       class="text-gray-600 text-hover-primary mb-1">{{$stockin->businessLocation->name}}</a>--}}
                        {{--                                </td>--}}
                        {{--                                <td>--}}
                        {{--                                    <a href="#"--}}
                        {{--                                       class="text-gray-600 text-hover-primary mb-1">{{$stockinsperson->find($stockin->stockin_person)->username}}</a>--}}
                        {{--                                </td>--}}
                        {{--                                <td>--}}
                        {{--                                    @switch($stockin->status)--}}
                        {{--                                        @case('received')--}}
                        {{--                                            <div class="badge badge-light-success">{{$stockin->status}}</div>--}}
                        {{--                                            @break--}}

                        {{--                                        @case('pending')--}}
                        {{--                                            <div class="badge badge-light-warning">{{$stockin->status}}</div>--}}
                        {{--                                            @break--}}

                        {{--                                        @case('confirmed')--}}
                        {{--                                            <div class="badge badge-light-primary">{{$stockin->status}}</div>--}}
                        {{--                                            @break--}}

                        {{--                                        @case('issued')--}}
                        {{--                                            <div class="badge badge-light-danger">{{$stockin->status}}</div>--}}
                        {{--                                            @break--}}

                        {{--                                        @default--}}
                        {{--                                            <div class="badge badge-light">{{$stockin->status}}</div>--}}
                        {{--                                    @endswitch--}}
                        {{--                                </td>--}}
                        {{--                                <td>--}}
                        {{--                                    <a href="#"--}}
                        {{--                                       class="text-gray-600 text-hover-primary mb-1">{{$stockinsperson->find($stockin->created_by)->username}}</a>--}}
                        {{--                                </td>--}}
                        {{--                            </tr>--}}
                        {{--                        @endforeach--}}
                        </tbody>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            var stockinTableBody = $('#stockin_table tbody');
            var filterCard = $('.filter-card');
            var filterLocations = filterCard.find('.filter_locations');
            var filterStockinsperosn = filterCard.find('.filter_stockinsperosn');
            ...
            $(document).on('change', '.filter-card select, .filter-card input', function () {
                ...
                var filterStockinsperosnVal = filterStockinsperosn.val();
                var filterStatusVal = filterStatus.val();
                var filterDateVal = filterDate.val();

                stockinTableBody.empty();
                filterData(filterLocationsVal, filterStockinsperosnVal, filterStatusVal, filterDateVal);
            });

            var filterDateVal = filterDate.val();
            filterData(0, 0, 0, filterDateVal);

            async function filterData(filterLocations, filterStockinsperosn, filterStatus, filterDate) {
                var data = {
                    filter_locations: filterLocations,
                    filter_stockinsperosn: filterStockinsperosn,
                    filter_status: filterStatus,
                    filter_date: filterDate
                };
                try {
                    $.ajax({
                        url: '/stockin/filter-list',
                        type: 'POST',
                        headers: {
                        ...
                        // console.log(results);
                            if (results.length > 0) {
                                ...
                                stockinTableBody.append(rowsHTML);
                            }else {
                                stockinTableBody.append('<tr><td colspan="7" class="text-center">{{__('stockin.no_data_table')}}</td></tr>');
                            }
                        },
                    });
                } catch (error) {
            ...
            function createRow(filteredProduct) {
                ...
                var viewRouteUrl = generateRouteUrl("{{ route('stock-in.show', ':id') }}", filteredProduct.id);
                var editRouteUrl = generateRouteUrl("{{ route('stock-in.edit', ':id') }}", filteredProduct.id);
                var deleteRouteUrl = generateRouteUrl("{{ route('stock-in.destroy', ':id') }}", filteredProduct.id);
                var printRouteUrl = generateRouteUrl("{{ route('stock-in.invoice.print', ':id') }}", filteredProduct.id);
                var csrfToken = "{{ csrf_token() }}";


                var viewPermission = <?php echo hasUpdate('stockin') ? 'true' : 'false'; ?>;
                var printPermission = <?php echo hasDelete('stockin') ? 'true' : 'false'; ?>;
                var updatePermission = <?php echo hasUpdate('stockin') ? 'true' : 'false'; ?>;
                var deletePermission = <?php echo hasDelete('stockin') ? 'true' : 'false'; ?>;
                ...
                var row = ` <tr>
                                        ...
                                        ${viewPermission ? `<div class="menu-item px-3">
                                            ...
                                            ${printPermission ? `<div class="menu-item px-3">
                                             ...
                                             ${deletePermission ? `<div class="menu-item px-3">
                                                <a class="menu-link px-3" data-id='${filteredProduct.id}' data-stockin-voucher-no='${filteredProduct.stockin_voucher_no}' data-kt-stockin-table="delete_row">Delete</a>
                                ...
                                <td>
                                    <a href="${viewRouteUrl}" class="text-gray-800 text-hover-primary mb-1">${filteredProduct.stockin_date}</a>
                                </td>
                                <td>
                                    <a href="${viewRouteUrl}" class="text-gray-600 text-hover-primary mb-1">${filteredProduct.stockin_voucher_no}</a>
                                </td>
                                <td>
                                    <a href="${viewRouteUrl}" class="text-gray-600 text-hover-primary mb-1">${filteredProduct.business_location.name}</a>
                                </td>
                                <td>
                                    <a href="${viewRouteUrl}" class="text-gray-600 text-hover-primary mb-1">${filteredProduct.stockin_person.username}</a>
                                </td>
            ...
            $(document).on('click', '#stockin_table [data-kt-stockin-table="delete_row"]', function (e) {
                var id = $(this).data('id');
                var voucherNo = $(this).data('stockin-voucher-no');
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            text: "Restore received stock or not?",
                            icon: "question",
                            showCancelButton: true,
                            buttonsStyling: false,
                            ...
                            let url;
                            if (result.isConfirmed) {
                                url = `/stockin/${id}/delete?restore=true`;
                            } else if (result.dismiss === 'cancel') {
                                url = `/stockin/${id}/delete?restore=false`;
                            } else {
                                url = `/stockin/${id}/delete?restore=true`;
                            }
                            $.ajax({
