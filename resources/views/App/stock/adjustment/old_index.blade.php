        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <!--end::Svg Icon-->{{__('adjustment.filter')}}
                                </button>
                                <!--begin::Menu 1-->
                           ...
                           @if(hasExport('stock transfer'))
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <!--end::Svg Icon-->{{__('adjustment.export')}}
                            </button>
                            <!--end::Export-->
                            @endif
                ...
                <div class="card-body pt-0">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="stockadjustment_table">
                        <!--begin::Table head-->
                        <thead>
                        <!--begin::Table row-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold">{{__('adjustment.export_adjustment')}}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            var stocktransferTableBody = $('#stockadjustment_table tbody');
            ...
            async function filterData(filterLocationsVal, filterStatusVal, filterDateVal) {
                ...
                try {
                    $.ajax({
                        url: '/stock-adjustment/filter-list',
                        type: 'POST',
                        headers: {
            ...
            function createRow(filteredProduct) {
                ...
                var viewRouteUrl = generateRouteUrl("{{ route('stock-adjustment.show', ':id') }}", filteredProduct.id);
                var editRouteUrl = generateRouteUrl("{{ route('stock-adjustment.edit', ':id') }}", filteredProduct.id);
                var deleteRouteUrl = generateRouteUrl("{{ route('stock-adjustment.destroy', ':id') }}", filteredProduct.id);
                ...
                var createTimestamp = filteredProduct.created_at;
                const dateTime = new Date(createTimestamp);
...
<!--                                </td>-->
                                        ...
                                        <div class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" aria-labelledby="actionDropDown" role="menu">
                                            ${viewPermission ? `<div class="menu-item px-3">
                                             ...
                                             ${deletePermission ? `<div class="menu-item px-3">
                                                ...
                                                <a class="menu-link px-3" data-id='${filteredProduct.id}' data-adjustment-voucher-no='${filteredProduct.adjustment_voucher_no}' data-adjustment-status='${filteredProduct.status}' data-kt-adjustmentItem-table="delete_row">Delete</a>
                                             </div>` : ''}
                                        </div>
                                   </div>
                                </td>
                                ...
                                <td>
                                    <a href="${viewRouteUrl}" class="text-gray-800 text-hover-primary mb-1">${formattedDateTime}</a>
                                </td>
                                <td>
                                    <a href="${viewRouteUrl}" class="text-gray-600 text-hover-primary mb-1">${filteredProduct.adjustment_voucher_no}</a>
                                </td>
                                <td>
                                    <a href="${viewRouteUrl}" class="text-gray-600 text-hover-primary mb-1">${filteredProduct.business_location.name}</a>
                                </td>
                                <td>
                                    <span class="text-gray-600">${Number(filteredProduct.increase_subtotal).toFixed(2)}</span>
                                </td>
                                <td>
                                    <span class="text-gray-600">${Number(filteredProduct.decrease_subtotal).toFixed(2)}</span>
                                </td>
                                 <td>
                                   <div class="badge badge-light-${filteredProduct.status === 'completed' ? 'success' : filteredProduct.status === 'prepared' ? 'warning' : 'primary'}">
                                        ${filteredProduct.status}
                                   </div>
                                </td>
                                <td>
                                  <span class="text-gray-600">${filteredProduct.created_by.username}</span>
                                </td>
            ...
            $(document).on('click', '#stockadjustment_table [data-kt-adjustmentItem-table="delete_row"]', function (e) {
                var id = $(this).data('id');
