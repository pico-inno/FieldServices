...
<body id="kt_body" style="background-image:"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            <!--begin::Aside-->
            <div id="kt_aside" class="aside aside-extended aside-menu" data-kt-drawer="true"
                        ...
                        <div class="hover-scroll-overlay-y mb-5 px-5" data-kt-scroll="true"
                            ...
                            <ul class="nav flex-column w-100" id="kt_aside_nav_tabs">
                                ...
                                @if (hasAll('sell'))
                                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        ...
                                        <a class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-500 btn-active-light @yield('sell_icon')"
                                            ...
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                            <span class="svg-icon svg-icon-gray-500 svg-icon-3"><svg width="24"
                                ...
                                @if (hasModule('Barcode') && isEnableModule('Barcode'))
                                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        data-bs-placement="right" data-bs-dismiss="click" title="Barcode">
                                        <!--begin::Nav link-->
                                ...
                                @if (hasModule('fieldService') && isEnableModule('fieldService'))
                                    <li class="nav-item mb-2" data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        data-bs-placement="right" data-bs-dismiss="click" title="campagin">
                                        <!-- begin::Nav link -->
                            ...
                            <div class="flex-column-fluid hover-scroll-y" data-kt-scroll="true"
                                ...
                                <div class="tab-content">
                                                ...
                                                @if (hasAll('user'))
                                                    ...
                                                    <div data-kt-menu-trigger="click"
                                                        ...
                                                        <span class="menu-link">
                                                            ...
                                                            <span
                                                                class="menu-title fw-semibold">{{ __('user.users') }}</span>
                                    ...
                                    @if (hasAll('supplier') || hasAll('customer'))
                                        <div class="tab-pane fade  @yield('contact_active_show')" id="kt_aside_nav_tab_contact"
                                            role="tabpanel">
                                            <!--begin::Wrapper-->
                                                                ...
                                                                @if (hasView('supplier'))
                                                                    ...
                                                                    <div class="menu-item">
                                                                        ...
                                                                        <a class="menu-link @yield('supplier_list_active_show')"
                                                                            ...
                                                                            <span class="menu-title fs-6">Suppliers
                                                                                List</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    </div>
                                                                ...
                                                                @if (hasCreate('supplier'))
                                                                    ...
                                                                    <div class="menu-item">
                                                                        ...
                                                                        <a class="menu-link  @yield('supplier_add_active_show')"
                                                                            ...
                                                                            <span class="menu-title fs-6">Add
                                                                                Supplier</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    </div>
                                                                ...
                                                                @if (hasView('customer'))
                                                                    ...
                                                                    <div class="menu-item">
                                                                        ...
                                                                        <a class="menu-link @yield('customer_list_active_show')"
                                                                            ...
                                                                            <span class="menu-title fs-6">Customers
                                                                                List</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    </div>
                                                ...
                                                <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                    ...
                                                    <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                        <div class="menu-item pt-1">
                                                            ...
                                                            <div class="menu-content">
                                                                <span
                                                                    class="menu-heading fw-bold text-uppercase fs-7">Invoice</span>
                                                            </div>
                                                            <!--end:Menu content-->
                                                        </div>
                                                        <!--begin:Menu item-->
                                                ...
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    ...
                                                    <div data-kt-menu-trigger="click"
                                                        ...
                                                        <div class="menu-sub menu-sub-accordion">
                                                            ...
                                                            @if (hasView('product'))
                                                                ...
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('products_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/product.list_products') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                                <!--end:Menu item-->
                                                            ...
                                                            @if (hasCreate('product'))
                                                                ...
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('add_product_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/product.add_product') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            ...
                                                            @if (hasView('variation'))
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('variations_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/variation.variation') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            @if (hasImport('product'))
                                                                ...
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('import_products_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/import-product.import_product') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            ...
                                                            @endif
                                                            {{-- @if (hasView('selling price groups') ||
    hasImport('selling
                                                        price groups') ||
    hasExport('selling price groups'))
                                                        <div class="menu-item">
                                                            <!--begin:Menu link-->
                                                        ...
                                                        @endif --}}
                                                            @if (hasView('unit') || hasView('uom'))
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('units_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/unit-and-uom.unit') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            @if (hasView('category'))
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('categories_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/category.category') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            @if (hasView('brand'))
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('brands_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/product.brand') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            @if (hasView('warranty'))
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('warranties_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/warranties.warranties') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            @if (hasView('manufacture'))
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('manufacturer_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/manufacturer.manufacturer') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            @if (hasView('generic'))
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link @yield('generic_menu_link')"
                                                                        ...
                                                                        <span
                                                                            class="menu-title fs-6">{{ __('product/generic.generic') }}</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            @endif
                                                            ...
                                                            <div class="menu-item">
                                                                <!--begin:Menu link-->
                                                                <a class="menu-link @yield('price_list_detail_menu_link')"
                                                                    href="{{ route('price-list-detail') }}">
                                                                    <span class="menu-icon">
                                                                        <i class="fa-solid fa-circle"></i>
                                                                    </span>
                                                                    <span
                                                                        class="menu-title fs-6">{{ __('product/pricelist.pricelist') }}</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <div class="menu-item">
                                                                <!--begin:Menu link-->
                                                                <a class="menu-link @yield('import_price_list_detail_menu_link')"
                                                                    href="{{ route('priceListTemplate') }}">
                                                                    <span class="menu-icon">
                                                                        <i class="fa-solid fa-download"></i>
                                                                    </span>
                                                                    <span
                                                                        class="menu-title fs-6">{{ __('product/pricelist.import_pricelist') }}</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                    ...
                                    @if (hasAll('purchase'))
                                        <!--begin::Tab pane-->
                                        <div class="tab-pane fade @yield('pruchases_show')"
                                            id="kt_aside_nav_tab_stocks_purchase" role="tabpanel">
                                            <!--begin::Wrapper-->
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                id="kt_aside_menu" data-kt-menu="true">
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-7">{{ __('purchase.purchase') }}</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                                    <!--begin:Menu item-->
                                                    <div data-kt-menu-trigger="click" class="menu-item ">
                                                        ...
                                                        @if (hasView('purchase'))
                                                            <div class="menu-item">
                                                                <a class="menu-link @yield('purchases_list_active_show') px-0"
                                                                    href="{{ route('purchase_list') }}">
                                                                    <span class="menu-icon">
                                                                        <i class="fa-solid fa-list-ul"></i>
                                                                    </span>
                                                                    <span
                                                                        class="menu-title fs-6">{{ __('purchase.list_purchase') }}</span>
                                                                </a>
                                                            </div>
                                                        @endif
                                                        @if (hasCreate('purchase'))
                                                            <div class="menu-item">
                                                                <a class="menu-link @yield('purchases_add_active_show') px-0"
                                                                    href="{{ route('purchase_add') }}">
                                                                    <span class="menu-icon">
                                                                        <i class="fa-solid fa-cart-plus"></i>
                                                                    </span>
                                                                    <span
                                                                        class="menu-title px-0">{{ __('purchase.add_purchase') }}</span>
                                                                </a>
                                                            </div>
                                                            {{-- <div class="menu-item d-none">
                                    ...
                                    @if (hasAll('sell'))
                                        <!--begin::Tab pane-->
                                        <div class="tab-pane fade @yield('sell_show')"
                                            id="kt_aside_nav_tab_stocks_sell" role="tabpanel">
                                            <!--begin::Wrapper-->
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                id="kt_aside_menu" data-kt-menu="true">
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2 ">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-7">Sales
                                                                Order</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                                    ...
                                                    <div data-kt-menu-trigger="click" class="menu-item  ">
                                                        <div class="menu-item  d-none">
                                                            <a class="menu-link @yield('sell_order_active_show') px-0"
                                                                href="{{ route('sale_order') }}">
                                                                <span class="menu-icon">
                                                                    <span
                                                                        class="svg-icon svg-icon-gray-500 svg-icon-1"><svg
                                                                            width="24" height="24"
                                                                            viewBox="0 0 24 24" fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg">
                                                                            <path opacity="0.3"
                                            ...
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                ...
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                                ...
                                                                @if (hasView('opening stock'))
                                                                    ...
                                                                    <div class="menu-item">
                                                                        ...
                                                                        <a class="menu-link @yield('opening_stock_active_show')"
                                                                            ...
                                                                            <span class="menu-title">List Opening
                                                                                Stocks</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    </div>
                                                                ...
                                                                @if (hasCreate('opening stock'))
                                                                    <div class="menu-item">
                                                                        ...
                                                                        <a class="menu-link @yield('add_opening_stock_active_show')"
                                                                            ...
                                                                            <span class="menu-title">Add Opening
                                                                                Stock</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    </div>
                                                                ...
                                                                @if (hasImport('opening stock'))
                                                                    <div class="menu-item">
                                                                        ...
                                                                        <a class="menu-link @yield('import_opening_stock_menu_link') "
                                                                            ...
                                                                            <span class="menu-title">Import Opening
                                                                                Stock</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    </div>
                                                    ...
                                                    @if (hasModule('StockInOut') && isEnableModule('StockInOut'))
                                                        @include('stockinout::layouts.master', [
                                                            'navbarType' => 'main_link',
                                                        ])
                                                    @endif
                                                    ...
                                                    @if (hasAll('stock transfer'))
                                                        ...
                                                        <div data-kt-menu-trigger="click"
                                                            ...
                                                            <span class="menu-link">
                                                                ...
                                                                <span
                                                                    class="menu-title">{{ __('transfer.transfer') }}</span>
                                                                <span class="menu-arrow"></span>
                                                            </span>
                                                            <!--end:Menu link-->
                                                            <!--begin:Menu sub-->
                                                                ...
                                                                @if (hasView('stock adjustment'))
                                                                    ...
                                                                    <div class="menu-item">
                                                                        ...
                                                                        <a class="menu-link @yield('stock_adjustment_active_show')"
                                                                            ...
                                                                            <span class="menu-title">Adjustment
                                                                                List</span>
                                                                        </a>
                                                                        <!--end:Menu link-->
                                                                    </div>
                                    ...
                                    <!--begin::Tab pane-->
                                    <div class="tab-pane fade @yield('reports_active_show')" id="kt_aside_nav_tab_reports"
                                        role="tabpanel">
                                        <!--begin::Wrapper-->
                                        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                            id="kt_aside_menu" data-kt-menu="true">
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                ...
                                                <div class="menu-item menu-accordion ">
                                                    <a class="menu-link @yield('plReport_active_show')"
                                                        href="{{ route('plReport') }}">
                                                        <span class="menu-title ">Profit/Loss Report</span>
                                                    </a>
                                                </div>
                                                <div class="menu-item menu-accordion ">
                                                    <a class="menu-link @yield('spReport_active_show')"
                                                        href="{{ route('spReport') }}">
                                                        <span class="menu-title ">Purchase & Sale Report</span>
                                                    </a>
                                                </div>
                                                <div class="menu-item menu-accordion ">
                                                    <a class="menu-link @yield('expenseReport_active_show')"
                                                        href="{{ route('expenseReport') }}">
                                                        <span class="menu-title ">Expense Report</span>
                                                    </a>
                                                </div>
                                                <div class="menu-item menu-accordion ">
                                                    <a class="menu-link @yield('itemReport_active_show')"
                                                        href="{{ route('itemReport') }}">
                                                            ...
                                                            @if (hasView('stock transfer') && hasExport('stock transfer'))
                                                                ...
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link  @yield('stock_transfer_summary_active_show')"
                                                                        ...
                                                                        <span class="menu-title">Stock Transfer
                                                                            Summary</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            ...
                                                            @if (hasView('stock adjustment') && hasExport('stock adjustment'))
                                                                ...
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link  @yield('stock_adjustment_summary_active_show')"
                                                                        ...
                                                                        <span class="menu-title">Stock Adjustment
                                                                            Summary</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                                            ...
                                                            @if (multiHasAll([
                                                                ...
                                                                <div class="menu-item">
                                                                    ...
                                                                    <a class="menu-link  @yield('stock_by_lot_active_show')"
                                                                        ...
                                                                        <span class="menu-title">Current Stock
                                                                            Balance</span>
                                                                    </a>
                                                                    <!--end:Menu link-->
                                                                </div>
                                    ...
                                    <!--end::Tab pane-->
                                    @if (hasModule('fieldService') && isEnableModule('fieldService'))
                                        <div class="tab-pane fade  @yield('campaign_show')"
                                            id="kt_aside_nav_tab_campaign" role="tabpanel">
                                            <!--begin::Wrapper-->
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                id="kt_aside_menu" data-kt-menu="true">
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-8">Campaign</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                                </div>
                                                <div class="menu-item menu-accordion ">
                                                    <a class="menu-link @yield('campaign_list_active')"
                                                ...
                                                <div class="menu-item menu-accordion ">
                                                    <a class="menu-link @yield('campaign_list_v2_active')"
                                                        href="{{ route('campaign.list2') }}">
                                                        <span class="menu-icon">
                                                            <i class="fa-solid fa-list fs-6"></i>
                                                        </span>
                                    ...
                                    <div class="tab-pane fade @yield('sms_active_show')" id="kt_aside_nav_tab_sms"
                                        ...
                                        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                            ...
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                ...
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="click"
                                                    class="menu-item menu-accordion @yield('sms_poh_active_show')">
                                                    <span class="menu-link">
                                                        <span class="menu-icon">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        <div class="menu-item">
                                                            <a class="menu-link @yield('sms_poh_dashboard')"
                                                                href="{{ route('sms.index', 'smspoh') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                ...
                                                <div data-kt-menu-trigger="click"
                                                    class="menu-item menu-accordion @yield('sms_twilio_active_show')">
                                                    <span class="menu-link">
                                                        <span class="menu-icon">
                                                            <i class="fa-solid fa-sms"></i>
                                                        </span>
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        <div class="menu-item">
                                                            <a class="menu-link @yield('twilio_dashboard')"
                                                                href="{{ route('sms.index', 'twilio') }}">
                                                                <span class="menu-bullet">
                                                                    <span class="bullet bullet-dot"></span>
                                                                </span>
                                                                <span class="menu-title ">Dashboard</span>
                                    ...
                                    <div class="tab-pane fade @yield('mail_active_show')" id="kt_aside_nav_tab_mail"
                                        role="tabpanel">
                                        <!--begin::Wrapper-->
                                        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                            id="kt_aside_menu" data-kt-menu="true">
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                ...
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="click"
                                                    class="menu-item menu-accordion @yield('mail_drop_active_show')">
                                                    <span class="menu-link">
                                                        <span class="menu-icon">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        <div class="menu-item">
                                                            <a class="menu-link @yield('compose_active')"
                                        ...
                                        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                            ...
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                <div class="menu-item pt-2">
                                                    ...
                                                    <div class="menu-content">
                                                        <span
                                                            class="menu-heading fw-bold text-uppercase fs-7">Settings</span>
                                                    </div>
                                                    <!--end:Menu content-->
                                                </div>
                                                <!--begin:Menu item-->
                                            ...
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                ...
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-7">Barcode</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                            ...
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                <div class="menu-item pt-2">
                                                    ...
                                                    @if (hasView('Cash & Payment'))
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-7">Cash
                                                                &
                                                                Payment</span>
                                                        </div>
                                                    @endif
                                            ...
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                ...
                                                <div class="menu-item menu-accordion ">
                                                    ...
                                                    <a class="menu-link @yield('create_expense_product')"
                                                        ...
                                                        <span
                                                            class="menu-title">{{ __('expense.create_expense_product') }}</span>
                                                    </a>
                                                </div>
                                                @if (hasView('Expense'))
                                                    <div class="menu-item menu-accordion ">
                                                        <a class="menu-link @yield('expense_report_active')"
                                                            ...
                                                            <span
                                                                class="menu-title">{{ __('expense.expense_report_list') }}</span>
                                                        </a>
                                                    </div>
                                                @endif
                                                {{-- <div class="menu-item menu-accordion ">
                                                ...
                                                @if (hasView('Expense'))
                                                    <div class="menu-item menu-accordion ">
                                                        ...
                                                        <a class="menu-link @yield('list_expense_active')"
                                                            ...
                                                            <span
                                                                class="menu-title">{{ __('expense.expense_list') }}</span>
                                                        </a>
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                ...
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-7">Service</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                                    <!--begin:Menu item-->
                                                    <div data-kt-menu-trigger="click"
                                                        ...
                                                        <div class="menu-item">
                                                            ...
                                                            <a class="menu-link @yield('service_active_show')"
                                                                ...
                                                                <span
                                                                    class="menu-title fs-7">{{ __('service.service') }}</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu sub-->
                                                        ...
                                                        <div class="menu-item">
                                                            ...
                                                            <a class="menu-link @yield('service_sales_active_show')"
                                                                ...
                                                                <span
                                                                    class="menu-title fs-7">{{ __('service.service_sale') }}</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                        <!--end:Menu sub-->
                                            ...
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                ...
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-7">Room
                                                                Management</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                            ...
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                ...
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-7">Restaurant
                                                                Management</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                    ...
                                    @if (hasModule('Reservation') && isEnableModule('Reservation'))
                                        <div class="tab-pane fade @yield('reservation_show')"
                                            id="kt_aside_nav_tab_reservation" role="tabpanel">
                                            <!--begin::Wrapper-->
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                id="kt_aside_menu" data-kt-menu="true">
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                            ...
                                            <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                                ...
                                                <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                    <div class="menu-item pt-2">
                                                        ...
                                                        <div class="menu-content">
                                                            <span
                                                                class="menu-heading fw-bold text-uppercase fs-8">Hostpital
                                                                Registration</span>
                                                        </div>
                                                        <!--end:Menu content-->
                                                    </div>
                                                    ...
                                                    <div data-kt-menu-trigger="click"
                                                        ...
                                                        <div class="menu-item">
                                                            ...
                                                            <a class="menu-link @yield('registration_timeline_active_show')"
                                                                ...
                                                                <span class="menu-title fs-6">Romm Registration
                                                                    Timeline</span>
                                                            </a>
                                                            <!-- end::Menu link -->
                                                        </div>
                                                        ...
                                                        <div class="menu-item">
                                                            ...
                                                            <a class="menu-link @yield('create_registration_active_show')"
                                                                ...
                                                                <span class="menu-title fs-6">Create
                                                                    Registration</span>
                                                            </a>
                                                            <!-- end::Menu link -->
                                                        </div>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between"
                        ...
                        <div class="d-flex d-lg-none align-items-center ms-n2 me-2">
                            ...
                            <a href="/" class="d-flex align-items-center">
                                ...
                                @endphp
                                @if ($logo)
                                    <img alt="Logo" src="{{ asset('storage/logo/' . $logo) }}"
                                        class="h-20px w-20px" />
                                @else
                                    <img alt="Logo" src="{{ asset('default/pico.png') }}"
                                        class="h-20px w-20px" />
                                @endif
                            </a>
                            <!--end::Logo-->
                        ...
                        <div class="d-flex flex-shrink-0">
                            ...
                            <div class="d-flex align-items-center ms-1 ms-sm-3">
                                <!--begin::Menu toggle-->
                                <a href="#"
                                    class="d-md-flex d-none  btn btn-icon flex-center btn-sm bg-body btn-color-gray-600 px-5 btn-active-color-primary h-40px w-auto"
                                    ...
                                    @if ($lang == 'en')
                                        English <img class="w-15px h-15px rounded-1 ms-2"
                                            ...
                                            alt="" />
                                    @elseif ($lang == 'my')
                                        မြန်မာ <img class="w-15px h-15px rounded-1 ms-2"
                                            src={{ asset('assets/media/flags/myanmar.svg') }} alt="" />
                                    @elseif ($lang == 'th')
                                        ภาษาไทย <img class="w-15px h-15px rounded-1 ms-2"
                                            src={{ asset('assets/media/flags/thailand.svg') }} alt="" />
                                    @endif
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('lang.change', 'my') }}"
                                            ...
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src={{ asset('assets/media/flags/myanmar.svg') }}
                                                    alt="" />
                                            </span>
                                            မြန်မာ
                                        </a>
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('lang.change', 'th') }}"
                                            ...
                                            <span class="symbol symbol-20px me-4">
                                                <img class="rounded-1"
                                                    src={{ asset('assets/media/flags/thailand.svg') }}
                                                    alt="" />
                                            </span>ภาษาไทย</a>
                                    </div>
                                </div>
                            ...
                            <div class="app-navbar-item ms-1 ms-sm-4" id="kt_header_user_menu_toggle">
                                ...
                                <div class="cursor-pointer symbol symbol-sm-40px symbol-25px"
                                    ...
                                    @if ($personalInfo)
                                        ...
                                        @else
                                            <img alt="Profile Picture" width="auto"
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item text-start px-5">
                                        <a href="#"
                                            class="d-md-none d-flex  btn btn-icon justify-content-start btn-sm bg-body btn-color-gray-600 px-5 btn-active-color-primary h-40px w-auto"
                                            data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                            @php
                                                $lang = Auth::user()->personal_info->language;
                ...
                <div class="d-none animated-content position-absolute px-10 start-50 translate-middle z-index-3 shadow-sm bg-white rounded pt-15"
                    id="noti" style="top: 10px">
                    <div
                        class="col-12 m-auto text-center pb-1 border-bottom-1 border-top-0 border-left-0 border-right-0 border">
