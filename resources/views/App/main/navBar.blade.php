                        ...
                        <div class="d-flex h-100 flex-column">
                            ...
                            <div class="flex-column-fluid hover-scroll-y" data-kt-scroll="true"
                                ...
                                <div class="tab-content">
                                                    ...
                                                    <div class="menu-sub menu-sub-accordion">
                                                        ...
                                                        <div class="menu-item">
                                                            ...
                                                            <a class="menu-link @yield('price_list_detail_menu_link')"
                                                                ...
                                                                <span class="menu-title fs-6">{{
                                                                    __('product/pricelist.pricelist') }}</span>
                                                            </a>
                                                            <!--end:Menu link-->
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                            ...
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                <div class="menu-item pt-2">
                                                    ...
                                                    <div class="menu-content">
                                                        <span
                                                            class="menu-heading fw-bold text-uppercase fs-7">Purchases</span>
                                                    </div>
                                                    <!--end:Menu content-->
                                                </div>
                                                <!--begin:Menu item-->
                                                <div data-kt-menu-trigger="click" class="menu-item ">
                                                    {{-- <div class="menu-item">
                                                        <a class="menu-link @yield('purchases_order_active_show') px-0"
                                                            href="{{ route('purchase_order') }}">
                                                            <span class="menu-icon">
                                                                <i class="fa-solid fa-list"></i>
                                                            </span>
                                                    ...
                                                    <div class="menu-item d-none">
                                                        <a class="menu-link @yield('purchases_new_add_active_show') px-0"
                                                            href="{{route('purchase_new_add')}}">
                                                            <span class="menu-icon">
                                                                <i class="fa-solid fa-cart-plus"></i>
                                                            </span>
                                                    ...
                                                    @yield('edit_purchase')
                                                    {{-- <div class="menu-item">
                                                        <a class="menu-link @yield('purchases_list_return_active_show') px-0"
                                                            href="{{route('purchase_list_return')}}">
                                                            <span class="menu-icon">
                                    ...
                                    @if(hasAll('sell'))
                                    <!--begin::Tab pane-->
                                    <div class="tab-pane fade @yield('sell_show')" id="kt_aside_nav_tab_stocks_sell"
                                        role="tabpanel">
                                        <!--begin::Wrapper-->
                                        <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-semibold fs-5 ps-6 pe-8 my-2 my-lg-0"
                                            id="kt_aside_menu" data-kt-menu="true">
                                            <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                <div class="menu-item pt-2 ">
                                                    <!--begin:Menu content-->
                                                    <div class="menu-content">
                                                        <span class="menu-heading fw-bold text-uppercase fs-7">Sales
                                                            Order</span>
                                                    </div>
                                                    <!--end:Menu content-->
                                                </div>
                                                ...
                                                <div data-kt-menu-trigger="click" class="menu-item  ">
                                                    <div class="menu-item  d-none">
                                                        <a class="menu-link @yield('sell_order_active_show') px-0"
                                                            ...
                                                            <span class="menu-icon">
                                                                <span class="svg-icon svg-icon-gray-500 svg-icon-1"><svg
                                                                        width="24" height="24" viewBox="0 0 24 24"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path opacity="0.3"
                                    ...
                                    <div class="tab-pane fade @yield('sms_active_show')" id="kt_aside_nav_tab_sms"
                                        ...
                                        <div class="menu-item menu-accordion ">
                                            <!--begin:Menu link-->
                                            <!--begin:Menu link-->
                                            <a class="menu-link @yield('sms_active_show')"
