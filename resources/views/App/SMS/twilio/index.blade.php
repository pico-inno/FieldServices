...
@section('twilio_dashboard','active')
@section('sms_twilio_active_show', 'active show')
@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-2">Twilio</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Twilio</li>
                            ...
                            <tr>
                                ...
                                <td class="text-start ">
                                    <a href="../../demo55/dist/apps/inbox/reply.html" class="d-flex align-items-center text-dark">
                                        ...
                                        <!--begin::Name-->
                                        @php
                                        // dd(substr($sms['message_to'],4));
                                           $contact =App\Models\Contact\Contact::where('mobile','09'.substr($sms['message_to'],4))->first();
                                        @endphp
                                ...
                                <td class="w-100px text-end fs-7 pe-9">
                                    <span class="fw-semibold text-muted">{{$sms['create_at']}}</span>
                                </td>
                            </tr>
                        @endforeach
