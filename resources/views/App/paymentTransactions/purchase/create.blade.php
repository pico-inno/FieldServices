<div class="modal-dialog " id="payment_container">
    <div class="modal-content">
        <form action="{{route('paymentTransaction.storeForPurchase',$data->id)}}" method="POST" id="add_payment_acounts">
            @csrf
            <div class="modal-header py-3">
                <h3 class="modal-title fs-6">Add Payment for {{$data->purchase_voucher_no}}</h3>
