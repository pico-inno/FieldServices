<div class="modal-dialog " id="payemntEdit_container">
    <div class="modal-content">
        <form action="{{route('paymentTransaction.updatetForExpense',['id' =>$data->id, 'transaction_type' => 'expense'])}}" method="POST" id="payment_form">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="row mb-6">
                    ...
                    <div class="col-md-4 mb-5  fv-row">
                        ...
                        <select name="payment_account_id" id="payment_account" data-control="select2-acc" class="form-select form-select-sm" data-dropdown-parent="#payment_form" >
                    ...
                    <div class="col-md-4 mb-5 fv-row">
                        <label for="payment_amount" class="form-label fs-7 mb-2 required">Payment Amount</label>
...
<script>
    ...
    $(document).ready(function(){
            ...
            var paidAllValidator = function () {
                ...
                const form = element.querySelector("#payment_form");
