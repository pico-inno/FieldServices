                        ...
                        <table class="table  table-layout-fixed  table-row-bordered">
                                <tbody class="">
                                    <tr>
                                        ...
                                        <td  class="text-end">
                                          <span class="fw-bold fs-7 text-gray-800">{{$data->expense_voucher_no}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="text-start">
                                          <span class="fw-semibold fs-7 text-gray-600">Expense report on:</span>
                                        </th>
                                        <td  class="text-end">
                                          <span class="fw-bold fs-7 text-gray-800">{{$data->created_at}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th class="text-start">
                                        ...
                                        <td  class="text-end">
                                          <span class="fw-bold fs-7 badge badge-sm badge-success">{{$data->status}}</span>
                                        </td>
                                    </tr>
                                </tbody>
                        </table>
                   ...
                   <div class="col-md-6 col-12">
                       <table class="table  table-layout-fixed  table-row-bordered">
                               <tbody class="">
                                   <tr>
                                       <th class="text-start">
                                         <span class="fw-semibold fs-7 text-gray-600">Total Expense Amout:</span>
                                       </th>
                                       <td  class="text-end">
                                         <span class="fw-bold fs-7 text-gray-800">{{$data->expense_amount}} {{$data->currency->symbol ?? ''}}</span>
                                       </td>
                                   </tr>
                                   <tr>
                                       <th class="text-start">
                        ...
                        <tbody class="">
                            ...
                            <tr class="transactionList">
                                ...
                                <th class="text-end pe-3">
                                    <button type="button" class="btn btn-sm  pe-2 edit_payment" data-id="{{$t->id}}" data-href="{{route('paymentTransaction.editForExpense',$t->id)}}"><i class="fa-regular fa-pen-to-square text-primary"></i></button>
