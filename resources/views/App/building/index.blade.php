...
@section('building_active_show','active')

@section('title')
<!--begin::Heading-->
<h1 class="text-dark fw-bold my-0 fs-3">Building</h1>
<!--end::Heading-->
<!--begin::Breadcrumb-->
<ul class="breadcrumb fw-semibold fs-base my-1">
    <li class="breadcrumb-item text-muted">Setting</li>
    <li class="breadcrumb-item text-dark">Building</li>
</ul>
<!--end::Breadcrumb-->
@endsection
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="card-toolbar d-flex justify-content-between ">
                    ...
                    <div class="mt-2">
                        ...
                        <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#add_building_modal" data-href="{{route('building.create')}}"
                        >
                            Add
                        </button>
                    </div>
   ...
   <!--end::container-->
   <!--begin::Modal-->
   @include('App.building.create')

   <div class="modal modal-lg fade" tabindex="-1" role="dialog" id="edit_building_modal">
   </div>
    <!--end::Modal-->
</div>
<!--end::Content-->
    ...
    <script>
        ...
        var KTDatatablesExample = function () {
            ...
            $(document).on('click', 'button.edit-btn', function(){
                $('#edit_building_modal').load($(this).data('href'), function() {
                    $(this).modal('show');

                    $('form#edit_building_form').submit(function(e) {
                        e.preventDefault();
                        var form = $(this);
            ...
            // Hook export buttons
            var exportButtons = () => {
                const documentTitle = 'Buildings Report';
