<div class="modal modal-lg fade" tabindex="-1" id="add_building_modal">
                ...
                <div class="modal-body">
                    <div class="row mb-6">
                        <div class="col-12">
                            ...
                            <input type="text" name="name" id="name" class="form-control form-control-sm fs-7" placeholder="Name" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
