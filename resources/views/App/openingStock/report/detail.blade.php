...
@section('os_detail_active_show', 'active show')
...
<ul class="breadcrumb fw-semibold fs-base my-1">
    ...
    <li class="breadcrumb-item text-dark">{{__('report/report.opening_stock_details')}}</li>
</ul>
<!--end::Breadcrumb-->
@endsection
@section('content')
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    <div class="container-xxl" id="kt_content_container">
        <livewire:OpeningStock.report.detail  />
    </div>
    <!--end::Container-->
</div>
@endsection
