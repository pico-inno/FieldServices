...
@endphp
    <table>
        <thead>
            ...
            <tr>
                <th style="font-weight: bold; text-align: center;background-color: gray;" colspan="5" > {{$i+1}} </th>
            </tr>
            <tr style=" font-size: 10px">
                ...
                <th >
                    {{$userInfo['personal_info']['initname']}} {{$userInfo['personal_info']['first_name']}} {{$userInfo['personal_info']['last_name']}}
                </th>
            </tr>
    ...
    <table>
        <thead>
            ...
            <tr >
                ...
                <th  style="font-weight: bold;">Category Name
                </th>
