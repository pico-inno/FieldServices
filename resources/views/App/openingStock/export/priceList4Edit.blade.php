        ...
        @foreach ($priceListDetail as $pl)
            ...
            // dd($priceListDetail->toArray());
                if($pl['applied_type']=='Category'){
                    ...
                    $applyValues=App\Models\Product\Product::where('id',$pl['applied_value'])->first()->name;
                }
                    ...
                    $variationName=App\Models\Product\ProductVariation::whereNotNull('variation_template_value_id')
                                                                    ...
                                                                    ->first();
                    $applyValues=App\Models\Product\Product::where('id',$variationName->product_id)->first()->name;
                    // dd($applyValues);
                }
            @endphp
            <tr>
