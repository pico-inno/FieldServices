...
@section('list_drafts_active_show', 'active ')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">Drafts </h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">Sale</li>
        <li class="breadcrumb-item text-dark">LIst Drafts</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Total Items</th>
