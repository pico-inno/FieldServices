    ...
    <div class="modal-content">
        <form>
            <div class="modal-header">
                <h3 class="-title">sale Details (Voucher No : <span class=" "
                        id="clipboard">{{$sale['sales_voucher_no']}} </span> )
            ...
            <div class="modal-body">
                <div class="row mb-10">
                    <div class="col-sm-4">
                        ...
                        <address class="mt-3 fs-5 fw-semibold">
                            ...
                            <div class="fw-semibold fs-5 d-inline-block">Table No : <span
                                    class="ms-1 mb-1 fs-7 badge badge-primary">{{$sale['table']?
                                    $sale['table']['table_no'] : ''}}</span></div><br>
                            @endif
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                                ...
                                <tbody class="fw-semibold text-gray-800 table-bordered billDiv">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            {{price($sale['extra_discount'] ?? 0)}} &nbsp;{{
                                            $sale['extra_discount_type']=='percentage'?'%':$currency}}
                ...
                {{-- <div class="row mt-5 mb-5">
                    <div class="col-md-6">
                        ...
                        <div class="mt-3 fs-5">
                            <p>
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem ipsa iure
                                adipisci culpa explicabo quaerat a in incidunt! Eius aliquid deserunt cum culpa saepe
                                voluptate repudiandae vero. Minima, sequi.
                            </p>
                        </div>
                    </div>
