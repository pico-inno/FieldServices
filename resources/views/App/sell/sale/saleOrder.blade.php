...
@section('sell_order_active_show', 'active ')
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                       ...
                       <!--begin::Toolbar-->
                        ...
                        <!--end::Export-->
                        <!--begin::Add customer-->
                        <a  class="btn btn-primary" href={{route('add_sale_order')}}>Add Sell Order</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <tr>
                            ...
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">99,34</a>
                            </td>
                            <td>
