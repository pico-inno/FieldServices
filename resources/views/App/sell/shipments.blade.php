...
@section('shipments_active_show', 'active ')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">Sell </h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-5 flex-wrap">
                            ...
                            <!--begin::Input group-->
                            <div class="mb-5 col-12 col-md-4">
                                <label class="form-label fs-6 fw-semibold">Payments Status:</label>
                                <select class="form-select  fw-bold" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                    <option></option>
                                    <option value="Administrator">All</option>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">Service staff</th>
                        </tr>
                        <!--end::Table row-->
                    </thead>
                    <!--end::Table head-->
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <tr>
                            ...
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">09123345</a>
                            </td>
                            <td>
