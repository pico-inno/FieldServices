...
<div class="modal-dialog  ">
    <div class="modal-content" id="pos_create_model">
        <form action="{{route('posUpdate',$registeredPos->id)}}" method="POST" id="pos_create_form">
            @csrf
            ...
            <div class="modal-body">
                <div class="row mb-6">
                    ...
                    <div class="col-6 mb-5 fv-row">
                        ...
                        <select name="layout_id" class="form-select form-select-sm" data-control="select2" placeholder="Select Printer"
                            data-placeholder="Select Printer">
                            <option value="0">Select Invoice Layout</option>
                            @foreach ($layouts as $layout)
                                <option value="{{$layout->id}}" @selected($registeredPos->invoice_layout_id==$layout->id)>{{$layout->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-6 mb-5">
