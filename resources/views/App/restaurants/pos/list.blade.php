...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">POS Register List</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">Restauratn Pos</li>
            ...
            <div class="d-flex  justify-content-between py-5 px-5">
                ...
                <div class="card-toolbar">
                    <div class="d-flex flex-stack flex-wrap gap-4" data-kt-table-toolbar="base">
                        <button type="button" class="btn btn-primary btn-sm openModal"  id="add" data-href="{{route('posCreate')}}">Add</button>
