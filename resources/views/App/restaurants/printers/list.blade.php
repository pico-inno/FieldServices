...
@section('setting_active_show','active show')
@section('printers_here_show', 'here show')
@section('printers_list_active_show', 'active show')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-4">Printer List</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        <li class="breadcrumb-item text-muted">Setting</li>
        <li class="breadcrumb-item text-dark">Printers </li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
            ...
            <div class="d-flex  justify-content-between py-5 px-5">
                ...
                <div class="card-toolbar">
                    <div class="d-flex flex-stack flex-wrap gap-4" data-kt-table-toolbar="base">
                        <button type="button" class="btn btn-primary btn-sm openModal"  id="add" data-href="{{route('printerCreate')}}">Add</button>
