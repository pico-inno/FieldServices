                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
                                                        <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
                                                    </td>
                                                    <td>
                                                        <span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">x1</span>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="ps-0">
                                                        <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
                    ...
                    <div class="card h-md-100" dir="ltr">
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="text-center mb-1">
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-primary me-2" href="../../demo7/dist/apps/ecommerce/sales/listing.html">View App</a>
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="../../demo7/dist/apps/ecommerce/catalog/add-product.html">New Product</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                        ...
                        <div class="card-body pt-2 table-responsive">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary">#XGY-346</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary">#YHD-047</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary">#SRR-678</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary">#PXF-534</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary">#XGD-249</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary">#SKP-035</a>
                                        </td>
                                        <td class="text-end">2 day ago</td>
                                        <td class="text-end">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="../../demo7/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary">#SKP-567</a>
                                        </td>
                                        <td class="text-end">7 min ago</td>
                                        <td class="text-end">
