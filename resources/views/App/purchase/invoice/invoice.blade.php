...
<body>
  <div id="print-invoice" class="m-10">
        <div class="-header">
            <h3 class="mb-4 invoice-purchases">Purchase Details (Reference No: {{$purchase['purchase_voucher_no']}} )</h3>
            ...
            <div class="row mb-4 d-flex justify-content-center align-items-center">
                <div class="col-4">
                    ...
                    <address class="mt-1 invoice-purchases">
                        {{$purchase['supplier']['company_name'] ?? $purchase['supplier']['first_name'] }}<br>
                ...
                <div class="col-4">
                    <div class="text-group">
                        <h3 class="fw-semibold invoice-purchases">
                            Date : <span class="text-gray-600">{{$purchase['purchased_at']}}</span>
                        </h3>
                        <h3 class="9 fw-semibold invoice-purchases">
                            Purchase Status : <span class="text-gray-600">{{$purchase['status']}}</span>
                        </h3>
                        <h3 class="text-gray-800 fw-semibold invoice-purchases">
                            Purchased By : <span class="text-gray-600">{{$purchase['purchased_by']['username']}}</span>
                        </h3>
                    </div>
                </div>
            </div>
