                            ...
                            <div class="mb-7 mt-3 col-12 col-md-3">
                                ...
                                <div class=" fv-row">
                                    <select class="form-select form-select-sm  fw-bold " name="business_location_id" id="businessLocationId" data-kt-select2="true"
                                        ...
                                        <option value="{{$l->id}}" @selected($l->id==$purchase->business_location_id)>{{$l->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <tbody class="fw-semibold text-gray-600 data-table-body">
                                    ...
                                    @endphp
                                        <tr class='cal-gp'>
                                            ...
                                            <td class="d-none">
                                            <span class="subtotal_with_tax ms-2">{{$subtotal_with_tax_text}}</span> {{$currency['symbol']}}
                                            </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="mb-2 d-none">
                                        <th class="fw-semibold"> Total Line Discount :</th>
                                            <td class="rowSum text-left  fs-6 fw-semibold text-end" >
                                                <span class="total_line_discount">{{$total_line_discount}} </span> {{$currency['symbol']}}
                                            </td>
                                    ...
                                    <tr class="mb-2">
                                        ...
                                        <td class="rowSum text-left fs-6 fw-semibold text-end" id=''>
                                            <span class="net_purchase_total_amount_text"> {{$purchase_amount_for_txt}} </span> {{$currency['symbol']}}
                                        </td>
                    ...
                    <div class="card-body" >
                        <div class="row">
                            ...
                            <div class="mb-7 col-12 col-md-4 fw-semibold fs-6  d-flex justify-content-between align-items-end">
                                ...
                                <div class="">
                                    <span class="extra_discount_txt"></span>{{$currency['symbol']}}
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-7 col-12 fw-semibold fs-6 col-md-4 offset-md-4 d-flex justify-content-between align-items-end">
                                ...
                                <div class="">
                                    <span id="purchase_expense_txt">{{$purchase_expense_text}}</span>{{$currency['symbol']}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="my-15 col-12 col-md-4 fw-semibold fs-6 offset-md-8 d-flex justify-content-between align-items-end">
                                ...
                                <div class="">
                                    <span id="total_purchase_amount_txt">{{$total_purchase_amount_text}}</span>{{$currency['symbol']}}
                                </div>
                            </div>
                        ...
                        {{-- <div class="row">
                            ...
                            <div class="mb-7  fs-6 fw-semibold col-12 col-md-4 offset-md-4 d-flex justify-content-between align-items-end">
                                ...
                                <div class="">
                                    <span id="paid_amount_txt">{{$paid_amount_text}}</span>{{$currency['symbol']}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="my-15 fs-6 fw-semibold col-12 col-md-4 offset-md-8 d-flex justify-content-between align-items-end">
                                ...
                                <div class="">
                                    <span id="balance_amount_txt">{{$balance_amount_text}}</span> {{$currency['symbol']}}
                                </div>
