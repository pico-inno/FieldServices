...
@section('purchases_order_active_show', 'active ')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">Purchase Order</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                       ...
                       <!--begin::Toolbar-->
                        ...
                        <!--end::Export-->
                        <!--begin::Add customer-->
                        <a  class="btn btn-primary" href={{route('purchase_order_add')}}>Add Purchase Order</a>
                        <!--end::Add customer-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="menu-link px-3 view_detail"  data-bs-toggle="modal" type="button" data-bs-target="#viewDetail" data-href="{{ url('purchase/add/supplier')}}">
                                            view
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="../../demo7/dist/apps/customers/view.html" class="menu-link px-3">Download Pdf</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="../../demo7/dist/apps/customers/view.html" class="menu-link px-3">Edit</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="../../demo7/dist/apps/customers/view.html" class="menu-link px-3">Edit shipping</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="../../demo7/dist/apps/customers/view.html" class="menu-link px-3">Send notification</a>
                                    </div>
                                    <div class="menu-item px-3">
                            ...
                            <!--begin::Email=-->
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">2022/0002</a>
                            </td>
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">Demo Business</a>
                            </td>
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">	Lux Ygn,</a>
                            </td>
                            <td>
                                 <div class="badge badge-light-success">Ordered</div>
                            </td>
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">11.00</a>
                            </td>
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1"></a>
                            </td>
                            <td>
                                <a href="#" class="text-gray-600 text-hover-primary mb-1">Demo</a>
                            </td>
                            <!--end::Email=-->
                            <!--begin::Status=-->
                            {{-- <td>
                                <!--begin::Badges-->
                                <div class="badge badge-light-danger">Default</div>
                                <!--end::Badges-->
                            </td>
                            <!--end::Status=-->
...
@include('App.purchase.DetailView.purchaseOrderDetail')
