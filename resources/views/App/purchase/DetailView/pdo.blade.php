    ...
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
        ...
        <thead class="bg-primary">
            ...
            <tr class="bg-primary fw-bold fs-6 text-white text-start text-uppercase fs-8">
                ...
                <th class="min-w-100px text-center {{$setting->enable_line_discount_for_purchase == 1 ? '' :'d-none'}}">
...
{{-- <div class="row mt-5 mb-5">
    <div class="col-md-6">
        ...
        <div class="mt-3 fs-5">
            <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem ipsa iure adipisci culpa
                explicabo quaerat a in incidunt! Eius aliquid deserunt cum culpa saepe voluptate repudiandae vero.
                Minima, sequi.
            </p>
        </div>
    </div>
