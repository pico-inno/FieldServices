            ...
            <div class="card-header border-0 px-5 px-sm-7 pt-6 pb-5">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-purchase-table-toolbar="base">
                        ...
                        <!--begin::Export-->
                        <button type="button" class="btn btn-sm btn-light-primary me-3 fs-8 fs-sm-7"
                            data-bs-toggle="modal" data-bs-target="#kt_purchase_export_modal">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        ...
                        <form id="kt_purchase_export_form" class="form" action="#">
                            ...
                            <div class="text-center">
                                <button type="reset" id="kt_purchase_export_cancel"
