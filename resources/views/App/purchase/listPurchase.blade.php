                    ...
                    <div class="d-flex justify-content-end" data-kt-purchase-table-toolbar="base">
                       ...
                       <!--begin::Toolbar-->
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <button type="button" class="btn btn-sm btn-light-primary me-3 collapsed fs-8 fs-sm-7" type="button" data-bs-toggle="collapse" data-bs-target="#kt_accordion_1_body_2" aria-expanded="false" aria-controls="kt_accordion_1_body_2">
                        ...
                        <!--begin::Export-->
                        <button type="button" class="btn btn-sm btn-light-primary me-3 fs-8 fs-sm-7" data-bs-toggle="modal" data-bs-target="#kt_purchase_export_modal">
                            <span class="svg-icon svg-icon-sm-2 svg-icon-5">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
