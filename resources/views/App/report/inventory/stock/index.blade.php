...
{{--@section('title')--}}
{{--    <!--begin::Heading-->--}}
{{--    <h1 class="text-dark fw-bold my-0 fs-2">Stock In/Out Summary</h1>--}}
{{--    <!--end::Heading-->--}}
{{--    <!--begin::Breadcrumb-->--}}
{{--    <ul class="breadcrumb fw-semibold fs-base my-1">--}}
{{--        <li class="breadcrumb-item text-muted">Reports</li>--}}
{{--        <li class="breadcrumb-item text-muted">Inventory Reports</li>--}}
{{--        <li class="breadcrumb-item text-dark">Stock In/Out Reports</li>--}}
{{--    </ul>--}}
{{--    <!--end::Breadcrumb-->--}}
{{--@endsection--}}
...
{{--                             <!--begin::Input group-->--}}
{{--                             <div class="mb-5 col-6 col-md-4">--}}
{{--                                <label class="form-label fs-6 fw-semibold">Stock Person</label>--}}
{{--                                <select class="form-select  fw-bold filter_person" data-kt-select2="true"--}}
{{--                                        data-placeholder="Select option" data-allow-clear="true" data-hide-search="true">--}}
{{--                                    <option></option>--}}
...
{{--                                        @endforeach--}}
{{--                                    @else--}}
{{--                                        <option selected disabled value="null">No Person</option>--}}
{{--                                    @endif--}}
{{--                                </select>--}}
{{--                            </div>--}}
{{--                            <!--end::Input group-->--}}
...
{{--                                                   id="chkColumn3"/>--}}
{{--                                            <span--}}
{{--                                                class="form-check-label text-gray-600 fw-semibold"><span id="stock-person-header-filter">Stock Person</span></span>--}}
{{--                                        </label>--}}
{{--                                        <!--end::Radio button-->--}}
{{--                                        <!--begin::Radio button-->--}}
{{--                                        --}}{{-- <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">--}}
