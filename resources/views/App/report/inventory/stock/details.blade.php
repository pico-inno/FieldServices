...
{{--@section('title')--}}
{{--    <!--begin::Heading-->--}}
{{--    <h1 class="text-dark fw-bold my-0 fs-2">Stock In/Out Details</h1>--}}
{{--    <!--end::Heading-->--}}
{{--    <!--begin::Breadcrumb-->--}}
{{--    <ul class="breadcrumb fw-semibold fs-base my-1">--}}
{{--        <li class="breadcrumb-item text-muted">Reports</li>--}}
{{--        <li class="breadcrumb-item text-muted">Inventory Reports</li>--}}
{{--        <li class="breadcrumb-item text-dark">Stock In/Out Details</li>--}}
{{--    </ul>--}}
{{--    <!--end::Breadcrumb-->--}}
{{--@endsection--}}
...
{{--                                <label class="form-label fs-6 fw-semibold">Stock Reports Type</label>--}}
{{--                                <select class="form-select  fw-bold filter_type" data-kt-select2="true"--}}
...
{{--                            <th class="min-w-125px">Purchase Price</th>--}}
...
{{--                            <th class="text-nowrap align-end fs-3">Total :</th>--}}
{{--                            <th></th>--}}
{{--                            <th></th>--}}
{{--                            <th></th>--}}
{{--                            <th></th>--}}
...
{{--                                                   id="chkColumn6"/>--}}
{{--                                            <span--}}
{{--                                                class="form-check-label text-gray-600 fw-semibold" id="stock-qty-header-filter">Stock Qty</span>--}}
{{--                                        </label>--}}
{{--                                        <!--end::Radio button-->--}}
{{--                                        --}}{{-- <!--begin::Radio button-->--}}
{{--                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">--}}
...
{{--                                                   id="chkColumn8"/>--}}
{{--                                            <span--}}
{{--                                                class="form-check-label text-gray-600 fw-semibold">Purchase Price</span>--}}
{{--                                        </label>--}}
{{--                                        <!--end::Radio button-->--}}
{{--                                        <!--begin::Radio button-->--}}
{{--                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">--}}
