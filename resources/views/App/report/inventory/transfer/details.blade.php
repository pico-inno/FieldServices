...
@section('stock_by_products_active_show', 'active show')
        ...
        <div class="container-xxl" id="kt_content_container">
                            ...
                            <div class="mb-5 col-6 col-md-3">
                                ...
                                <select class="form-select form-select-sm fw-bold filter_category" data-kt-select2="true"
                                    ...
                                    @if(count($categories) > 0)
                                        ...
                                        @endforeach
                                    @else
                                        <option selected disabled value="null">No Categories</option>
                                    @endif
                                </select>
                            </div>
                            <!--end::Input group-->
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="transfer_details_reports_table">
                        <!--begin::Table head-->
                        <thead>
                        <!--begin::Table row-->
                                    ...
                                    <div class="d-flex flex-column column_checkboxes">
                                        ...
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox" checked="checked"
                                                   id="chkColumn0"/>
                                            <span class="form-che   ck-label text-gray-600 fw-semibold">{{__('common.date')}}</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox" checked="checked"
                                                   id="chkColumn1"/>
                                            <span class="form-che   ck-label text-gray-600 fw-semibold">Voucher No</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
