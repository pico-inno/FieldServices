...
@section('stock_adjustment_details_active_show', 'active show')
        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="stock_adjustment_details_reports_table">
                        <!--begin::Table head-->
                        <thead>
                        <!--begin::Table row-->
                                    ...
                                    <div class="d-flex flex-column column_checkboxes">
                                        ...
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox"  checked="checked"
                                                   id="chkColumn3"/>
                                            <span
                                                class="form-check-label text-gray-600 fw-semibold">Adjustment Type</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox"  checked="checked"
                                                   id="chkColumn4"/>
                                            <span
                                                class="form-check-label text-gray-600 fw-semibold">Balance Qty</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox"  checked="checked"
                                                   id="chkColumn5"/>
                                            <span
                                                class="form-check-label text-gray-600 fw-semibold">Ground Qty</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox"  checked="checked"
                                                   id="chkColumn6"/>
                                            <span
                                                class="form-check-label text-gray-600 fw-semibold">Adjustment Qty</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                        ...
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox"  checked="checked"
                                                   id="chkColumn8"/>
                                            <span
                                                class="form-check-label text-gray-600 fw-semibold">UOM Price</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox"  checked="checked"
                                                   id="chkColumn9"/>
                                            <span
                                                class="form-check-label text-gray-600 fw-semibold">Total</span>
                                        </label>
                                        <!--end::Radio button-->
                                    </div>
                                    <!--end::Input group-->
