...
@section('stock_adjustment_summary_active_show', 'active show')
    ...
    @section('title')
        <!--begin::Heading-->
        <h1 class="text-dark fw-bold my-0 fs-2">{{__('adjustment.stock_adjustment_summary')}}</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb fw-semibold fs-base my-1">
            ...
            <li class="breadcrumb-item text-dark">{{__('adjustment.stock_adjustment_reports')}}</li>
        </ul>
        <!--end::Breadcrumb-->
    @endsection
            ...
            <div class="container-xxl" id="kt_content_container">
                        ...
                        <div class="card-body filter-card">
                            <div class="row mb-5 flex-wrap">
                                ...
                                <div class="mb-5 col-6 col-md-3">
                                    ...
                                    <select class="form-select form-select-sm fw-bold filter_status" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-table-filter="status" data-hide-search="true">
                                        <option></option>
                                ...
                                <div class="col-6 col-md-3 ">
                                    ...
                                    <input class="form-control form-select-sm filter_date" placeholder="Pick date rage" id="kt_daterangepicker_4" data-kt-date-filter="date" data-dropdown-parent="#filter" />
                                </div>
                                <!--end::Input group-->
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="stock_adjustment_reports_table">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">{{__('adjustment.increase_subtotal')}}</th>
                                 <th class="min-w-125px">{{__('adjustment.decrease_subtotal')}}</th>
                                <th class="min-w-125px">{{__('adjustment.status')}}</th>
                                <th class="min-w-125px">{{__('common.crated_by')}}</th>
                            </tr>
                            <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">{{__('adjustment.export_stock_adjustment')}}</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                        ...
                                        <div class="d-flex flex-column column_checkboxes">
                                            ...
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox"  checked="checked"
                                                       id="chkColumn3"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">Increase Subtotal</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox"  checked="checked"
                                                       id="chkColumn4"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">Decrease Subtoal</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
    ...
    @push('scripts')
        <script src="{{ asset('customJs/reports/inventory/adjustment/stockAdjustmentExport.js') }}"></script>
        <script src="{{ asset('customJs/reports/inventory/adjustment/stockAdjustmentSummaryFilter.js') }}"></script>
