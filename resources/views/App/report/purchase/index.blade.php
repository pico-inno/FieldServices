...
@section('purchase_reports_here_show', 'here show')
@section('purchase_summary_active_show', 'active show')
    ...
    @section('title')
        <!--begin::Heading-->
        <h1 class="text-dark fw-bold my-0 fs-2">{{__('report.purchase_summary')}}</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb fw-semibold fs-base my-1">
            <li class="breadcrumb-item text-muted">{{__('report.reports')}}</li>
            <li class="breadcrumb-item text-muted">{{__('report.purchase_reports')}}</li>
            <li class="breadcrumb-item text-dark">{{__('report.purchase_summary')}}</li>
        </ul>
        <!--end::Breadcrumb-->
    @endsection
            ...
            <div class="container-xxl" id="kt_content_container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body filter-card">
                            <div class="row mb-5 flex-wrap">
                                ...
                                <!--begin::Input group-->
                                <div class="mb-5 col-4 col-sm12 col-md-3 ">
                                    <label class="form-label fs-6 fw-semibold">{{__('report.supplier')}}</label>
                                    <select class="form-select  form-select-sm  fw-bold filter_customers" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-filter="customer" data-hide-search="true">
                                ...
                                <!--begin::Input group-->
                                <div class="mb-5 col-4 col-sm12 col-md-3 ">
                                    <label class="form-label fs-7 fw-semibold">{{__('report.status')}}</label>
                                    <select class="form-select form-select-sm   fw-bold filter_status" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-filter="status" data-hide-search="true">
                                        <option value="0">{{__('report.all')}}</option>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0 saleTableCard">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="purchase_reports_table">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-100px">{{__('report.supplier')}}</th>
                                <th class="min-w-100px">{{__('report.purchase_amount')}}</th>
                                        ...
                                        <div class="d-flex flex-column column_checkboxes">
                                            ...
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox" checked="checked"
                                                       id="chkColumn0"/>
                                                <span class="form-check-label text-gray-600 fw-semibold">{{__('report.date')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox" checked="checked"
                                                       id="chkColumn1"/>
                                                <span class="form-check-label text-gray-600 fw-semibold">{{__('report.voucher_no')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox" checked="checked"
                                                       id="chkColumn2"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">{{__('report.supplier')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox"  checked="checked"
                                                       id="chkColumn3"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">{{__('report.purchase_amount')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            {{-- <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            ...
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox"  checked="checked"
                                                       id="chkColumn5"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">{{__('report.location')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox"  checked="checked"
                                                       id="chkColumn6"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">{{__('report.status')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                        </div>
                                        <!--end::Input group-->
