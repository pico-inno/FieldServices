...
@section('purchased_details_active_show', 'active show')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('report.purchase_details')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">{{__('report.purchase_details')}}</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold">Export purchases details</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
