...
@section('sales_reports_here_show', 'here show')
@section('sales_summary_active_show', 'active show')
    ...
    @section('title')
        <!--begin::Heading-->
        <h1 class="text-dark fw-bold my-0 fs-2">{{__('report.sales_summary')}}</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb fw-semibold fs-base my-1">
            <li class="breadcrumb-item text-muted">{{__('report.reports')}}</li>
            <li class="breadcrumb-item text-muted">{{__('report.sales_reports')}}</li>
            <li class="breadcrumb-item text-dark">{{__('report.sales_summary')}}</li>
        </ul>
        <!--end::Breadcrumb-->
    @endsection
            ...
            <div class="container-xxl" id="kt_content_container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body filter-card">
                            <div class="row mb-5 flex-wrap">
                                ...
                                <!--begin::Input group-->
                                <div class="mb-5 col-4 col-sm12 col-md-3 ">
                                    <label class="form-label fs-6 fw-semibold">{{__('report.customer')}}</label>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0 saleTableCard">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="sale_reports_table">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
                                        ...
                                        <div class="d-flex flex-column column_checkboxes">
                                            ...
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox" checked="checked"
                                                       id="chkColumn2"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">{{__('report.customer')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                                <input class="form-check-input" type="checkbox"  checked="checked"
                                                       id="chkColumn3"/>
                                                <span
                                                    class="form-check-label text-gray-600 fw-semibold">{{__('report.sale_amount')}}</span>
                                            </label>
                                            <!--end::Radio button-->
                                            <!--begin::Radio button-->
                                            {{-- <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
    ...
    @push('scripts')
        <script src="{{ asset('customJs/reports/sale/salesSummaryExport.js') }}"></script>
        <script src="{{ asset('customJs/reports/sale/salesSummaryFilter.js') }}"></script>
