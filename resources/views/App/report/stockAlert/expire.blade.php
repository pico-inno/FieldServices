...
@section('expire_alerts_active_show', 'active show')
...
@section('title')
    <!--begin::Heading-->
    <h1 class="text-dark fw-bold my-0 fs-2">{{__('report.expire_alert')}}</h1>
    <!--end::Heading-->
    <!--begin::Breadcrumb-->
    <ul class="breadcrumb fw-semibold fs-base my-1">
        ...
        <li class="breadcrumb-item text-dark">{{__('report.expire_alert')}}</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
                                ...
                                <div class="row mb-5 flex-wrap">
                                    ...
                                    <div class="mb-10 col-4 col-sm12 col-md-3 ">
                                        ...
                                        <select class="form-select form-select-sm  fw-bold filter_expire_range" data-kt-select2="true"
                                            ...
                                            <option value="expire_month">Expiring in a month</option>
                                            <option value="expire_3_months">Expiring in 3 months</option>
            ...
            <div class="card">
                ...
                <div class="card-body pt-0 saleTableCard">
                    ...
                    <div class="table-responsive table-loading">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="alert_expire_reports_table">
                            <!--begin::Table head-->
                            <thead>
                            <!--begin::Table row-->
                                    ...
                                    <div class="d-flex flex-column column_checkboxes">
                                        ...
                                        <label class="form-check form-check-custom form-check-sm form-check-solid mb-3">
                                            <input class="form-check-input" type="checkbox"  checked="checked"
                                                   id="chkColumn3"/>
                                            <span
                                                class="form-check-label text-gray-600 fw-semibold">{{__('report.expire_date')}}</span>
                                        </label>
                                        <!--end::Radio button-->
                                    </div>
                                    <!--end::Input group-->
