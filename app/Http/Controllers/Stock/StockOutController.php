...
//
//        return view('App.stock.out.index', [
//            'stockouts' => $stockouts,
//            'locations' => $locations,
...
//
//
//        return view('App.stock.out.outgoing', [
//            'locations' => $locations,
//            'stockouts' => $stockouts,
//            'stockoutsperson' => $stockouts_person,
...
//
//        return view('App.stock.out.deliveredProduct', [
...
//
//
//        return view('App.stock.out.view', [
//            'stockout' => $stockout,
...
//
//
//        return view('App.stock.out.edit', [
//            'stockout' => $stockout,
//            'stockout_details' => $stockout_details,
...
//
//
//        $invoiceHtml = view('App.stock.out.invoice', compact('stockout', 'location', 'stockout_details'))->render();
//
