...
class VariationController extends Controller
{
    ...
    {
        // $variationIds = $request->input('ids');
        // $variationValues = [];

        // // Assuming $variationRepository->getTemplateById() fetches variation values by ID
        // foreach ($variationIds as $id) {
        //     $variationValues[] = $this->variationRepository->getTemplateValuesByIdWithRelationships($id);
        // }
