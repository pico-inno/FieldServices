...
class Fsproductsummary extends Component
{
    ...
    public function render()
    {
        ...
        $datas = sale_details::query()
            ...
            ->paginate(15);
        // return view('livewire.campaignProductSummeryReport',compact('datas'));

        return view('livewire.fsproductsummary',compact('datas'));
